object frmInformeDiarioCaja: TfrmInformeDiarioCaja
  Left = 587
  Top = 231
  Width = 290
  Height = 127
  Caption = 'Caja - Informe Diario'
  Color = clBtnFace
  ...
  Icon.Data = {
    ...
    
  ...
  object Report: TprTxReport
    ...
    Values = <
      ...
      item
        Name = 'TEfectivoCar'
        AggFunction = prafSum
        Formula = 'IBQuery3.BILLETES+IBQuery3.MONEDAS'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'INFORME DE MOVIMIENTOS DEL DIA [:<yyyy/MM/dd>IBQuery1.FECHA_MOV]' +
                  ' - CAJA [:<000>CAJA]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
        ...
        object prTxMemoObj54: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<#,#0>IBQuery3.BILLETES+IBQuery3.MONEDAS]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'MOVIMIENTOS REALIZADOS EN LA AGENCIA : [IBQuery1.DESCRIPCION_AGE' +
                  'NCIA]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
  ...
  object IBQuery3: TIBQuery
    ...
    SQL.Strings = (
      'SELECT'
      '  "caj$movimientocol".ID_CAJA,'
      '  "caj$movimientocol".ID_AGENCIA,'
      '  "caj$movimientocol".ID_COLOCACION,'
      '  "caj$movimientocol".DOCUMENTO,'
      '  "caj$movimientocol".CAPITAL,'
      '  "caj$movimientocol".INTERESES,'
      '  "caj$movimientocol".DEVOLUCION,'
      '  "caj$movimientocol".OTROS,'
      '  "caj$movimientocol".BILLETES,'
      '  "caj$movimientocol".MONEDAS,'
      '  "gen$persona".NOMBRE,'
      ...
      '  "caj$movimientocol"'
        ...
        '  INNER JOIN "col$colocacion" ON ("caj$movimientocol".ID_AGENCIA' +
        ' = "col$colocacion".ID_AGENCIA) AND ("caj$movimientocol".ID_COLO' +
        'CACION = "col$colocacion".ID_COLOCACION)'
    ...
    Left = 132
    Top = 58
    object IBQuery3ID_CAJA: TSmallintField
      FieldName = 'ID_CAJA'
      Origin = 'caj$movimientocol.ID_CAJA'
      Required = True
    end
    object IBQuery3ID_AGENCIA: TSmallintField
      FieldName = 'ID_AGENCIA'
      Origin = 'caj$movimientocol.ID_AGENCIA'
      Required = True
    end
    object IBQuery3ID_COLOCACION: TIBStringField
      FieldName = 'ID_COLOCACION'
      Origin = 'caj$movimientocol.ID_COLOCACION'
      Size = 11
    end
    object IBQuery3DOCUMENTO: TIntegerField
      FieldName = 'DOCUMENTO'
      Origin = 'caj$movimientocol.DOCUMENTO'
      Required = True
    end
    object IBQuery3CAPITAL: TIBBCDField
      FieldName = 'CAPITAL'
      Origin = 'caj$movimientocol.CAPITAL'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuery3INTERESES: TIBBCDField
      FieldName = 'INTERESES'
      Origin = 'caj$movimientocol.INTERESES'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuery3DEVOLUCION: TIBBCDField
      FieldName = 'DEVOLUCION'
      Origin = 'caj$movimientocol.DEVOLUCION'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuery3OTROS: TIBBCDField
      FieldName = 'OTROS'
      Origin = 'caj$movimientocol.OTROS'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuery3BILLETES: TIBBCDField
      FieldName = 'BILLETES'
      Origin = 'caj$movimientocol.BILLETES'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuery3MONEDAS: TIBBCDField
      FieldName = 'MONEDAS'
      Origin = 'caj$movimientocol.MONEDAS'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuery3NOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'gen$persona.NOMBRE'
      Size = 90
    end
    object IBQuery3PRIMER_APELLIDO: TIBStringField
      FieldName = 'PRIMER_APELLIDO'
      Origin = 'gen$persona.PRIMER_APELLIDO'
      Size = 30
    end
    object IBQuery3SEGUNDO_APELLIDO: TIBStringField
  ...
  object IBQuery4: TIBQuery
    ...
    SQL.Strings = (
      'select'
        ...
        '  count(ID_CAJA) AS CANTIDAD, sum(BILLETES+MONEDAS) as EFECTIVO ' +
        'from "caj$movimientocol"'
      
        'where FECHA_MOV between :FECHA1 and :FECHA2 and ID_CAJA = :ID_CA' +
        'JA')
    Left = 160
    Top = 58
    ParamData = <
    ...
    object IBQuery4CANTIDAD: TIntegerField
      FieldName = 'CANTIDAD'
      Required = True
    end
    object IBQuery4EFECTIVO: TIBBCDField
      FieldName = 'EFECTIVO'
      Precision = 18
      Size = 3
    end
  ...
  object prReportInforme: TprReport
    Values = <
      item
        Name = 'TEfectivoDB'
        AggFunction = prafSum
    ...
    object prPage1: TprPage
      ...
      object prHDetailHeaderBand1: TprHDetailHeaderBand
        Height = 16
        UseVerticalBands = False
        DetailBand = prReportInforme.prHDetailBand1
        ColCount = 1
        ColDirection = prcdTopBottomLeftRight
      ...
      object prHGroupHeaderBand1: TprHGroupHeaderBand
        Height = 17
        UseVerticalBands = False
        Group = prReportInforme.prGroup1
        ColCount = 1
        ColDirection = prcdTopBottomLeftRight
        LinkToDetail = True
        StartNewPage = False
      ...
      object prHDetailHeaderBand2: TprHDetailHeaderBand
        Height = 35
        UseVerticalBands = False
        DetailBand = prReportInforme.prHDetailBand2
        ColCount = 1
        ColDirection = prcdTopBottomLeftRight
        ReprintOnEachPage = True
        LinkToDetail = False
      ...
      object prHDetailHeaderBand3: TprHDetailHeaderBand
        Height = 35
        UseVerticalBands = False
        DetailBand = prReportInforme.prHDetailBand3
        ColCount = 0
        ColDirection = prcdTopBottomLeftRight
        ReprintOnEachPage = False
        LinkToDetail = False
      ...
      object prHDetailBand4: TprHDetailBand
        Height = 21
        UseVerticalBands = False
        DataSetName = 'IBQuery4'
        ColCount = 0
      ...
      object prHDetailFooterBand3: TprHDetailFooterBand
        Height = 21
        UseVerticalBands = False
        DetailBand = prReportInforme.prHDetailBand4
        ColCount = 0
        ColDirection = prcdTopBottomLeftRight
        LinkToDetail = False
