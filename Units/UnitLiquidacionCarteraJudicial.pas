unit UnitLiquidacionCarteraJudicial;
...
uses
  ...
  DBClient, JvEdit, JvTypedEdit, Grids, JvStringGrid, pr_Classes;
...
type
  TfrmLiquidacionCarteraJudicial = class(TForm)
    Panel4: TPanel;
    CmdAceptar: TBitBtn;
    CmdInforme: TBitBtn;
    BtnCerrar: TBitBtn;
...
var
  frmLiquidacionCarteraJudicial: TfrmLiquidacionCarteraJudicial;
  vColocacion : string;
  vComprobante : string;
...
procedure TfrmLiquidacionCarteraJudicial.FormCreate(Sender: TObject);
begin
        dmColocacion := TdmColocacion.Create(Self);
end;

procedure TfrmLiquidacionCarteraJudicial.FormClose(Sender: TObject;
...
procedure TfrmLiquidacionCarteraJudicial.EdNumeroColocacionExit(Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.FormShow(Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
        EnterTabs(Key,Self);
end;

procedure TfrmLiquidacionCarteraJudicial.EdAbonoCapitalExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdTasaAplicadaCausadoEnter(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdTasaAplicadaCorrienteEnter(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdTasaAplicadaAnticipadoEnter(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdTasaAplicadaMoraEnter(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdAbonoInteresCausadoExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdFechaInicialCausadoExit(
  Sender: TObject);
begin
//        vFechaInicialCausado := EdFechaInicialCausado.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.EdFechaFinalcausadoExit(Sender: TObject);
begin
//        vFechaFinalCausado := EdFechaFinalCausado.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.EdDiasAplicadosCausadoExit(
  Sender: TObject);
begin
        DiasCausado;
        DiasContingentes;
...
procedure TfrmLiquidacionCarteraJudicial.EdTasaAplicadaCausadoExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdAbonoInterescorrienteExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdFechaInicialCorrienteExit(
  Sender: TObject);
begin
//        vFechaInicialCorriente := EdFechaInicialCorriente.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.EdFechaFinalCorrienteExit(
  Sender: TObject);
begin
//        vFechaFinalCorriente := EdFechaFinalCorriente.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.EdDiasAplicadosCorrienteExit(
  Sender: TObject);
begin
        DiasCorriente;
        DiasAnticipado;
...
procedure TfrmLiquidacionCarteraJudicial.EdTasaAplicadaCorrienteExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdAbonoInteresAnticipadoExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdFechaInicialAnticipadoExit(
  Sender: TObject);
begin
        vFechaInicialAnticipado := EdFechaInicialAnticipado.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.EdFechaFinalAnticipadoExit(
  Sender: TObject);
begin
        vFechaFinalAnticipado := EdFechaFinalAnticipado.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.EdDiasAplicadosAnticipadoExit(
  Sender: TObject);
begin
        DiasAnticipado;
        DiasMora;
        if (EstadoActual = 2) or (EstadoActual = 3) then
          vTasaAnticipado := BuscoTasaManual(Clasificacion,TasaC,TipoInteres,TipoCuota,vPuntosAdic,Amortizacion,fFechaActual,FechaInteres).TasaMora
        else
          vTasaAnticipado := BuscoTasaManual(Clasificacion,TasaC,TipoInteres,TipoCuota,vPuntosAdic,Amortizacion,vFechaFinalAnticipado,FechaInteres).TasaLiquidar;
        EdTasaAplicadaAnticipado.Text := FormatCurr('#0.00%',vTasaAnticipado);
end;

procedure TfrmLiquidacionCarteraJudicial.EdTasaAplicadaAnticipadoExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdAbonoInteresMoraExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdFechaInicialMoraExit(
  Sender: TObject);
begin
        vFechaInicialMora := EdFechaInicialMora.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.EdFechaFinalMoraExit(
  Sender: TObject);
begin
        vFechaFinalMora := EdFechaFinalMora.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.EdTasaAplicadaMoraExit(
  Sender: TObject);
begin
end;
///**Fin - Intereses Mora**///
...
procedure TfrmLiquidacionCarteraJudicial.EdInteresDevueltoExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdFechaInicialDevueltoExit(
  Sender: TObject);
begin
        vFechaInicialDevuelto := EdFechaInicialDevuelto.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.EdFechaFinalDevueltoExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.CmdAceptarClick(Sender: TObject);
var
I,J:Integer;
...
begin
        ...
        begin
           ...
           SQL.Add('where');
           SQL.Add('"col$tablaliquidacion".PAGADA = 0 and ID_AGENCIA = :ID_AGENCIA AND "col$tablaliquidacion".ID_COLOCACION = :ID_COLOCACION');
...
// coloco Juvenil
         if vTotalJuvenil > 0 then begin
          ...
          AR^.Dias         := 0;
          AR^.Tasa         := 0;
          AR^.Debito       := vTotalJuvenil;//TotalCreditos - TotalDebitos;
          AR^.Credito      := 0;
          AR^.EsCapital := False;
          AR^.EsCausado := False;
          AR^.EsCorriente := False;
...
//         vTotalLiquidacion := TGeneral + vConsignaAhorros;
         TotalDebitos := 0;
         TotalCreditos := 0;
...
procedure TfrmLiquidacionCarteraJudicial.GrabarExtractoDet;
begin
      with IBQuery do
        begin
          SQL.Clear;
...
procedure TfrmLiquidacionCarteraJudicial.GrabarExtracto;
var
FechaIntAnt:TDate;
FechaCapAnt:TDate;
vCuotaTipo : string;
...
//     Verificacion de Credito
     if ChVCredito.Checked then
      begin
       ...
       if (EsCapital.Checked = True) and (EsIntereses.Checked = True) then
        begin
          ...
          if EstadoActual <> 2 then
            ...
            IBConsulta.ParamByName('CAPITAL_PAGO_HASTA').AsDate := FechaCapAnt;
       ...
       if vCuotaTipo = 'V' then
        if (CapitalaPagar > 0) and (InteresaPagar > 0) then
         begin
           if (FechaTabla <= NuevaFechaCapital) and (InteresaPagar <= vTotalInteres) and (SaldoTabla <= (vSaldoActual - vAbonocapital)) and (EstadoActual <> 2) then
            begin
              IBConsulta.sql.Clear;
              IBConsulta.sql.Add('update "col$tablaliquidacion" set ');
              IBConsulta.sql.Add('"col$tablaliquidacion"."PAGADA" = 1');
         ...
         if (CapitalaPagar > 0) and (FechaTabla <= NuevaFechaCapital) and (EstadoActual <> 2) then
          begin
            IBConsulta.sql.Clear;
            IBConsulta.sql.Add('update "col$tablaliquidacion" set ');
            IBConsulta.sql.Add('"col$tablaliquidacion"."PAGADA" = 1');
        ...
        if (InteresaPagar >= 0) and (InteresaPagar <= vTotalInteres) and (SaldoTabla <= (vSaldoActual - vAbonocapital)) and (EstadoActual <> 2) then
         begin
           IBConsulta.sql.Clear;
           IBConsulta.sql.Add('update "col$tablaliquidacion" set ');
           IBConsulta.sql.Add('"col$tablaliquidacion"."PAGADA" = 1');
      ...
      begin
          if ((EsCapital.Checked = True) and (EsIntereses.Checked = True) and (CapitalP <= vAbonocapital)) then
          begin
            sql.Clear;
...
procedure TfrmLiquidacionCarteraJudicial.BtnCerrarClick(Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.CmdBuscarClick(Sender: TObject);
...
procedure TfrmLiquidacionCarteraJudicial.CmdInformeClick(Sender: TObject);
var Tabla:string;
    I:Integer;
    AF:PCuotasLiq;
...
begin
        ...
        Cuenta := IntToStr(NumeroCuentaAp) + '-' + DigitoControl(2,FormatCurr('0000000',NumeroCuentaAp));
        for I := 0 to (MyCuotasLiq.Lista.Count - 1) do
         begin
           ...
           prReportCartera.Variables.ByName['ProximaCuota'].AsString := FechaProx;
           prReportCartera.Variables.ByName['FechaCorte'].AsDateTime := fFechaActual;
           prReportCartera.Variables.ByName['Asociado'].AsString := Asociado;
           prReportCartera.Variables.ByName['Cuenta'].AsString := Cuenta;
           prReportCartera.Variables.ByName['NuevoSaldo'].AsDouble := vSaldoActual - vAbonoCapital;
           prReportCartera.Variables.ByName['InteresesHasta'].AsDateTime := vFechaFInt;
           prReportCartera.Variables.ByName['CapitalHasta'].AsDateTime := NuevaFechaCapital;
           if (Trim(EdNoComprobante.Text) = '') then
            prReportCartera.Variables.ByName['comprobante'].AsInteger := 0
           else
            prReportCartera.Variables.ByName['comprobante'].AsInteger := StrToInt(Trim(EdNocomprobante.Text));
...
procedure TfrmLiquidacionCarteraJudicial.Empleado;
begin
...
procedure TfrmLiquidacionCarteraJudicial.inicializar;
begin
...
procedure TfrmLiquidacionCarteraJudicial.CmdGrabarClick(Sender: TObject);
var
I,J : integer;
...
if MessageDlg('Seguro de Realizar el Abono?',mtConfirmation,[mbYes,mbNo],0) = mrYes then
 begin
  ...
  if not (TotalDebitoRecibo = TotalCreditoRecibo) then
   begin
     MessageDlg('La Nota Contable est? Descuadrada' + #10 + #13 +
                       'Revise los Valores',mtError,[mbOk],0);
     CmdReversar.Click;
     Exit;
   end
...
///**Genero el consecutivo
    ...
    with IBQuery do
     try
      ...
      New(AR);
      AR^.CuotaNumero := 0;
      AR^.CodigoPuc   := '615025000000000000'{YA ES NIIF};
      AR^.FechaInicial := fFechaActual;
      AR^.FechaFinal   := fFechaActual;
      AR^.Dias         := 0;
      AR^.Tasa         := 0;
      ...
      New(AR);
      AR^.CuotaNumero := 0;
      AR^.CodigoPuc   := '523050000000000000'{YA ES NIIF};
      AR^.FechaInicial := fFechaActual;
      AR^.FechaFinal   := fFechaActual;
      AR^.Dias         := 0;
      AR^.Tasa         := 0;
      ...
      New(AR);
      AR^.CuotaNumero := 0;
      AR^.CodigoPuc   := '243005000000000000'{YA ES NIIF};
      AR^.FechaInicial := fFechaActual;
      AR^.FechaFinal   := fFechaActual;
      AR^.Dias         := 0;
      AR^.Tasa         := 0;
      ...
      New(AR);
      AR^.CuotaNumero := 0;
      AR^.CodigoPuc   := '243095000000000000'{YA ES NIIF};
      AR^.FechaInicial := fFechaActual;
      AR^.FechaFinal   := fFechaActual;
      AR^.Dias         := 0;
      AR^.Tasa         := 0;
      ...
      with IBQuery1 do
       begin
         ...
         if vNacional > 0 then
           ParamByName('DESCRIPCION').AsString := 'Descuento de Cartera por Pagar? No.' + vColocacion + ' ' + 'Consig. Nal' + ' ' + DateToStr(FechaConsignacion)
         else
           ParamByName('DESCRIPCION').AsString := 'Descuento de Cartera por Pagar? No.' + vColocacion;
    ...
    if vConsignaAhorros > 0 then begin
      with IBQuery1 do
       begin
         ...
         ParamByName('DIGITO_CUENTA').AsInteger := StrToInt(DigitoControl(2,FormatCurr('0000000',NumeroCuentaAp)));;
         ParamByName('FECHA_MOVIMIENTO').AsDateTime := fFechaActual;
         ParamByName('HORA_MOVIMIENTO').AsTime := Time;
...
procedure TfrmLiquidacionCarteraJudicial.CmdReversarClick(Sender: TObject);
begin
          DmGeneral.IBTransaction1.Rollback;
          MessageDlg('Error al Abonar Cuotas',mtInformation,[mbOK],0);
          Inicializar;
...
procedure TfrmLiquidacionCarteraJudicial.EsCapitalClick(Sender: TObject);
begin
        if EsCapital.Checked = True then
         ...
         begin
           ...
           DevueltosClick(Sender);
           CobradosClick(Sender);
           esinteresesclick(Sender);
         end;
end;

procedure TfrmLiquidacionCarteraJudicial.EsInteresesClick(Sender: TObject);
...
procedure TfrmLiquidacionCarteraJudicial.DevueltosClick(Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.CobradosClick(Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.GroupBox5Exit(Sender: TObject);
begin
        if (Devueltos.Checked = True) or (Cobrados.Checked = True) then
          EsIntereses.Checked := False;
end;

procedure TfrmLiquidacionCarteraJudicial.DiasCausado;
var
Ano,Mes,Dia,AnoA,MesA,DiaA:Word;
FechaArranque :TDate;
Bisiesto:Boolean;
begin
        FechaArranque := IncDay(FechaInteres);
...
procedure TfrmLiquidacionCarteraJudicial.DiasCorriente;
begin
...
procedure TfrmliquidacionCarteraJudicial.DiasAnticipado;
begin
...
procedure TfrmLiquidacionCarteraJudicial.DiasMora;
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdDiasAplicadosCausadoChange(
  Sender: TObject);
begin
        DiasCausado;
        DiasContingentes;
...
procedure TfrmLiquidacionCarteraJudicial.EdDiasAplicadosCorrienteChange(
  Sender: TObject);
begin
        DiasCorriente;
        DiasMora;
...
procedure TfrmLiquidacionCarteraJudicial.GrabarTablaLiquidacion;
begin
        with IBQuery1 do
         begin
          sql.Clear;
...
function TfrmLiquidacionCarteraJudicial.BuscarAhorros(TipoId: Integer;
...
function TfrmLiquidacionCarteraJudicial.BuscarAportes(TipoId: Integer;
  NumeroId: String): Currency;
var Saldo,Movimiento,Canje,Disponible:Currency;
...
procedure TfrmLiquidacionCarteraJudicial.LimpiarManualIntereses;
begin
  EdAbonoInteresContingente.Text := '';
  EdAbonoInteresCausado.Text := '';
  EdAbonoInterescorriente.Text := '';
...
procedure TfrmLiquidacionCarteraJudicial.EdAbonoInteresContingenteExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdAbonoCostasExit(Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdDiasAplicadosContingenteExit(
  Sender: TObject);
begin
        DiasContingentes;
        DiasCorriente;
...
procedure TfrmLiquidacionCarteraJudicial.EdDiasAplicadosContingenteChange(
  Sender: TObject);
begin
        DiasContingentes;
        DiasCausado;
...
procedure TfrmLiquidacionCarteraJudicial.DiasContingentes;
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdDiasAplicadosMoraChange(
  Sender: TObject);
begin
        diasmora;
end;

procedure TfrmLiquidacionCarteraJudicial.EdDiasAplicadosMoraExit(
  Sender: TObject);
begin
        diasmora;
...
procedure TfrmLiquidacionCarteraJudicial.VerificarCuentaAportes(Cuenta,
  Digito: Integer);
begin

end;

procedure TfrmLiquidacionCarteraJudicial.EdDiasDevueltoExit(
  Sender: TObject);
begin
        DiasDevuelto;
...
procedure TfrmLiquidacionCarteraJudicial.EdDiasDevueltoChange(
  Sender: TObject);
begin
        DiasDevuelto;
end;

procedure TfrmLiquidacionCarteraJudicial.EdInteresCobradoCausadoExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdInteresCobradoCorrienteExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdDiasCobradoCausadoExit(
  Sender: TObject);
begin
        DiasCobradoCausado;
        DiasCobradoCorriente;
        if (EstadoActual = 2) or (EstadoActual = 3) then
          vTasaCobradoCausado := BuscoTasaManual(Clasificacion,TasaC,TipoInteres,TipoCuota,vPuntosAdic,Amortizacion,fFechaActual,FechaInteres).TasaMora
        else
          vTasaCobradoCausado := BuscoTasaManual(Clasificacion,TasaC,TipoInteres,TipoCuota,vPuntosAdic,Amortizacion,vFechaFinalCobradoCausado,FechaInteres).TasaLiquidar;
        EdTasaCobradoCausado.Text := FormatCurr('#0.00%',vTasaCobradoCausado);
end;

procedure TfrmLiquidacionCarteraJudicial.EdDiasCobradoCausadoChange(
  Sender: TObject);
begin
        DiasCobradoCausado;
end;

procedure TfrmLiquidacionCarteraJudicial.EdDiasCobradoCorrienteExit(
  Sender: TObject);
begin
        DiasCobradoCorriente;
        if (EstadoActual = 2) or (EstadoActual = 3) then
          vTasaCobradoCorriente := BuscoTasaManual(Clasificacion,TasaC,TipoInteres,TipoCuota,vPuntosAdic,Amortizacion,fFechaActual,FechaInteres).TasaMora
        else
          vTasaCobradoCorriente := BuscoTasaManual(Clasificacion,TasaC,TipoInteres,TipoCuota,vPuntosAdic,Amortizacion,vFechaFinalCobradoCorriente,FechaInteres).TasaLiquidar;
        EdTasaCobradoCorriente.Text := FormatCurr('#0.00%',vTasaCobradoCorriente);
        CmdAceptar.SetFocus;
end;

procedure TfrmLiquidacionCarteraJudicial.EdDiasCobradoCorrienteChange(
  Sender: TObject);
begin
        DiasCobradoCausado;
        DiasCobradoCorriente;
...
procedure TfrmLiquidacionCarteraJudicial.DiasDevuelto;
begin
...
procedure TfrmLiquidacionCarteraJudicial.DiasCobradoCausado;
begin
...
procedure TfrmLiquidacionCarteraJudicial.DiasCobradoCorriente;
begin
...
function TfrmLiquidacionCarteraJudicial.BuscarJuvenil(TipoId: integer;
  NumeroId: String): Currency;
var Saldo,Movimiento,Canje,Disponible:Currency;
    Ag,Tipo:Integer;
begin
...
procedure TfrmLiquidacionCarteraJudicial.ActualizarCaptaciones(
           ...
           while not Eof do begin
            if i > 1 then
              GridCuentas.RowCount := GridCuentas.RowCount + 1;
                IBSQL2.Close;
                IBSQL2.SQL.Clear;
                IBSQL2.SQL.Add('select SALDO_ACTUAL from SALDOS_VIGENTES(:AG,:TP,:CTA,:DGT,:ANO,:FECHA1,:FECHA2)');
                ...
                try
                  ...
                  if IBSQL2.RecordCount > 0 then begin
                    ...
                    if FieldByName('ID_TIPO_CAPTACION').AsInteger = 1 then begin
                      NumeroCuentaAp := FieldByName('NUMERO_CUENTA').AsInteger;
                      vTotalAportes := vTotalAportes + IBSQL2.FieldByName('SALDO_ACTUAL').AsCurrency;
                      SaldoAportes := vTotalAportes;
                    end
                    else
                    if FieldByName('ID_TIPO_CAPTACION').AsInteger = 2 then begin
                      vTotalAhorros := vTotalAhorros + IBSQL2.FieldByName('SALDO_ACTUAL').AsCurrency;
                    ...
                    if FieldByName('ID_TIPO_CAPTACION').AsInteger = 4 then begin
                      vTotalJuvenil := vTotalJuvenil + IBSQL2.FieldByName('SALDO_ACTUAL').AsCurrency;
                      SaldoJuvenil := vTotalJuvenil;
                    end;

                    vTotalCuentas := vTotalCuentas + IBSQL2.FieldByName('SALDO_ACTUAL').AsCurrency;
                    ...
                    AR^.Saldo   := IBSQL2.FieldByName('SALDO_ACTUAL').AsCurrency;
                    ListaCuentas.Add(AR);
                   end;
                 except
                   raise;
...
procedure TfrmLiquidacionCarteraJudicial.GridCuentasGetCellAlignment(
...
procedure TfrmLiquidacionCarteraJudicial.ChkPapeleriaClick(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdExasociadosExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.CmdNuevoClick(Sender: TObject);
begin
        inicializar;
end;

procedure TfrmLiquidacionCarteraJudicial.EdExasociadosEnter(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.VerificarCancelacionCaptacion(Agencia:Integer;Colocacion:string);
var  Saldo :Currency;
     AR:PCuentas;
     i:Integer;
begin
...
procedure TfrmLiquidacionCarteraJudicial.GridCuentasGetEditText(
  Sender: TObject; ACol, ARow: Integer; var Value: String);
begin
        Fila := ARow;
end;

procedure TfrmLiquidacionCarteraJudicial.GridCuentasExitCell(
...
begin
          ...
          Cuenta := MidStr(GridCuentas.Cells[0,fila],5,7);
          Tipo := MidStr(GridCuentas.Cells[0,fila],1,1);
          ...
          for I := 0 to ListaCuentas.Count - 1 do begin
           AR := ListaCuentas.Items[i];
           if AR^.Tipo = 1 then
             vTotalAportes := vTotalAportes + AR^.Saldo
           else if AR^.Tipo = 2 then
             vTotalAhorros := vTotalAhorros + AR^.Saldo
           else if AR^.Tipo = 4 then
             vTotalJuvenil := vTotalJuvenil + AR^.Saldo;
          end;
...
procedure TfrmLiquidacionCarteraJudicial.EdAbonoHonorariosExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdNacionalExit(Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.DBLCBBancosExit(Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdNacionalEnter(Sender: TObject);
begin
        EdNacional.SelectAll;
end;

procedure TfrmLiquidacionCarteraJudicial.GridCuentasExit(Sender: TObject);
begin
          vTotalCuentas := vTotalAportes + vTotalAhorros + vTotalJuvenil + vNacional;
end;

procedure TfrmLiquidacionCarteraJudicial.EdFechaConsignacionExit(
  Sender: TObject);
begin
        FechaConsignacion := EdFechaConsignacion.Date;
end;

procedure TfrmLiquidacionCarteraJudicial.VerificacionCambioEstado;
begin
        if EstadoActual <> NuevoEstado then begin
          with IBCambioEstado do begin
            ...
            ParamByName('FECHA_CAPITAL').AsDate := NuevaFechaCapital;
            ParamByName('FECHA_INTERES').AsDate := vFechaFInt;
            ExecQuery;
            Close;
...
procedure TfrmLiquidacionCarteraJudicial.FallecidoClick(Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.IncapacitadoClick(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.DacionClick(Sender: TObject);
begin
