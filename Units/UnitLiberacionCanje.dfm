object frmLiberacionCanje: TfrmLiberacionCanje
  ...
  object PgC: TPageControl
    ...
    object TabSheet6: TTabSheet
      ...
      object RAgencia: TRadioGroup
        ...
        TabOrder = 0
        TabStop = True
        OnClick = RAgenciaClick
      end
      object PageAgencia: TPageControl
        Left = 253
        Top = 0
        Width = 286
        Height = 86
        ActivePage = TabCaptacion
        TabOrder = 1
        object TabFecha: TTabSheet
          Caption = 'TabSheet1'
          TabVisible = False
        ...
        object TabCaptacion: TTabSheet
          ...
          object DbAgTipo: TDBLookupComboBox
            Left = 84
            Top = 0
            Width = 193
            Height = 21
          ...
          object sAgAsociado: TStaticText
            Left = 10
            Top = 52
            Width = 264
            Height = 21
        ...
        object TabCheque: TTabSheet
          ...
          object DbAgBanco: TDBLookupComboBox
            Left = 47
            Top = 10
            Width = 232
            Height = 21
  ...
  object IBAgencia: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  "gen$agencia"'
      'WHERE'
      '  "gen$agencia".ID_AGENCIA <> :IDAGENCIA AND '
