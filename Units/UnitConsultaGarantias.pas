...
uses
  ...
  StdCtrls, Buttons, IBQuery, Menus, IBDatabase, IBSQL, FR_Class, IdGlobal;
...
uses UnitDmGeneral, UnitGlobales, UnitDireccionesAsociados, UnitGlobalesCol,
      ...
      begin
       ...
       try
        ...
        begin
          ...
          ExecQuery;
          if Agencia = 1 then
             Fciudad := 'Ocaña ' + FormatDateTime('dd-mmm-yyyy',Date)
          else
          ...
          Fdireccion := LowerCase(FieldByName('MUNICIPIO').AsString) + ', ' + LowerCase(FieldByName('DIRECCION').AsString);
          Fbarrio := FieldByName('BARRIO').AsString;
          Close;
          SQL.Clear;
