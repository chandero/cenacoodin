object frmBalanceConsolidadoTxt: TfrmBalanceConsolidadoTxt
  Left = 436
  Top = 311
  Width = 245
  Height = 138
  ...
  object IBQTabla: TIBQuery
    ...
    SQL.Strings = (
      'SELECT * FROM BALANCE_CONSOLIDADO_OFICINAS(:MES,:NIVELX)')
    Left = 48
    Top = 48
    ParamData = <
      item
    ...
    object IBQTablaCODIGO: TIBStringField
      FieldName = 'CODIGO'
      Origin = '"BALANCE_CONSOLIDADO_OFICINAS"."CODIGO"'
      FixedChar = True
      Size = 18
    end
    object IBQTablaNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = '"BALANCE_CONSOLIDADO_OFICINAS"."NOMBRE"'
      Size = 100
    end
    object IBQTablaNIVEL: TIntegerField
      FieldName = 'NIVEL'
      Origin = '"BALANCE_CONSOLIDADO_OFICINAS"."NIVEL"'
    end
    object IBQTablaSALDOMESANT: TIBBCDField
      FieldName = 'SALDOMESANT'
      Origin = '"BALANCE_CONSOLIDADO_OFICINAS"."SALDOMESANT"'
      Precision = 18
      Size = 3
    end
    object IBQTablaDEBITO: TIBBCDField
      FieldName = 'DEBITO'
      Origin = '"BALANCE_CONSOLIDADO_OFICINAS"."DEBITO"'
      Precision = 18
      Size = 3
    end
    object IBQTablaCREDITO: TIBBCDField
      FieldName = 'CREDITO'
      Origin = '"BALANCE_CONSOLIDADO_OFICINAS"."CREDITO"'
      Precision = 18
      Size = 3
    end
    object IBQTablaSALDO: TIBBCDField
      FieldName = 'SALDO'
      Origin = '"BALANCE_CONSOLIDADO_OFICINAS"."SALDO"'
      Precision = 18
      Size = 3
    end
  end
        ...
        object prTxMemoObj40: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<#,#0.00>iif(IBQTabla.SALDOMESANT > 0,IBQTabla.SALDOMESANT,0)]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[:<#,##0.00>iif(IBQTabla.SALDOMESANT <= 0,-IBQTabla.SALDOMESANT,' +
                  '0)]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
        ...
        object prTxMemoObj48: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<#,#0.00>iif(IBQTabla.SALDO > 0,IBQTabla.SALDO,0)]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
