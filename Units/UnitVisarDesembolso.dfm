object frmVisarDesembolso: TfrmVisarDesembolso
  ...
  Height = 371
  AutoSize = True
  Caption = 'Visaci'#243'n de Desembolso'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object CHcredivida: TCheckBox
        ...
        Caption = '&Autorizaci'#243'n Credivida'
        TabOrder = 6
      end
    end
  ...
  object IBAhorros: TIBQuery
    ...
    Transaction = dmGeneral.IBTransaction1
    SQL.Strings = (
      'Select CREDITO,DEBITO from "col$concol"'
      'where'
  ...
  object Reporte: TfrReport
    InitialZoom = pzDefault
    PreviewButtons = [pbZoom, pbLoad, pbPrint, pbFind, pbExit, pbPageSetup]
    RebuildPrinter = False
    Left = 104
    Top = 34
    ReportForm = {19000000}
