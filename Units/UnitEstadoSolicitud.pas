...
uses UnitDmSolicitud, UnitImpresion, UnitMain, UnitGlobales, UnitdmGeneral,
...
begin
        ...
        frReport1.Dictionary.Variables['EMPRESA'] := Empresa;
...
begin
        ...
        begin
          ...
          frmProgreso.Titulo := 'Solicitudes Aprobadas ' + Empresa +':'+ IntToStr(RecordCount);
          ...
          begin
            ...
            begin
               ...
               CDaprobado.FieldValues['desc_agencia'] := Empresa;
        ...
        begin
          ...
          begin
            try
              ...
              ShowMessage('No se logro comunicación con: ' + FieldByName('DESCRIPCION_AGENCIA').AsString);
            end;
            Next;
          end;
        //solicitudagencia(,2,'192.168.201.15','ABREGO');
        //solicitudagencia(3052,3,'192.168.205.2','CONVENCION');
        //solicitudagencia(3052,4,'192.168.203.2','AGUACHICA');
