object frmInformeCajaAuditoria: TfrmInformeCajaAuditoria
  Left = 381
  Top = 292
  Width = 368
  Height = 166
  Caption = 'Informe de Movimientos de Caja'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object rgorden: TRadioGroup
      ...
      ItemIndex = 0
      Items.Strings = (
        'Producto y Orden de Ingreso seg'#250'n Fecha y Hora'
        'Producto y Orden de Ingreso'
        'Orden de Ingreso')
      ParentFont = False
      TabOrder = 3
    end
