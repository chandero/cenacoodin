...
begin
        ...
        begin
          ...
          begin
            vAgencia := 'SANTA CLARA';
            id_agencia := 5;
            saldoremoto(BuscaServicio(5,1).vPuerto,BuscaServicio(5,1).vhost);
          end;
...
begin
        ...
        begin
          ...
          begin
            if FieldByName('SALDOCAJA').AsCurrency <> 0 then
               insertar(1,FieldByName('ID_CAJA').AsInteger,FieldByName('SALDOCAJA').AsCurrency,DBAgencia.Text,FieldByName('EMPLEADO').AsString);
            Next;
          end;
        end;
       ...
       begin
          ...
          begin
            ...
            FieldValues['agencia'] := DBagencia.Text;
...
begin
        ...
        begin
          ...
          begin
            ...
            CdConBancos.FieldValues['DESCRIPCION'] := DBAgencia.Text;
