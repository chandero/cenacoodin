object frmInformeArqueoDiarioCaja: TfrmInformeArqueoDiarioCaja
  Left = 604
  Top = 412
  BorderStyle = bsDialog
  Caption = 'Caja - Arqueo del D'#237'a'
  ClientHeight = 107
  ClientWidth = 282
  Color = clBtnFace
  ...
  object IBQuery: TIBQuery
    ...
    SQL.Strings = (
      'select ID_CAJA,FECHA,'
        ...
        '  SALDO_INICIAL_EFECTIVO, SALDO_INICIAL_CHEQUE,   SALDO_INICIAL_' +
        'MONEDA, SALDO_FINAL_CHEQUE,   SALDO_FINAL_EFECTIVO, SALDO_FINAL_' +
        'MONEDA from "caj$cierres"'
      'where'
      ' ID_CAJA = :ID_CAJA and FECHA = :FECHA')
    Left = 52
    Top = 66
    ParamData = <
      item
    ...
    object IBQueryID_CAJA: TSmallintField
      FieldName = 'ID_CAJA'
      Origin = 'caj$cierres.ID_CAJA'
      Required = True
    end
    object IBQueryFECHA: TDateField
      FieldName = 'FECHA'
      Origin = 'caj$cierres.FECHA'
      Required = True
    end
    object IBQuerySALDO_INICIAL_EFECTIVO: TIBBCDField
      FieldName = 'SALDO_INICIAL_EFECTIVO'
      Origin = 'caj$cierres.SALDO_INICIAL_EFECTIVO'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuerySALDO_INICIAL_CHEQUE: TIBBCDField
      FieldName = 'SALDO_INICIAL_CHEQUE'
      Origin = 'caj$cierres.SALDO_INICIAL_CHEQUE'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuerySALDO_INICIAL_MONEDA: TIBBCDField
      FieldName = 'SALDO_INICIAL_MONEDA'
      Origin = 'caj$cierres.SALDO_INICIAL_MONEDA'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuerySALDO_FINAL_CHEQUE: TIBBCDField
      FieldName = 'SALDO_FINAL_CHEQUE'
      Origin = 'caj$cierres.SALDO_FINAL_CHEQUE'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuerySALDO_FINAL_EFECTIVO: TIBBCDField
      FieldName = 'SALDO_FINAL_EFECTIVO'
      Origin = 'caj$cierres.SALDO_FINAL_EFECTIVO'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQuerySALDO_FINAL_MONEDA: TIBBCDField
      FieldName = 'SALDO_FINAL_MONEDA'
      Origin = 'caj$cierres.SALDO_FINAL_MONEDA'
      Required = True
      Precision = 18
      Size = 3
    end
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'QUE+IBQuery.SALDO_FINAL_MONEDA]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
