object FrmControlContractual: TFrmControlContractual
  ...
  object IBControl: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = IBTObservacion
    SQL.Strings = (
      'SELECT '
      '  "cap$controlcon".FECHA_ANTERIOR,'
      '  "cap$controlcon".FECHA_ACTUAL,'
      '  "cap$controlcon".C_VENCIDA,'
      '  "cap$controlcon".ID_EMPLEADO,'
      '  "cap$controlcon".DIAS'
      'FROM'
      '  "cap$controlcon"'
      'WHERE'
      '  "cap$controlcon".ID_TIPO_CAPTACION = 5 AND '
      '  "cap$controlcon".NUMERO_CUENTA = :NM AND '
      '  "cap$controlcon".DIGITO_CONTROL = :DG')
    Left = 216
    Top = 64
    ParamData = <
      item
  ...
  object IBQuery2: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  "cap$controlcon".ID_EMPLEADO,'
      '  "cap$controlcon".DIAS,'
      '  "cap$controlcon".NUMERO_CUENTA,'
      '  "cap$controlcon".DIGITO_CONTROL,'
      '  "cap$controlcon".C_VENCIDA'
      ''
      'FROM'
      '  "cap$controlcon"'
      
        '  INNER JOIN "cap$maestro" ON ("cap$controlcon".ID_AGENCIA = "ca' +
        'p$maestro".ID_AGENCIA)'
      
        '  AND ("cap$controlcon".ID_TIPO_CAPTACION = "cap$maestro".ID_TIP' +
        'O_CAPTACION)'
      
        '  AND ("cap$controlcon".NUMERO_CUENTA = "cap$maestro".NUMERO_CUE' +
        'NTA)'
      
        '  AND ("cap$controlcon".DIGITO_CONTROL = "cap$maestro".DIGITO_CU' +
        'ENTA)'
      'WHERE'
      '  "cap$maestro".ID_TIPO_CAPTACION = 5 AND '
      '  "cap$controlcon".C_VENCIDA > 0 AND '
      '  "cap$maestro".ID_ESTADO IN (1,6)')
    Left = 624
    Top = 176
  end
  object IBQuery3: TIBQuery
    ...
    SQL.Strings = (
      ...
      'WHERE'
      '  "cap$controlcon".NUMERO_CUENTA = :NM AND '
      '  "cap$controlcon".DIGITO_CONTROL = :DG AND '
      '  "cap$controlcon".FECHA_ACTUAL = :FECHA')
    Left = 672
    Top = 176
    ParamData = <
      item
