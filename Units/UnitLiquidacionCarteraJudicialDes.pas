...
procedure TfrmLiquidacionCarteraJudicial.EdTasaAplicadaContingenteExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdTasaDevolucionExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdTasaCobradoCausadoExit(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionCarteraJudicial.EdTasaCobradoCorrienteExit(
  Sender: TObject);
begin
