          ...
          while not Eof do begin
                ...
                try
                 ...
                 if RecordCount > 0 then begin
                    ...
                    if DiasEntre(Fecha,fFechaActual) >= StrToInt(EdDias.Text) then begin
                       IBQTabla.Append;
                       ...
                       IBQTabla.FieldByName('FECHA').AsString := DateToStr(Fecha);
//                       IBQTabla.FieldByName('SALDO').AsCurrency := 
                       IBQTabla.Post;
                       IBQTabla.Close;
                    end;
                 end;
