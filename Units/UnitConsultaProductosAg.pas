...
begin
{
      try
        ...
        Nodo1.WriteString('tipo','select');
        nodo1.WriteString('sentencia',sentencia);
        //***Información Codeudores

        //***Información Garantias
        ...
        begin
          ...
          begin
            ...
            if PingHost(_sIpPing) then
              ...
              _sMensaje := _sMensaje + FieldByName('DESCRIPCION_AGENCIA').AsString;
             Next;
          end;
        end;
        if vContador > 1 then
          Arbol.Enabled := True;
        if _sMensaje <> '' then
          ShowMessage('No se logro Comunicación con: ' + _smensaje);
