object frmInformeChequesenCaja: TfrmInformeChequesenCaja
  Left = 190
  Top = 213
  BorderStyle = bsDialog
  Caption = 'Caja - Cheques en Caja'
  ClientHeight = 139
  ClientWidth = 346
  Color = clBtnFace
        ...
        object prTxMemoObj2: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'CHEQUES EN CAJA [IBQuery.ID_CAJA]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj6: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'Rango del [:<yyyy/MM/dd>Fecha1] hasta el [:<yyyy/MM/dd>Fecha2]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
  ...
  object IBQuery: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  "caj$cheques".NUMERO_CHEQUE,'
      '  "caj$cheques".FECHA,'
      '  "caj$cheques".PLAZA,'
      '  "caj$cheques".VALOR,'
      '  "caj$cheques".ID_AGENCIA,'
      '  "caj$cheques".NUMERO_CUENTA,'
      '  "caj$cheques".ID_TIPO_CUENTA,'
      '  "caj$cheques".DIGITO_CUENTA,'
      ...
      '  "caj$cheques"'
        ...
        '  INNER JOIN "gen$bancos" ON ("caj$cheques".ID_BANCO = "gen$banc' +
        'os".ID_BANCO)'
      
        '  INNER JOIN CAJ$CAJAS ON ("caj$cheques".ID_CAJA = CAJ$CAJAS' +
        '.ID_CAJA)'
      
        '  INNER JOIN "gen$empleado" ON (CAJ$CAJAS.ID_EMPLEADO = "gen$e' +
        'mpleado".ID_EMPLEADO)'
      
        '  INNER JOIN "gen$agencia" ON ("caj$cheques".ID_AGENCIA = "gen$a' +
        'gencia".ID_AGENCIA)')
    Left = 264
    Top = 82
    object IBQueryID_CAJA: TSmallintField
      FieldName = 'ID_CAJA'
      Origin = 'caj$cheques.ID_CAJA'
      Required = True
    end
    ...
    object IBQueryNUMERO_CHEQUE: TIntegerField
      FieldName = 'NUMERO_CHEQUE'
      Origin = 'caj$cheques.NUMERO_CHEQUE'
      Required = True
    end
    object IBQueryFECHA: TDateField
      FieldName = 'FECHA'
      Origin = 'caj$cheques.FECHA'
    end
    object IBQueryPLAZA: TIBStringField
      FieldName = 'PLAZA'
      Origin = 'caj$cheques.PLAZA'
      Required = True
      FixedChar = True
      Size = 1
    end
    object IBQueryVALOR: TIBBCDField
      FieldName = 'VALOR'
      Origin = 'caj$cheques.VALOR'
      Required = True
      Precision = 18
      Size = 3
    end
    object IBQueryID_AGENCIA: TSmallintField
      ...
      Origin = 'caj$cheques.ID_AGENCIA'
      Required = True
    end
    object IBQueryNUMERO_CUENTA: TIntegerField
      FieldName = 'NUMERO_CUENTA'
      Origin = 'caj$cheques.NUMERO_CUENTA'
    end
    object IBQueryID_TIPO_CUENTA: TSmallintField
      FieldName = 'ID_TIPO_CUENTA'
      Origin = 'caj$cheques.ID_TIPO_CUENTA'
      Required = True
    end
    object IBQueryDIGITO_CUENTA: TIntegerField
      FieldName = 'DIGITO_CUENTA'
      Origin = 'caj$cheques.DIGITO_CUENTA'
    end
    object IBQueryPRIMER_APELLIDO: TIBStringField
      FieldName = 'PRIMER_APELLIDO'
      Origin = 'gen$empleado.PRIMER_APELLIDO'
      Size = 30
    end
    object IBQuerySEGUNDO_APELLIDO: TIBStringField
      FieldName = 'SEGUNDO_APELLIDO'
      Origin = 'gen$empleado.SEGUNDO_APELLIDO'
      Size = 30
    end
    object IBQueryNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'gen$empleado.NOMBRE'
      Size = 30
    end
    object IBQueryDESCRIPCION_AGENCIA: TIBStringField
