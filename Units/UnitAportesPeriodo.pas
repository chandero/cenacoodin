...
type
  TfrmAportesPeriodo = class(TForm)
    ...
    save: TSaveDialog;
    CdSaldoMUNICIPIO: TStringField;
    CdSaldoDPTO: TStringField;
    CdSaldoMCP: TStringField;
    CdSaldoPARTICIACION: TCurrencyField;
    IBSQLPor: TIBSQL;
    GroupBox2: TGroupBox;
    Label3: TLabel;
    Label5: TLabel;
    ...
    CdSaldoREVALORIZACION: TCurrencyField;
...
//
               ...
               CdSaldo.FieldValues['PARTICIACION'] := (FieldByName('VALOR').AsCurrency/JvTotal.Value) * 100;
