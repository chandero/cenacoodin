object frmRecuperarBarridoCartera: TfrmRecuperarBarridoCartera
  Left = 237
  Top = 207
  Width = 362
  Height = 158
  Caption = 'Impresi'#243'n de Barrido Cartera'
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    Height = 124
    Align = alClient
    Caption = 'Datos de Ultimo Barrido'
    TabOrder = 1
    ...
    object EdFechaHora: TLabeledEdit
      Left = 7
      Top = 38
      Width = 122
      Height = 21
      EditLabel.Width = 64
      EditLabel.Height = 13
      EditLabel.Caption = 'Fecha y Hora'
      LabelPosition = lpAbove
      LabelSpacing = 3
      ReadOnly = True
      TabOrder = 0
    end
    object EdNotaContable: TLabeledEdit
      Left = 132
      Top = 38
      Width = 74
      Height = 21
      EditLabel.Width = 68
      EditLabel.Height = 13
      EditLabel.Caption = 'Nota Contable'
      LabelPosition = lpAbove
      LabelSpacing = 3
      ReadOnly = True
      TabOrder = 1
    end
    object EdLiquidaciones: TLabeledEdit
      Left = 209
      Top = 38
      Width = 47
      Height = 21
  ...
  object IBGrupo2: TIBQuery
    ...
    SQL.Strings = (
      ...
      'and "col$extracto".ID_EMPLEADO = :ID_EMPLEADO'
  ...
  object IBGrupo1: TIBQuery
    ...
    SQL.Strings = (
      ...
      '           "col$extracto".SALDO_ANTERIOR_EXTRACTO,'
        ...
        '           ("col$extracto".SALDO_ANTERIOR_EXTRACTO - "col$extrac' +
        'to".ABONO_CAPITAL) as SALDO,'
      ...
      '           "col$extractodet".ID_AGENCIA = CON$PUC.ID_AGENCIA )'
        ...
        'TE_COLOCACION = "col$extracto".ID_CBTE_COLOCACION'
      
        '                                     and "col$extractodet".HORA_' +
        'EXTRACTO = "col$extracto".HORA_EXTRACTO)'
      
        '           inner join "gen$empleado" on ("col$extracto".ID_EMPLE' +
        'ADO = "gen$empleado".ID_EMPLEADO)'
      '           where'
      
        '           "col$extractodet".ID_CBTE_COLOCACION >= :"ID1" and "c' +
        'ol$extractodet".ID_CBTE_COLOCACION <= :"ID2"'
      
        '           and "col$extractodet".FECHA_EXTRACTO = :"FECHA_EXTRAC' +
        'TO" and "col$extracto".ID_EMPLEADO = :ID_EMPLEADO'
      
        '           order by "col$extractodet".ID_CBTE_COLOCACION,  "col$' +
        'extractodet".VALOR_CREDITO')
    Left = 35
    Top = 52
    ParamData = <
      item
  ...
  object ReporteBarrido: TprTxReport
    ShowProgress = True
    DesignerFormMode = fmMDIChild
    ...
    OnUnknownVariable = ReporteBarridoUnknownVariable
    OnPrintComplete = ReporteBarridoPrintComplete
    WrapAfterColumn = 0
    EjectPageAfterPrint = False
    PaperType = ptRulon
    UseLinesOnPage = True
    ...
    object prTxPage1: TprTxPage
      ...
      object prTxHDetailFooterBand1: TprTxHDetailFooterBand
        Height = 4
        UseVerticalBands = False
        DetailBand = ReporteBarrido.prTxHDetailBand1
        ColCount = 1
        ColDirection = prcdTopBottomLeftRight
        LinkToDetail = True
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'ELABORO: [IBGrupo1.NOMEMPLEADO] [IBGrupo1.APE1EMPLEADO] [IBGrupo' +
                  '1.APE2EMPLEADO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
    ...
    object prTxPage3: TprTxPage
      ...
      object prTxHDetailFooterBand2: TprTxHDetailFooterBand
        Height = 2
        UseVerticalBands = False
        DetailBand = ReporteBarrido.prTxHDetailBand2
        ColCount = 0
        ColDirection = prcdTopBottomLeftRight
        LinkToDetail = True
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'ELABORO:[IBGrupo1.NOMEMPLEADO] [IBGrupo1.APE1EMPLEADO] [IBGrupo1' +
                  '.APE2EMPLEADO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
    ...
    object grupo1: TprGroup
      ...
      DetailBand = ReporteBarrido.prTxHDetailBand3
    end
