...
begin
        ...
        //FormularioN.LoadFromFile('ReportesCap\FormularioDatosPersonaNaturalCooperativas.frf');
        FormularioN.LoadFromFile('ReportesCap\FormularioDatosPersonaNaturalNuevo2.frf');
