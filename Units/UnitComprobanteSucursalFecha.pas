unit UnitComprobanteSucursalFecha;
...
type
  TFrmComprobanteSucursalFecha = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
    Label2: TLabel;
...
var
  FrmComprobanteSucursalFecha: TFrmComprobanteSucursalFecha;

implementation
uses UnitVistaPreliminar,UnitGlobales,UnitdmGeneral;
{$R *.dfm}

procedure TFrmComprobanteSucursalFecha.EdFechaChange(Sender: TObject);
...
procedure TFrmComprobanteSucursalFecha.FormShow(Sender: TObject);
begin
...
procedure TFrmComprobanteSucursalFecha.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
        EnterTabs(Key,Self);
end;

procedure TFrmComprobanteSucursalFecha.CmdCerrarClick(Sender: TObject);
var    i:Integer;
begin
        Close;
end;

procedure TFrmComprobanteSucursalFecha.CmdGeneraClick(Sender: TObject);
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                ParamByName('DESCRIPCION').AsString := 'Contabilizaci?n de Movimientos de la Agencia  ' + IBSQL4.FieldByName('DESCRIPCION_AGENCIA').AsString + ', CAJA '+
...
//
               ...
               begin
                 ...
                 ParamByName('FECHA').AsDate := EdFecha.Date;
                 ExecQuery;
                 //Validacion para el comprobante del fin de semana
                 Close;
                 SQL.Clear;
               end;
...
{        with IBSQLColocacion do begin
           ...
           try
             ...
             while not eof do begin
              ...
              if NoHay then
              begin
                MessageDlg('No Existe Informaci?n para el comprobante',mtInformation,[mbok],0);
              end;
           except
...
procedure TFrmComprobanteSucursalFecha.EdFechaEnter(Sender: TObject);
begin
        EdFechaChange(Sender);
end;

procedure TFrmComprobanteSucursalFecha.cmdReporteClick(Sender: TObject);
begin
...
function TFrmComprobanteSucursalFecha.codigo_remoto(id_agencia,
...
procedure TFrmComprobanteSucursalFecha.FormCloseQuery(Sender: TObject;
