  ...
  object ReportBalance: TprTxReport
    ...
    Values = <
      ...
      item
        ...
        AggFunction = prafSum
        Formula = 'IBQTabla1.DEBITOANT + IBQTabla1.DEBITOMOV'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'IBQTabla1'
        Accumulate = True
      ...
      item
        ...
        AggFunction = prafSum
        Formula = 'IBQTabla1.CREDITOANT + IBQTabla1.CREDITOMOV'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'IBQTabla1'
        Accumulate = True
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[:<#,##0.00>iif(((IBQTabla.DEBITOANT + IBQTabla.DEBITOMOV)-(IBQT' +
                  'abla.CREDITOANT+IBQTabla.CREDITOMOV))>0,((IBQTabla.DEBITOANT + I' +
                  'BQTabla.DEBITOMOV)-(IBQTabla.CREDITOANT+IBQTabla.CREDITOMOV)),0)' +
                  ']')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[:<#,##0.00>iif(((IBQTabla.DEBITOANT + IBQTabla.DEBITOMOV)-(IBQT' +
                  'abla.CREDITOANT+IBQTabla.CREDITOMOV))<0,-((IBQTabla.DEBITOANT + ' +
                  'IBQTabla.DEBITOMOV)-(IBQTabla.CREDITOANT+IBQTabla.CREDITOMOV)),0' +
                  ')]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[:<#,##0.00>iif(((IBQTabla1.DEBITOANT + IBQTabla1.DEBITOMOV)-(IB' +
                  'QTabla1.CREDITOANT+IBQTabla1.CREDITOMOV))>0,((IBQTabla1.DEBITOAN' +
                  'T + IBQTabla1.DEBITOMOV)-(IBQTabla1.CREDITOANT+IBQTabla1.CREDITO' +
                  'MOV)),0)]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[:<#,##0.00>iif(((IBQTabla1.DEBITOANT + IBQTabla1.DEBITOMOV)-(IB' +
                  'QTabla1.CREDITOANT+IBQTabla1.CREDITOMOV))<0,-((IBQTabla1.DEBITOA' +
                  'NT + IBQTabla1.DEBITOMOV)-(IBQTabla1.CREDITOANT+IBQTabla1.CREDIT' +
                  'OMOV)),0)]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
