...
type
  TfrmInformeChequesenCaja = class(TForm)
    ...
    Report: TprTxReport;
    IBQueryDESCRIPCION_AGENCIA: TIBStringField;
...
uses UnitGlobales,UnitVistaPreliminar, UnitdmGeneral;
...
procedure TfrmInformeChequesenCaja.FormCreate(Sender: TObject);
begin
