object frmAgregarObservacionCobro: TfrmAgregarObservacionCobro
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 119
      Height = 13
      Caption = 'Fecha de la Observaci'#243'n'
    end
    object Label2: TLabel
      ...
      Width = 107
      Height = 13
      Caption = 'Fecha del Compromiso'
    end
    object EdFechaObservacion: TDateTimePicker
      Left = 14
      Top = 16
      Width = 97
      Height = 21
    ...
    object ChkCompromiso: TCheckBox
      Left = 128
      Top = 18
      Width = 111
      Height = 17
      Caption = 'Es Un Compromiso'
      TabOrder = 1
      OnClick = ChkCompromisoClick
    end
