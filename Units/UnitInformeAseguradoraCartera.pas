...
begin
        ...
        if PersonasJuridicas.Checked then begin
           with IBQTabla do begin
            Close;
            SQL.Clear;
            SQL.Add('SELECT "col$causaciondiaria".ID_AGENCIA, "col$causaciondiaria".ID_COLOCACION, "col$causaciondiaria".ID_PERSONA, "gen$agencia".DESCRIPCION_AGENCIA,');
            SQL.Add('"gen$persona".NOMBRE, "gen$persona".PRIMER_APELLIDO,');
            SQL.Add('"gen$persona".SEGUNDO_APELLIDO,');
            SQL.Add('"col$causaciondiaria".FECHA_DESEMBOLSO,"col$causaciondiaria".VALOR,');
            SQL.Add('("col$causaciondiaria".TASA_INTERES_CORRIENTE + "col$causaciondiaria".PUNTOS_INTERES) as TASA,');
            SQL.Add('"col$colocacion".PLAZO_COLOCACION, "col$causaciondiaria".FECHA_CAPITAL,"col$causaciondiaria".FECHA_INTERES,');
            SQL.Add('"col$colocacion".NUMERO_CUENTA, "col$causaciondiaria".DEUDA,');
            SQL.Add('"col$causaciondiaria".ID_ARRASTRE,"col$estado".DESCRIPCION_ESTADO_COLOCACION');
            SQL.Add('FROM "col$causaciondiaria"');
            SQL.Add('LEFT JOIN "gen$persona" ON ("col$causaciondiaria".ID_PERSONA = "gen$persona".ID_PERSONA) AND ("col$causaciondiaria".ID_IDENTIFICACION = "gen$persona".ID_IDENTIFICACION)');
            ...
            SQL.Add('WHERE ("col$causaciondiaria".ID_IDENTIFICACION = 4 or "col$causaciondiaria".ID_IDENTIFICACION = 7) and');
            SQL.Add('"col$causaciondiaria".ID_ESTADO <= 2 and "col$causaciondiaria".FECHA_CORTE = :FECHA_CORTE AND DEUDA > 0');
        ...
        if Mora.Checked then begin
           with IBQTabla do begin
            ...
            SQL.Add('where MOROSIDAD > :DIAS and FECHA_CORTE = :FECHA');
