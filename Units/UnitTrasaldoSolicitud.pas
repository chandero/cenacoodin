...
uses
  ...
  IBQuery, IBExtract, Buttons, Mask, IBDatabase, IBSQL;
...
begin
        ...
        begin
          ...
          Close;
          SQL.Clear;
          SQL.Add('insert into "col$solicitudanalista" values (:AGENCIA,:ID_SOLICITUD,:ID_EMPLEADO,:FECHAHORA,1,:ID_EMPLEADO_TRAS,0,0,-1)');
          ParamByName('ID_SOLICITUD').AsString := MKsolicitud.Text;
