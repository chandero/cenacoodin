object frmDevolucionCheques: TfrmDevolucionCheques
  Left = 204
  Top = 188
  BorderStyle = bsDialog
  Caption = 'Devoluci'#243'n de Cheques'
  ClientHeight = 446
  ClientWidth = 788
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 135
      Height = 13
      Caption = 'Total de Cheques Devueltos'
    end
    object Label2: TLabel
      ...
      Width = 133
      Height = 13
      Caption = 'Notas Contables Generadas'
    end
    object EdTotalConsignaciones: TStaticText
      Left = 182
      Top = 4
      Width = 32
      Height = 20
  ...
  object SGCheques: TJvStringGrid
    Left = 0
    Top = 0
    Width = 788
    Height = 386
    ...
    TabOrder = 0
    OnClick = SGChequesClick
    OnGetEditText = SGChequesGetEditText
    OnKeyPress = SGChequesKeyPress
    OnSelectCell = SGChequesSelectCell
    Alignment = taLeftJustify
    OnExitCell = SGChequesExitCell
    OnGetCellAlignment = SGChequesGetCellAlignment
    ...
    object DBLCBTipoAhorro: TDBLookupComboBox
      ...
      TabStop = False
      Visible = False
      OnEnter = DBLCBTipoAhorroEnter
      OnExit = DBLCBTipoAhorroExit
    end
    ...
    object DBLCBContable: TDBLookupComboBox
      Left = 38
      Top = 118
      Width = 180
      Height = 21
      ...
      KeyField = 'ID_BANCO'
      ListField = 'DESCRIPCION'
      ListSource = DSContable
      TabOrder = 3
      TabStop = False
      Visible = False
      OnEnter = DBLCBContableEnter
      OnExit = DBLCBContableExit
    end
  end
  object IBQBancos: TIBQuery
    ...
    SQL.Strings = (
      'select * from "gen$bancos" order by  "gen$bancos".ID_BANCO')
    Left = 32
    Top = 152
  end
  object IBQTipoAhorro: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = dmGeneral.IBTransaction1
    SQL.Strings = (
      'select * from "cap$tipocaptacion"'
      
        'inner join "cap$tiposforma" on ("cap$tiposforma".ID_FORMA = "cap' +
        '$tipocaptacion".ID_FORMA)'
      'where'
  ...
  object DSTipoAhorro: TDataSource
    DataSet = IBQTipoAhorro
    Left = 56
    Top = 208
  end
  ...
  object reporte: TprTxReport
    ...
    OnInitDetailBandDataSet = reporteInitDetailBandDataSet
  ...
  object IBQContable: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = dmGeneral.IBTransaction1
    SQL.Strings = (
      
        'select * from GEN$BANCOSCONNAL order by  GEN$BANCOSCONNAL.ID' +
        '_BANCO')
    Left = 48
    Top = 88
  end
  object DSContable: TDataSource
    DataSet = IBQContable
    Left = 80
    Top = 88
  end
