object frmInformeCuentasporEstado: TfrmInformeCuentasporEstado
  Left = 370
  Top = 281
  ...
  object Reporte: TprTxReport
    ...
    Variables = <
      ...
      item
        Name = 'EMPLEADO'
        ValueType = 'prvvtString'
        Value = 'AREA DISE'#209'O Y DESARROLLO'
      end
      item
        Name = 'ESTADO'
        ValueType = 'prvvtString'
        ...
        object prTxMemoObj2: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'INFORME DE CUENTAS CON ESTADO "[ESTADO]"')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[Trim(IBQuery1.PRIMER_APELLIDO+" "+IBQuery1.SEGUNDO_APELLIDO+" "' +
                  '+IBQuery1.NOMBRE)]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
        ...
        object prTxMemoObj14: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'TOTAL DE CUENTAS CON ESTADO "[ESTADO]" : [:<#,0>TOTAL]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
