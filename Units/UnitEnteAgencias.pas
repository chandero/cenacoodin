...
uses
  ...
  IBQuery, IBDatabase, ImgList, DateUtils, Math, FR_DSet, FR_DBSet, JPEG,
  ...
  JvThreadTimer, IBSQL, XMLIntf, XMLDoc, IdHTTP, IdGlobal, UnitProgreso;
...
type
  TFrmEnteAgencias = class(TForm)
    ...
    IBQuery1: TIBQuery;
    CDfianzasfecha_interes: TStringField;
    CDcodeudoresfoto: TBlobField;
    CDcodeudoresfirma: TBlobField;
    Image1: TImage;
    ...
    procedure CDcodeudoresAfterScroll(DataSet: TDataSet);
  private
    codigo_ente :Integer;
    id_persona: string;
...
var
  ...
  frmProgreso: TfrmProgresoServer;
...
uses UnitDmSolicitud, UnitAnalisisPago, UnitDesreferencias,
  ...
  UnitMain, UnitConsultaProductos, unitGlobales,
...
begin
        ...
        frmProgreso := TfrmProgresoServer.Create(Self);
end;
...
begin
        ...
        begin
           imprimir_reporte(frmMain.wpath+'reporte\repinformegerenciaof.frf');
           Exit;
        end;
        if CHverifica.Checked then
...
begin
        ...
        Try
          ...
          frreport1.SavePreparedReport(frmMain._sSession + '\' + IntToStr(DbOficina.KeyValue) + Msolicitud.Text + '.frp');
        except
        end;
...
var     numero,estado,id_pagointeres :Integer;
        ...
        XMLCreditos,XMLFianzas, XMLCapacidades,
        XMLObservaciones,XMLCodeudores,
        XMLConceptos,XMLTipoObservaciones,
        XMLDescuentos, XMLReferencia: IXMLNode;
        msFoto: TMemoryStream;
        msFirma: TMemoryStream;
        dataFoto: String;
        dataFirma: String;
...
begin
      ...
      begin
        cadena := GetURLAsString('http://'+host_server+':'+IntToStr(puerto_server)+'/sif/rest/eas/sol/'+Msolicitud.Text);
        if (cadena <> '') then begin
          ...
          try
             ...
             for i := 0 to XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes.Count - 1 do
             begin
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'enteaprobador') then
              begin
                  DBente.KeyValue := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'documento') then
              begin
                  JVid_persona.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'nombre') then
              begin
                  JVsolicitante.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'numeroCuenta') then
              begin
                  JVcuenta.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'fechaRecepcion') then
              begin
                  JVfecha.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'numeroCodeudores') then
              begin
                  JVcodeudores.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'valor') then
              begin
                  JVvalor.Value := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'valorAprobado') then
              begin
               JVvalora.Value := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              ...
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'amortizacionCapital') then
              begin
                  JVamortizacion.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'amortizacionInteres') then
              begin
                  JVpagointeres.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'respaldo') then
              begin
                  JVrespaldo.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'garantia') then
              begin
                  JVgarantia.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'destino') then
              begin
                 EDgarantia.Text := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'tipoCuota') then
              begin
                  JVtipocuota.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'plazo') then
              begin
                  JVplazo.Value := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'plazoAprobado') then
              begin
                 JVPlazoa.Value :=  XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if  (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'linea') then
              begin
                id_linea := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
                IBSQL3.SQL.Clear;
                IBSQL3.SQL.Add('select TASA from "col$lineas"');
                IBSQL3.SQL.Add('where ID_LINEA = :ID_LINEA');
                IBSQL3.ParamByName('ID_LINEA').AsInteger := id_linea;
                IBSQL3.ExecQuery;
                JVtasaa.Value := IBSQL3.FieldByName('TASA').AsCurrency;
                IBSQL3.Close;
                DBLinea.KeyValue := id_linea;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'inversion') then
              begin
                  EDinversion.Text := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'clasificacion') then
              begin
                  EDclasificacion.Text := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'aporte') then
              begin
                  JVaportes.Value := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'ordinario') then
              begin
                  JVahorro.Value := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'juvenil') then
              begin
                  JVjuvenil.Value := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'contractual') then
              begin
                  JVcontractual.Value := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'cdat') then
              begin
                  JVcdat.Value := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'colocaciones') then
              begin  // data creditos
              // A mover
                 XMLCreditos := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i];
                 if (Assigned(XMLCreditos)) then
                 begin
                   try
                     CDcreditos.Open;
                     CDcreditos.Append;
                     try
                     if ((XMLCreditos.ChildNodes.FindNode('id_credito')) <> nil) then
                       CDcreditosid_colocacion.Value := XMLCreditos.ChildNodes.Nodes['id_credito'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCreditos.ChildNodes.FindNode('id_persona')) <> nil) then
                       CDcreditosid_persona.Value := XMLCreditos.ChildNodes.Nodes['id_persona'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCreditos.ChildNodes.FindNode('valor_cuota')) <> nil) then
                       CDcreditosvalor_cuota.Value := XMLCreditos.ChildNodes.Nodes['valor_cuota'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCreditos.ChildNodes.FindNode('fecha_capital')) <> nil) then
                       CDcreditosfecha_capital.Value := XMLCreditos.ChildNodes.Nodes['fecha_capital'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCreditos.ChildNodes.FindNode('fecha_interes')) <> nil) then
                       CDcreditosfecha_interes.Value := XMLCreditos.ChildNodes.Nodes['fecha_interes'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCreditos.ChildNodes.FindNode('saldo')) <> nil) then
                       CDcreditossaldo.Value := XMLCreditos.ChildNodes.Nodes['saldo'].NodeValue;
                     except
                     end;
                     CDcreditos.Post;
                   except
              ...
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'fianzas') then
              begin  // data fianzas
              // A mover
                 XMLFianzas := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i];
                 if (Assigned(XMLFianzas)) then
                 begin
                   try
                     CDfianzas.Open;
                     CDfianzas.Append;
                     try
                     if ((XMLFianzas.ChildNodes.FindNode('id_colocacion'))<> nil) then
                       CDfianzasid_colocacion.Value := XMLFianzas.ChildNodes.Nodes['id_colocacion'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLFianzas.ChildNodes.FindNode('fecha_interes')) <>  nil) then
                       CDfianzasfecha_interes.Value := XMLFianzas.ChildNodes.Nodes['fecha_interes'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLFianzas.ChildNodes.FindNode('saldo')) <> nil) then
                       CDfianzassaldo.Value := XMLFianzas.ChildNodes.Nodes['saldo'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLFianzas.ChildNodes.FindNode('estado')) <> nil) then
                       CDfianzasestado.Value := XMLFianzas.ChildNodes.Nodes['estado'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLFianzas.ChildNodes.FindNode('id_persona'))<> nil) then
                       CDfianzasid_persona.Value := XMLFianzas.ChildNodes.Nodes['id_persona'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLFianzas.ChildNodes.FindNode('valor_desembolso'))<>nil) then
                       CDfianzasvalor_desembolso.Value := XMLFianzas.ChildNodes.Nodes['valor_desembolso'].NodeValue;
                     except
                     end;
                     CDfianzas.Post;
                   except
              ...
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'capacidades') then
              begin  // data capacidades
              // A mover
                 XMLCapacidades := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i];
                 if (Assigned(XMLCapacidades)) then
                 begin
                     CDcapacidad.Open;
                     CDcapacidad.Append;
                     try
                     if ((XMLCapacidades.ChildNodes.FindNode('id_identificacion')) <> nil) then
                       CDcapacidadid_identificacion.Value := XMLCapacidades.ChildNodes.Nodes['id_identificacion'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCapacidades.ChildNodes.FindNode('id_persona')) <> nil) then
                       CDcapacidadid_persona.Value := XMLCapacidades.ChildNodes.Nodes['id_persona'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCapacidades.ChildNodes.FindNode('ingresos')) <> nil) then
                       CDcapacidadingresos.Value := XMLCapacidades.ChildNodes.Nodes['ingresos'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCapacidades.ChildNodes.FindNode('deducciones')) <> nil) then
                       CDcapacidaddeducciones.Value := XMLCapacidades.ChildNodes.Nodes['deducciones'].NodeValue;
                     except
                     end;
                     try
                     if (XMLCapacidades.ChildNodes.FindNode('disponible') <> nil) then
                     //if (Assigned(XMLCapacidades.ChildNodes.Nodes['disponible'])) then
                       CDcapacidaddisponible.Value := XMLCapacidades.ChildNodes.Nodes['disponible'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCapacidades.ChildNodes.FindNode('valor_cuota')) <> nil) then
                       CDcapacidadvalor_cuota.Value := XMLCapacidades.ChildNodes.Nodes['valor_cuota'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCapacidades.ChildNodes.FindNode('disp_pago')) <> nil) then
                       CDcapacidaddisp_pago.Value := XMLCapacidades.ChildNodes.Nodes['disp_pago'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCapacidades.ChildNodes.FindNode('solv_economica')) <> nil ) then
                       CDcapacidadsolv_economica.Value := XMLCapacidades.ChildNodes.Nodes['solv_economica'].NodeValue;
                     except
                     end;
                     try
                     if (XMLCapacidades.ChildNodes.FindNode('definicion') <> nil) then
                     //if (Assigned(XMLCapacidades.ChildNodes.Nodes['definicion'])) then
                       CDcapacidaddefinicion.Value := XMLCapacidades.ChildNodes.Nodes['definicion'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCapacidades.ChildNodes.FindNode('exp_creditos')) <> nil) then
                       CDcapacidadexp_creditos.Value := XMLCapacidades.ChildNodes.Nodes['exp_creditos'].NodeValue;
                     except
                     end;
                     CDcapacidad.Post;
                 end;
              ...
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'observaciones') then
              begin  // data capacidades
              // A mover
                 XMLObservaciones := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i];
                 if (Assigned(XMLObservaciones)) then
                 begin
                     CDobservacion.Open;
                     CDobservacion.Append;
                     try
                     if ((XMLObservaciones.ChildNodes.FindNode('observacion')) <> nil) then
                       CDobservacionobservacion.Value := XMLObservaciones.ChildNodes.Nodes['observacion'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLObservaciones.ChildNodes.FindNode('id_observacion')) <>  nil) then
                       CDobservacionid_observacion.Value := XMLObservaciones.ChildNodes.Nodes['id_observacion'].NodeValue;
                     except
                     end;
                     CDobservacion.Post;
                     CDtipoobservacion.Open;
                     CDtipoobservacion.Append;
                     CDtipoobservacion.FieldValues['tipo'] := XMLObservaciones.ChildNodes.Nodes['id_observacion'].NodeValue;

                     IBSQL3.SQL.Clear;
                     IBSQL3.SQL.Add('SELECT');
                     IBSQL3.SQL.Add('"col$tipoobservacion".DESCRIPCION');
                     IBSQL3.SQL.Add('FROM');
                     IBSQL3.SQL.Add('"col$tipoobservacion"');
                     IBSQL3.SQL.Add('WHERE');
                     IBSQL3.SQL.Add('("col$tipoobservacion".ID_TIPO IN (:TIPO))');
                     IBSQL3.ParamByName('TIPO').AsInteger := XMLObservaciones.ChildNodes.Nodes['id_observacion'].NodeValue;
                     IBSQL3.ExecQuery;
                     CDtipoobservacion.FieldValues['descripcion'] := IBSQL3.FieldByName('DESCRIPCION').AsString;
                     CDtipoobservacion.FieldValues['observacion'] := XMLObservaciones.ChildNodes.Nodes['observacion'].NodeValue;
                     CDtipoobservacion.Post;
                     IBSQL3.Close;
                 end;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'codeudores') then
              begin  // data capacidades
              // A mover
                 XMLCodeudores := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i];
                 if (Assigned(XMLCodeudores)) then
                 begin
                     CDcodeudores.Open;
                     CDcodeudores.Append;

                     try
                     if ((XMLCodeudores.ChildNodes.FindNode('id_identificacion')) <> nil) then
                       CDcodeudoresid_identificacion.Value := XMLCodeudores.ChildNodes.Nodes['id_identificacion'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCodeudores.ChildNodes.FindNode('id_persona'))<> nil) then
                       CDcodeudoresid_persona.Value := XMLCodeudores.ChildNodes.Nodes['id_persona'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCodeudores.ChildNodes.FindNode('nombres')) <> nil) then
                       CDcodeudoresnombres.Value := XMLCodeudores.ChildNodes.Nodes['nombres'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCodeudores.ChildNodes.FindNode('definicion')) <> nil) then
                       CDcodeudoresdefinicion.Value := XMLCodeudores.ChildNodes.Nodes['definicion'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCodeudores.ChildNodes.FindNode('numero')) <> nil) then
                       CDcodeudoresnumero.Value := XMLCodeudores.ChildNodes.Nodes['numero'].NodeValue;
                     except
                     end;
                     try
                     if ((XMLCodeudores.ChildNodes.FindNode('foto')) <> nil) then
                       dataFoto := XMLCodeudores.ChildNodes.Nodes['foto'].NodeValue;
                       msFoto := TMemoryStream.Create;
                       if (Length(dataFoto) > 0) then begin
                        IdDecoderMIME1.DecodeStream(dataFoto,msFoto);
                        CDcodeudoresfoto.LoadFromStream(msFoto);
                       end;
                       FreeAndNil(msFoto);
                     except
                     end;
                     try
                     if ((XMLCodeudores.ChildNodes.FindNode('firma')) <> nil) then
                       dataFirma := XMLCodeudores.ChildNodes.Nodes['firma'].NodeValue;
                       msFirma := TMemoryStream.Create;
                       if (Length(dataFirma) > 0) then begin
                        IdDecoderMIME1.DecodeStream(dataFirma,msFoto);
                        CDcodeudoresfirma.LoadFromStream(msFirma);
                       end;
                       FreeAndNil(msFirma);
                     except
                     end;
              ...
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'concepto') then
              begin  // data concepto
              // A mover
                 XMLConceptos := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i];
                 if (Assigned(XMLConceptos)) then
                 begin
                     CDconcepto.Open;
                     CDconcepto.Append;
                     try
                     if (Assigned(XMLConceptos.ChildNodes.Nodes['tipo'])) then
                       CDconceptotipo.Value := XMLConceptos.ChildNodes.Nodes['tipo'].NodeValue;
                     except
                     end;
                     try
                     if (Assigned(XMLConceptos.ChildNodes.Nodes['concepto'])) then
                       CDconceptoconcepto.Value := XMLConceptos.ChildNodes.Nodes['concepto'].NodeValue;
                     except
                     end;
                     try
                     if (Assigned(XMLConceptos.ChildNodes.Nodes['descripcion'])) then
                       CDconceptodescripcion.Value := XMLConceptos.ChildNodes.Nodes['descripcion'].NodeValue;
                     except
                     end;
                     CDconcepto.Post;
                 end;
              ...
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'descuentos') then
              begin  // data concepto
              // A mover
                 XMLDescuentos := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i];
                 if (Assigned(XMLDescuentos)) then
                 begin
                     CDdescuentos.Open;
                     CDdescuentos.Append;
                     try
                     if (Assigned(XMLDescuentos.ChildNodes.Nodes['tipo'])) then
                       CDconceptotipo.Value := XMLDescuentos.ChildNodes.Nodes['tipo'].NodeValue;
                     except
                     end;
                     CDdescuentos.Post;
                 end;
              ...
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'referencias') then
              begin
                  XMLReferencia := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i];
                  if (Assigned(XMLReferencia)) then
                  begin
                    FrmReferencias.ClientDataSet1.Append;
                    if (XMLReferencia.ChildNodes.FindNode('nombre') <> nil) then
                      FrmReferencias.ClientDataSet1.FieldValues['nombre'] := XMLReferencia.ChildNodes.Nodes['nombre'].NodeValue;
                    if (XMLReferencia.ChildNodes.FindNode('telefono') <> nil) then
                      FrmReferencias.ClientDataSet1.FieldValues['telefono'] := XMLReferencia.ChildNodes.Nodes['telefono'].NodeValue;
                    if (XMLReferencia.ChildNodes.FindNode('direccion') <> nil) then
                      FrmReferencias.ClientDataSet1.FieldValues['direccion'] := XMLReferencia.ChildNodes.Nodes['direccion'].NodeValue;
                    if (XMLReferencia.ChildNodes.FindNode('tipo') <> nil) then
                    begin

                     IBSQL3.SQL.Clear;
                     IBSQL3.SQL.Add('SELECT');
                     IBSQL3.SQL.Add('"gen$tiposreferencia".DESCRIPCION_REFERENCIA');
                     IBSQL3.SQL.Add('FROM');
                     IBSQL3.SQL.Add('"gen$tiposreferencia"');
                     IBSQL3.SQL.Add('WHERE');
                     IBSQL3.SQL.Add('("gen$tiposreferencia".ID_REFERENCIA = :ID_REFERENCIA)');
                     IBSQL3.ParamByName('ID_REFERENCIA').AsInteger := XMLReferencia.ChildNodes.Nodes['tipo'].NodeValue;
                     IBSQL3.ExecQuery;
                     FrmReferencias.ClientDataSet1.FieldValues['tipo_referencia'] := IBSQL3.FieldByName('DESCRIPCION_REFERENCIA').AsString;
                     IBSQL3.Close;

                    end;
                    if (XMLReferencia.ChildNodes.FindNode('parentesco') <> nil) then
                    begin
                     IBSQL3.SQL.Clear;
                     IBSQL3.SQL.Add('SELECT');
                     IBSQL3.SQL.Add('"gen$tiposparentesco".DESCRIPCION_PARENTESCO');
                     IBSQL3.SQL.Add('FROM');
                     IBSQL3.SQL.Add('"gen$tiposparentesco"');
                     IBSQL3.SQL.Add('WHERE');
                     IBSQL3.SQL.Add('("gen$tiposparentesco".ID_PARENTESCO = :ID_PARENTESCO)');
                     IBSQL3.ParamByName('ID_PARENTESCO').AsInteger := XMLReferencia.ChildNodes.Nodes['parentesco'].NodeValue;
                     IBSQL3.ExecQuery;
                     FrmReferencias.ClientDataSet1.FieldValues['parentesco'] := IBSQL3.FieldByName('DESCRIPCION_PARENTESCO').AsString;
                     IBSQL3.Close;
      ...
      if CDcreditos.RecordCount > 0 then Rsi.Checked := true else Rno.Checked := true;
      ...
      with CDdescuentos do
              ...
              if ((not DBente.KeyValue = 2) and (not DBente.KeyValue = 3) and (not DBente.KeyValue = 8)) then
              begin
                  ShowMessage('Esta solicitud no puede ser evaluada, rectifique el estado de la misma');
                  Msolicitud.SetFocus;
                  Exit;
              end;
      {
...
begin
        ...
        //   Exit;
        if (JVvalora.Value >= _cValorMaximoInf) then
...
begin
        ...
        XMLData.ChildValues['idsolicitud'] := MSolicitud.Text;
        XMLData.ChildValues['acta'] := EDacta.Text;
        XMLData.ChildValues['valoraprobado'] := JVvalora.Value;
        XMLData.ChildValues['tasa'] := JVtasaa.Value;
        XMLData.ChildValues['enteaprobador'] := DBente.KeyValue;
        XMLData.ChildValues['fechaconcepto'] := FormatDateTime('yyyy/MM/dd',vFechaEnte);
        XMLData.ChildValues['plazoaprobado'] := JVplazoa.Value;
        XMLData.ChildValues['estado'] := estado;
        if (CHparcial.Checked) then
           XMLData.ChildValues['desembolsoparcial'] := 'true'
        else
           XMLData.ChildValues['desembolsoparcial'] := 'false';
        XMLData.ChildValues['observacion'] := Mconcepto.Text;
        XMLData.ChildValues['idobservacion'] := id_observacion;
        if (desembolso) then
            XMLData.ChildValues['aprobada'] := 'true'
        else
            XMLData.ChildValues['aprobada'] := 'false';
        XMLData.ChildValues['oficina'] := DBoficina.KeyValue;
        updated := false;
        cadena := PostURLAsString('http://'+host_server+':'+IntToStr(puerto_server)+'/sif/rest/eas/solup',XMLPeticion.XML);
        if (cadena <> '') then
        begin
          XMLResult := LoadXMLData(cadena);
          try
          if (XmlResult.ChildNodes.Count > 0) then
          begin
           for i := 0 to XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes.Count - 1 do
           begin
            if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'updated') then
            begin
                  updated :=  XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
            end;
           end;
           if updated then
           begin
          ...
          begin
              ShowMessage('No se actualizó la solicitud, por favor confirme la operación');
              exit;
          end;
         end
         else 
          begin
              ShowMessage('No se recibió información de respuesta de la Agencia Remota, por favor confirme la operación');
              exit;
          end;
        except
              ShowMessage('No se recibió respuesta de la Agencia Remota, por favor confirme la operación');
              exit;
        end;
        end
        else
          MessageDlg('No se recibió respuesta de la Agencia Remota, por favor confirme la operación',mtInformation,[mbok],0);
...
begin
        host_server := buscaservicio(DBoficina.KeyValue,3).vHost;
        puerto_server := buscaservicio(DBoficina.KeyValue,3).vPuerto;
{
...
function TFrmEnteAgencias.GetURLAsString(const aURL: string): string;
var
 IdHTTP1 : TIdHTTP;
begin
  try
...
function TFrmEnteAgencias.PostURLAsString(const aURL: string; const aRequest: TStrings): string;
var
  aBody: TStringStream;
  aResponse: String;
  IdHTTP1 : TIdHTTP;
...
procedure TFrmEnteAgencias.CDcodeudoresAfterScroll(DataSet: TDataSet);
var
 jpgFoto : TJPEGImage;
...
begin
            try
                ...
                (DataSet.FieldByName('foto') as TBlobField).SaveToStream(FotoStream);
                if FotoStream.Size > 0 then
                begin
                  FotoStream.Position := 0;
                  jpgFoto.LoadFromStream(FotoStream);
                  Image1.Picture.Bitmap.Assign(jpgFoto);
                end;
            finally
