...
procedure TfrmEfectivoNota.EdEfectivoEnter(Sender: TObject);
begin
        EdEfectivo.SelectAll;
end;

procedure TfrmEfectivoNota.EdChequeEnter(Sender: TObject);
begin
        EdCheque.SelectAll;
end;

procedure TfrmEfectivoNota.EdCreditoEnter(Sender: TObject);
begin
        EdCredito.SelectAll;
end;
