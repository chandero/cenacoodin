...
type
  TfrmCreacionPersona = class(TForm)
    ...
    Button3: TButton;
    EpadInk1: TEpadInk;
    InfoCompromisos: TTabSheet;
    Panel11: TPanel;
    btnModifcarCompromiso: TBitBtn;
    btnAgregarCompromiso: TBitBtn;
    btnRemoverCompromiso: TBitBtn;
    btnLimpiarCompromiso: TBitBtn;
    gridCompromiso: TDBGrid;
    Label80: TLabel;
    listTipoObligacion: TDBLookupComboBox;
    edEntidad: TLabeledEdit;
    edFechaVencimiento: TDateTimePicker;
    Label81: TLabel;
    Label82: TLabel;
    edSaldoActual: TJvCurrencyEdit;
    Label83: TLabel;
    edValorMensual: TJvCurrencyEdit;
    Label84: TLabel;
    CDScompromiso: TClientDataSet;
    DScompromiso: TDataSource;
    DStipoobligacion: TDataSource;
    CDScompromisoTIOB_ID: TIntegerField;
    CDScompromisoENTIDAD: TStringField;
    CDScompromisoFECHA_VENCIMIENTO: TDateField;
    CDScompromisoSALDO: TCurrencyField;
    CDScompromisoMENSUAL: TCurrencyField;
    chkEmpleado: TCheckBox;
    InfoFamiliaresEntidad: TTabSheet;
    Label85: TLabel;
    chkPeps: TCheckBox;
    edPrimerApellidoParentesco: TLabeledEdit;
    edSegundoApellidoParentesco: TLabeledEdit;
    edNombreParentesco: TLabeledEdit;
    listParentescoFamiliar: TDBLookupComboBox;
    rgConsejo: TRadioGroup;
    rgFamiliar: TRadioGroup;
    emailParentesco: TLabeledEdit;
    edIngresosPension: TMemo;
    Label87: TLabel;
    qTipoObligacion: TIBQuery;
    CBTipoPeps: TDBLookupComboBox;
    edValorGarantia: TJvCurrencyEdit;
    Label86: TLabel;
    listTipoGarantia: TDBLookupComboBox;
    CDScompromisoGARANTIA: TCurrencyField;
    CDScompromisoTIPOGARANTIA: TIntegerField;
    qTipoGarantia: TIBQuery;
    DStipogarantia: TDataSource;
    familiarPEPS: TTabSheet;
    DBGfamiliarpeps: TDBGrid;
    edNombreFamiliarPeps: TEdit;
    edPrimerApellidoFamiliarPeps: TEdit;
    edSegundoApellidoFamiliarPeps: TEdit;
    Label88: TLabel;
    Label89: TLabel;
    Label90: TLabel;
    Panel12: TPanel;
    btnModificarFamiliarPeps: TBitBtn;
    btnAgregarFamiliarPeps: TBitBtn;
    btnEliminarFamiliarPeps: TBitBtn;
    btnLimpiarFamiliarPeps: TBitBtn;
    Label91: TLabel;
    edParentescoFamiliarPEPS: TDBLookupComboBox;
    edEmailFamiliarPeps: TLabeledEdit;
    CDSfamiliarpeps: TClientDataSet;
    DSfamiliarpeps: TDataSource;
    CDSfamiliarpepsPRIMER_APELLIDO: TStringField;
    CDSfamiliarpepsSEGUNDO_APELLIDO: TStringField;
    CDSfamiliarpepsNOMBRE: TStringField;
    CDSfamiliarpepsID_PARENTESCO: TIntegerField;
    CDSfamiliarpepsDESCRIPCION_PARENTESCO: TStringField;
    CDSfamiliarpepsEMAIL: TStringField;
    ...
    procedure EpadInk1FirePadData(Sender: TObject; abs_x, abs_y,
      abs_z: Integer; fTouch: Smallint; dwTimestamp,
      dwSeqenceNum: Integer);
    procedure btnAgregarCompromisoClick(Sender: TObject);
    procedure chkPepsClick(Sender: TObject);
    procedure gridCompromisoCellClick(Column: TColumn);
    procedure btnLimpiarCompromisoClick(Sender: TObject);
    procedure btnModifcarCompromisoClick(Sender: TObject);
    procedure btnLimpiarFamiliarPepsClick(Sender: TObject);
    procedure btnAgregarFamiliarPepsClick(Sender: TObject);
    procedure btnModificarFamiliarPepsClick(Sender: TObject);
    procedure btnEliminarFamiliarPepsClick(Sender: TObject);
    procedure DBGfamiliarpepsCellClick(Column: TColumn);
  private
    Tipo : Integer;
    Doc : string;
    vAuxilio: Boolean;
...
type
   PListaObligacion = ^AListaObligacion;
   AListaObligacion = record
      TipoObligacion:Integer;
      Entidad:String;
...
begin
        ...
        dmPersona.IBDStipopeps.Open;
        dmPersona.IBDStipopeps.Last;
        dmPersona.IBDStipopeps.First;
        ...
        qTipoObligacion.Transaction := dmPersona.IBTPersonas;
        qTipoGarantia.Database := dmGeneral.IBDatabase1;
        qTipoGarantia.Transaction := dmPersona.IBTPersonas;
        qTipoGarantia.Open;
        qTipoGarantia.Last;
...
// valores iniciales información laboral
        ...
        qTipoContrato.Open;
        qTipoContrato.Last;
        qTipoObligacion.Open;
        qTipoObligacion.Last;
        vProfesion := '';
        EdProfesion.Text := '';
        vEmpresa := '';
        EdEmpresa.Text := '';
...
//           CBTiposIdentificacion.SetFocus;
        ...
        if ((Tipo <> 0) and (Tipo = 4) or (Tipo = 7)) and (Doc <> '') then
         ...
         CBTipoPeps.Enabled := false;
         edIngresosPension.Text := '';
         rgConsejo.ItemIndex := 0;
         rgFamiliar.ItemIndex := 0;
         edPrimerApellidoParentesco.Text := '';
         edSegundoApellidoParentesco.Text := '';
         edNombreParentesco.Text := '';
         listParentescoFamiliar.KeyValue := -1;
         emailParentesco.Text := '';

        edNombreFamiliarPeps.Text := '';
        edPrimerApellidoFamiliarPeps.Text := '';
        edSegundoApellidoFamiliarPeps.Text := '';
        edParentescoFamiliarPEPS.KeyValue := -1;
        edEmailFamiliarPeps.Text := '';
        CDSfamiliarpeps.EmptyDataSet;
        ...
        begin
            ...
            begin
               ...
               try
                 ...
                 _tImagenR := _tImagen.ConsultaImagen(vTipoIdentificacion,vIdentificacion);
...
//                     ImgHuellaC.Picture.Bitmap.FreeImage;
               ...
               try
                 ...
                 begin
                     ...
                     ImgFirmaC.Picture.Bitmap.Assign(jpg);
                     FreeAndNil(jpg);
                     ImgFirmaC.Repaint;
...
//                 ImgFirmaC.Picture.Bitmap.FreeImage;
            ...
            // Leer gen$persadicional2
            Close;
            SQL.Clear;
            SQL.Add('select * from "gen$persadicional2" where ');
            SQL.Add('ID_IDENTIFICACION = :ID_IDENTIFICACION and ');
            SQL.Add('ID_PERSONA = :ID_PERSONA');
            ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
            ParamByName('ID_PERSONA').AsString := vIdentificacion;
            ...
            if RecordCount > 0 then
            begin
                chkEmpleado.Checked := IntToBool(FieldByName('ES_EMPLEADO').AsInteger);
                chkPeps.Checked := IntToBool(FieldByName('ES_PEPS').AsInteger);
                rgConsejo.ItemIndex := FieldByName('PERTENECE_A').AsInteger;
                rgFamiliar.ItemIndex := FieldByName('ES_FAMILIAR_DE').AsInteger;
                edPrimerApellidoParentesco.Text := FieldByName('PRIMER_APELLIDO').AsString;
                edSegundoApellidoParentesco.Text := FieldByName('SEGUNDO_APELLIDO').AsString;
                edNombreParentesco.Text := FieldByName('NOMBRE').AsString;
                listParentescoFamiliar.KeyValue := FieldByName('ID_PARENTESCO').AsInteger;
                emailParentesco.Text := FieldByName('EMAIL').AsString;
                edIngresosPension.Text := FormatCurr('#,#0.00',FieldByName('INGRESOS_PENSION').AsCurrency);
                CBTipoPeps.KeyValue := FieldByName('ID_PEPS').AsInteger;
                if (chkPeps.Checked) then familiarPEPS.TabVisible := true else familiarPEPS.TabVisible := false;
            end
            else
            begin
                chkEmpleado.Checked := false;
                ...
                emailParentesco.Text := '';
                edIngresosPension.Text := '';
                familiarPEPS.TabVisible := false;
            end;
            // --
            // Leer Compromisos obligaciones
            SQL.Clear;
            SQL.Add('select * from "gen$persobligacion" where');
            SQL.Add('ID_IDENTIFICACION = :ID_IDENTIFICACION and ');
            SQL.Add('ID_PERSONA = :ID_PERSONA');
            ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
            ParamByName('ID_PERSONA').AsString := vIdentificacion;
            ...
            begin
                Last;
                First;
                CDScompromiso.EmptyDataSet;
                CDScompromiso.Open;
                while not eof do
                begin
                    CDScompromiso.Insert;
                    CDScompromisoTIOB_ID.Value := FieldByName('TIPO').AsInteger;
                    CDScompromisoENTIDAD.Value := FieldByName('ENTIDAD').AsString;
                    CDScompromisoFECHA_VENCIMIENTO.Value := FieldByName('FECHA_VENCIMIENTO').AsDateTime;
                    CDScompromisoSALDO.Value := FieldByName('SALDO').AsCurrency;
                    CDScompromisoMENSUAL.Value := FieldByName('VALOR_MENSUAL').AsCurrency;
                    CDScompromisoGARANTIA.Value := FieldByName('GARANTIA').AsCurrency;
                    CDScompromisoTIPOGARANTIA.Value := FieldByName('TIPO_GARANTIA').AsInteger;
                    CDScompromiso.Post;
                    Next;
                end;
            end;
            ...
            // *** inicioactualizacio hijos
              ...
              Close;
              SQL.Clear;
              SQL.Add('SELECT * FROM "gen$persobligacion" o WHERE o.ID_IDENTIFICACION = :ID_IDENTIFICACION and o.ID_PERSONA = :ID_PERSONA');
              ParamByName('ID_PERSONA').AsString := vIdentificacion;
              ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
              Open;
              while not Eof do
              ...
              Close;
              SQL.Clear;
              SQL.Add('SELECT f.*, p.* FROM GEN$FAMILIARPEPS f INNER JOIN "gen$tiposparentesco" p ON p.ID_PARENTESCO = f.ID_PARENTESCO WHERE ID_IDENTIFICACION = :ID_IDENTIFICACION and ID_PERSONA = :ID_PERSONA');
              ParamByName('ID_PERSONA').AsString := vIdentificacion;
              ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
              Open;
              while not Eof do
              begin
                  CDSfamiliarpeps.Insert;
                  CDSfamiliarpepsPRIMER_APELLIDO.Value := FieldByName('PRIMER_APELLIDO').AsString;
                  CDSfamiliarpepsSEGUNDO_APELLIDO.Value := FieldByName('SEGUNDO_APELLIDO').AsString;
                  CDSfamiliarpepsNOMBRE.Value := FieldByName('NOMBRE').AsString;
                  CDSfamiliarpepsID_PARENTESCO.Value := FieldByName('ID_PARENTESCO').AsInteger;
                  CDSfamiliarpepsDESCRIPCION_PARENTESCO.Value := FieldByName('DESCRIPCION_PARENTESCO').AsString;
                  CDSfamiliarpepsEMAIL.Value := FieldByName('EMAIL').AsString;
...
begin
      ...
      try
          ...
          if (vTipoIdentificacion = 4) or (vTipoIdentificacion = 7) then
           ...
           begin
             ...
             ExecSQL;
             try
               _cImagen.InsertarImagen(BS2,BS3,BS1,vIdentificacion,vTipoIdentificacion);
             except
             end;
             try
               BS1.Free;
      ...
      with dmPersona.IBQuery do
        begin
           ...
           // Pers adicional 2
           SQL.Clear;
           SQL.Add('insert into "gen$persadicional2" values(');
           SQL.Add(':ID_IDENTIFICACION,');
           SQL.Add(':ID_PERSONA,');
           SQL.Add(':ES_EMPLEADO,');
           SQL.Add(':ES_PEPS,');
           SQL.Add(':PERTENECE_A,');
           SQL.Add(':ES_FAMILIAR_DE,');
           SQL.Add(':PRIMER_APELLIDO,');
           SQL.Add(':SEGUNDO_APELLIDO,');
           SQL.Add(':NOMBRE,');
           SQL.Add(':ID_PARENTESCO,');
           SQL.Add(':EMAIL,');
           SQL.Add(':INGRESOS_PENSION,');
           SQL.Add(':ID_PEPS');
           SQL.Add(')');
           ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
           ParamByName('ID_PERSONA').AsString := vIdentificacion;
           ParamByName('ES_EMPLEADO').AsInteger := BooleanoToInt(chkEmpleado.Checked);
           ParamByName('ES_PEPS').AsInteger := BooleanoToInt(chkPeps.Checked);
           ParamByName('ID_PEPS').AsInteger := CBTipoPeps.KeyValue;
           ParamByName('PERTENECE_A').AsInteger := rgConsejo.ItemIndex;
           ParamByName('ES_FAMILIAR_DE').AsInteger := rgFamiliar.ItemIndex;
           ParamByName('PRIMER_APELLIDO').AsString := edPrimerApellidoParentesco.Text;
           ParamByName('SEGUNDO_APELLIDO').AsString := edSegundoApellidoParentesco.Text;
           ParamByName('NOMBRE').AsString := edNombreParentesco.Text;
           ParamByName('ID_PARENTESCO').AsInteger := listParentescoFamiliar.KeyValue;
           ParamByName('EMAIL').AsString := emailParentesco.Text;
           if (edIngresosPension.Text <> '') then
                   ParamByName('INGRESOS_PENSION').AsCurrency := StrToFloat(edIngresosPension.Text)
           else
                   ParamByName('INGRESOS_PENSION').AsCurrency := 0;
           ParamByName('ID_PEPS').AsInteger := CBTipoPeps.KeyValue;
           ExecSQL;

           // Compromisos
           SQL.Clear;
           SQL.Add('INSERT INTO "gen$persobligacion" VALUES (');
           SQL.Add(':ID_IDENTIFICACION, :ID_PERSONA, :TIPO,:ENTIDAD,:FECHA_VENCIMIENTO,:SALDO,:VALOR_MENSUAL,:GARANTIA,:TIPO_GARANTIA)');
           CDScompromiso.First;
           while not CDScompromiso.Eof do
           begin
                ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
                ParamByName('ID_PERSONA').AsString := vIdentificacion;
                ParamByName('TIPO').AsInteger := CDScompromisoTIOB_ID.Value;
                ParamByName('ENTIDAD').AsString := CDScompromisoENTIDAD.Value;
                ParamByName('FECHA_VENCIMIENTO').AsDate := CDScompromisoFECHA_VENCIMIENTO.Value;
                ParamByName('SALDO').AsCurrency := CDScompromisoSALDO.Value;
                ParamByName('VALOR_MENSUAL').AsCurrency := CDScompromisoMENSUAL.Value;
                ParamByName('GARANTIA').AsCurrency := CDScompromisoGARANTIA.Value;
                ParamByName('TIPO_GARANTIA').AsInteger := CDScompromisoTIPOGARANTIA.Value;
                ExecSQL;
                CDScompromiso.Next;
           end;
           ...
           // --
             ...
             Close;
             SQL.Clear;
             SQL.Add('INSERT INTO GEN$FAMILIARPEPS (ID_IDENTIFICACION, ID_PERSONA, PRIMER_APELLIDO, SEGUNDO_APELLIDO, NOMBRE, ID_PARENTESCO, EMAIL) VALUES (');
             SQL.Add(':ID_IDENTIFICACION, :ID_PERSONA, :PRIMER_APELLIDO, :SEGUNDO_APELLIDO, :NOMBRE, :ID_PARENTESCO, :EMAIL)');
             ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
             ParamByName('ID_PERSONA').AsString := vIdentificacion;
             CDSfamiliarpeps.First;
             while not CDSfamiliarpeps.Eof do
             begin
                 ParamByName('PRIMER_APELLIDO').AsString := CDSfamiliarpepsPRIMER_APELLIDO.Value;
                 ParamByName('SEGUNDO_APELLIDO').AsString := CDSfamiliarpepsSEGUNDO_APELLIDO.Value;
                 ParamByName('NOMBRE').AsString := CDSfamiliarpepsNOMBRE.Value;
                 ParamByName('ID_PARENTESCO').AsInteger := CDSfamiliarpepsID_PARENTESCO.Value;
                 ParamByName('EMAIL').AsString := CDSfamiliarpepsEMAIL.Value;
                 ExecSQL;
                 CDSfamiliarpeps.Next;
             end;
        end;
        Transaction.Commit;
        Result := true;
...
//           SQL.Add('"gen$persona"."FOTO_DOCUMENTO" = :"FOTO_DOCUMENTO"');
           ...
           //      SQL.Add(',"gen$persona".DATOS_HUELLA = :DATOS_HUELLA');
          ...
          if (vTipoIdentificacion = 4) or (vTipoIdentificacion = 7) then
           begin
             ...
             if hayFoto then begin
               BS2 := TMemoryStream.Create;
               _jImagenJpg.SaveToStream(BS2);
               //_jImagenJpg.SaveToFile('c:\imagen.jpg');
               //ShowMessage(IntToStr(BS2.Size));
               _iImagen.ActualizarImagen(BS2,0,vIdentificacion,vTipoIdentificacion);
               ParamByName('FOTO').Clear;
               //Sleep(200);
               //BS2.Free;
             end;
             if hayFirma then begin
               BS3 := TMemoryStream.Create;
               _jFirma.SaveToStream(BS3);
               _iImagen.ActualizarImagen(BS3,2,vIdentificacion,vTipoIdentificacion);
               ParamByName('FIRMA').Clear;
             end;
           end
           else
           begin
             ...
             ParamByName('ID_EMPLEADO').AsString := DBAlias;
             ParamByName('FECHA_ACTUALIZACION').AsDate := Date;
             if hayHuella then //Validación para nuevo proceso
               ParamByName('DATOS_HUELLA').SetBlobData(addr(pvdata),blobSize - 1);
             if hayHuella then
             begin
                BS1 := TMemoryStream.Create;
               _jHuella.SaveToStream(BS1);
               ParamByName('FOTO_HUELLA').Clear;
               _iImagen.ActualizarImagen(BS1,1,vIdentificacion,vTipoIdentificacion);
               BS1.Free;
             end;
             if hayFoto then begin
               BS2 := TMemoryStream.Create;
...
// Gen persadicional2
           SQL.Clear;
           SQL.Add('delete from "gen$persadicional2" where');
           SQL.Add('"gen$persadicional2".ID_IDENTIFICACION = :ID_IDENTIFICACION');
           SQL.Add('and');
           SQL.Add('"gen$persadicional2".ID_PERSONA = :ID_PERSONA');
           ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
           ParamByName('ID_PERSONA').AsString := vIdentificacion;
           ExecSQL;
           Transaction.CommitRetaining;
...
// Compromisos
           SQL.Clear;
           SQL.Add('DELETE FROM "gen$persobligacion" WHERE ID_IDENTIFICACION = :ID_IDENTIFICACION and ID_PERSONA = :ID_PERSONA');
           ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
           ParamByName('ID_PERSONA').AsString := vIdentificacion;
           ExecSQL;
           SQL.Clear;
...
// Guardar Información de Direcciones
           ...
           begin
             ...
             Close;
             SQL.Clear;
             SQL.Add('DELETE FROM GEN$FAMILIARPEPS WHERE ID_IDENTIFICACION = :ID_IDENTIFICACION and ID_PERSONA = :ID_PERSONA');
             ParamByName('ID_IDENTIFICACION').AsInteger := vTipoIdentificacion;
             ParamByName('ID_PERSONA').AsString := vIdentificacion;
             ExecSQL;
             Close;
...
begin
{
    ...
    1: begin
        ...
        firmaStatus := 0;
        hayFirma := True;
        _jFirma := TJPEGImage.Create;
//        _jFirma.CompressionQuality := 55;
//        _jFirma.Compress;
        _jFirma.Assign(ImgFirmaC.Picture.Bitmap);
       end;
    end;
}
    ...
    case firmaStatus of
    0: begin
         numProv := EpadInk1.GetNumDevices;
         if (EpadInk1.OpenConnection(numProv-1) = 1) Then
         begin
            g_xMin := EpadInk1.ConnGetDataRangeMinX;
            g_xMax := EpadInk1.ConnGetDataRangeMaxX;
            g_yMin := EpadInk1.ConnGetDataRangeMinY;
            g_yMax := EpadInk1.ConnGetDataRangeMaxY;
            g_fOpened := True;
            Bitmap := nil;
            try
              Bitmap := TBitmap.Create;
...
var     frmTomarFoto:TfrmTomarFoto;
        _tMemory :TMemoryStream;
begin
        hayFoto := False;
        frmTomarFoto := TfrmTomarFoto.Create(Self);
        if not frmTomarFoto.Inicializar then begin
           ShowMessage('No Existen Drivers de Captura de Imagen !!');
           frmTomarFoto.Close;
           Exit;
        end;
        BitMap := TBitmap.Create;
        _jImagenJpg := TJPEGImage.Create;
        _jImagenJpg.CompressionQuality := 55;
        _jImagenJpg.Compress;
        _tMemory := TMemoryStream.Create;
        frmTomarFoto.ShowModal;
        if Assigned(Bitmap) then
        begin
           _jImagenJpg.Assign(BitMap);
           _jImagenJpg.SaveToStream(_tMemory);
...
begin
        ...
        if (EpadInk1.connClearInk = 1) then
        firmaStatus := 1;
        //CmdFirma.Click;
...
begin
        ...
        //frmRegistrarHuella := TfrmRegistrarHuella.Create(self);
        //frmRegistrarHuella.ShowModal;
        hayHuella := False;
        ...
        //How to save a byte array (binary data) to database.
           ...
           on E: Exception do showmessage('Problemas al Transportar los datos de la Huella');

           end;

// crear bitmap en blanco
            OleGraphic := TOleGraphic.Create;
            OleGraphic.Assign(frmRegister.Image);
            Bitmap := nil;
            Bitmap := TBitmap.Create;
            Bitmap.Width := OleGraphic.Width;
            Bitmap.Height := OleGraphic.Height;
            Bitmap.Canvas.Draw(0,0, OleGraphic);
            OleGraphic.Free;
            _jHuella := TJPEGImage.Create;
            _jHuella.Assign(Bitmap);
            ImgHuellaC.Picture.Graphic := Bitmap;
...
procedure TfrmCreacionPersona.Button1Click(Sender: TObject);
var     frmTomarFoto:TfrmTomarFoto;
        _tMemory :TMemoryStream;
begin
        hayFoto := False;
...
procedure TfrmCreacionPersona.Button2Click(Sender: TObject);
var Bitmap:TBitmap;
    numProv :Integer;
begin
{    case firmaStatus of
...
procedure TfrmCreacionPersona.Button3Click(Sender: TObject);
var
...
procedure TfrmCreacionPersona.EdDireccionExit(Sender: TObject);
begin
        if StrLen(PChar(EdDireccion.Text)) < 8 then
        begin
           ShowMessage('El campo Dirección debe tener como minimo 8 caracteres');
           EdDireccion.SetFocus;
        end;
end;

procedure TfrmCreacionPersona.EpadInk1FirePadData(Sender: TObject; abs_x,
  abs_y, abs_z: Integer; fTouch: Smallint; dwTimestamp,
  dwSeqenceNum: Integer);
  var x,y: Integer;
begin
    x := (imgFirmaC.Width * (abs_x - g_xMin)) div (g_xMax - g_xMin);
    y := (imgFirmaC.Height * (abs_y - g_yMin)) div (g_yMax - g_yMin);
    if (g_fFirstTouch = True) Then
    begin
      if (fTouch = 1) then
      begin
        ImgFirmaC.Canvas.MoveTo(x,y);
...
procedure TfrmCreacionPersona.btnAgregarCompromisoClick(Sender: TObject);
var ARecord:PListaObligacion;
begin
        if ( Not VarIsNull(listTipoObligacion.KeyValue) ) and
           ( EdEntidad.Text <> '' ) and (edFechaVencimiento.Date > 0) then
        begin
           CDScompromiso.Append;
           CDScompromisoTIOB_ID.Value := listTipoObligacion.KeyValue;
           CDScompromisoENTIDAD.Value := EdEntidad.Text;
           CDScompromisoFECHA_VENCIMIENTO.Value := edFechaVencimiento.Date;
           CDScompromisoSALDO.Value := edSaldoActual.Value;
           CDScompromisoMENSUAL.Value := edValorMensual.Value;
           CDScompromisoGARANTIA.Value := edValorGarantia.Value;
           CDScompromisoTIPOGARANTIA.Value := listTipoGarantia.KeyValue;
           CDScompromiso.Post;
           btnLimpiarCompromiso.Click;
        end;
end;

procedure TfrmCreacionPersona.chkPepsClick(Sender: TObject);
begin
        if (chkPeps.Checked) then
        begin
          CBTipoPeps.Enabled := true;
          familiarPEPS.TabVisible := true;
        end
        else
        begin
          CBTipoPeps.Enabled := false;
...
procedure TfrmCreacionPersona.gridCompromisoCellClick(Column: TColumn);
begin
        if CDScompromiso.RecordCount <> 0 then
        begin
            listTipoObligacion.KeyValue := CDScompromisoTIOB_ID.Value;
            edEntidad.Text := CDScompromisoENTIDAD.Value;
            edFechaVencimiento.Date := CDScompromisoFECHA_VENCIMIENTO.Value;
            edSaldoActual.Value := CDScompromisoSALDO.Value;
            edValorMensual.Value := CDScompromisoMENSUAL.Value;
            edValorGarantia.Value := CDScompromisoGARANTIA.Value;
            listTipoGarantia.KeyValue := CDScompromisoTIPOGARANTIA.Value;

            btnModifcarCompromiso.Enabled := True;
            btnAgregarCompromiso.Enabled := False;
            btnRemoverCompromiso.Enabled := True;

        end;
end;

procedure TfrmCreacionPersona.btnLimpiarCompromisoClick(Sender: TObject);
begin
        listTipoObligacion.KeyValue := -1;
        edEntidad.Text := '';
        edFechaVencimiento.Date := now;
        edSaldoActual.Value := 0;
        edValorMensual.Value := 0;
        edValorGarantia.Value := 0;
        listTipoGarantia.KeyValue := -1;
        btnAgregarCompromiso.Enabled := True;
        btnModifcarCompromiso.Enabled := False;
        btnRemoverCompromiso.Enabled := False;

end;

procedure TfrmCreacionPersona.btnModifcarCompromisoClick(Sender: TObject);
begin
           CDScompromiso.Edit;
           CDScompromisoTIOB_ID.Value := listTipoObligacion.KeyValue;
           CDScompromisoENTIDAD.Value := EdEntidad.Text;
...
procedure TfrmCreacionPersona.btnLimpiarFamiliarPepsClick(Sender: TObject);
begin
        edNombreFamiliarPeps.Text := '';
        edPrimerApellidoFamiliarPeps.Text := '';
        edSegundoApellidoFamiliarPeps.Text := '';
        edParentescoFamiliarPEPS.KeyValue := -1;
        edEmailFamiliarPeps.Text := '';
        btnEliminarFamiliarPeps.Enabled := False;
        btnModificarFamiliarPeps.Enabled := False;
        btnAgregarFamiliarPeps.Enabled := True;
end;

procedure TfrmCreacionPersona.btnAgregarFamiliarPepsClick(Sender: TObject);
begin
        CDSfamiliarpeps.Append;
        CDSfamiliarpepsNOMBRE.Value := edNombreFamiliarPeps.Text;
        CDSfamiliarpepsPRIMER_APELLIDO.Value := edPrimerApellidoFamiliarPeps.Text;
        CDSfamiliarpepsSEGUNDO_APELLIDO.Value := edSegundoApellidoFamiliarPeps.Text;
        CDSfamiliarpepsID_PARENTESCO.Value := edParentescoFamiliarPEPS.KeyValue;
        CDSfamiliarpepsDESCRIPCION_PARENTESCO.Value := edParentescoFamiliarPEPS.Text;
        CDSfamiliarpepsEMAIL.Value := edEmailFamiliarPeps.Text;
        CDSfamiliarpeps.Post;
end;

procedure TfrmCreacionPersona.btnModificarFamiliarPepsClick(
  Sender: TObject);
begin
        CDSfamiliarpeps.Edit;
        CDSfamiliarpepsNOMBRE.Value := edNombreFamiliarPeps.Text;
        CDSfamiliarpepsPRIMER_APELLIDO.Value := edPrimerApellidoFamiliarPeps.Text;
        CDSfamiliarpepsSEGUNDO_APELLIDO.Value := edSegundoApellidoFamiliarPeps.Text;
        CDSfamiliarpepsID_PARENTESCO.Value := edParentescoFamiliarPEPS.KeyValue;
...
procedure TfrmCreacionPersona.btnEliminarFamiliarPepsClick(
  Sender: TObject);
begin
        CDSfamiliarpeps.Delete;
end;

procedure TfrmCreacionPersona.DBGfamiliarpepsCellClick(Column: TColumn);
begin
        edPrimerApellidoFamiliarPeps.Text := CDSfamiliarpeps.FieldByName('PRIMER_APELLIDO').AsString;
        edSegundoApellidoFamiliarPeps.Text := CDSfamiliarpeps.FieldByName('SEGUNDO_APELLIDO').AsString;
        edNombreFamiliarPeps.Text := CDSfamiliarpeps.FieldByName('NOMBRE').AsString;
        edParentescoFamiliarPEPS.KeyValue := CDSfamiliarpeps.FieldByName('ID_PARENTESCO').AsInteger;
        edEmailFamiliarPeps.Text := CDSfamiliarpeps.FieldByName('EMAIL').AsString;
        edPrimerApellidoFamiliarPeps.SetFocus;
