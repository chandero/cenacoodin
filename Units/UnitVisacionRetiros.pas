...
uses
  ...
  IBCustomDataSet, IBQuery, IBEvents, MSNPopUp,Jpeg;
...
uses UnitDmGeneral, UnitGlobales, unitMain,UnitGuardaImagen;
...
begin
         try
          ...
          _rimagen := _iImagen.ConsultaImagen(IBQTitulares.FieldByName('ID_IDENTIFICACION').AsInteger ,IBQTitulares.FieldByName('ID_PERSONA').AsString);
          if _rImagen.Foto.Size > 0 then
          begin
           jpg := TJpegImage.Create;
           jpg.LoadFromStream(_rImagen.Foto);
           EdFoto.Picture.Bitmap.Assign(jpg);
           EdFoto.Repaint;
           FreeAndNil(jpg);
          end;
          ...
          begin
            ...
            EdFirma.Picture.Bitmap.Assign(jpg);
            EdFirma.Repaint;
            FreeAndNil(jpg);
          end;
          FreeAndNil(_iImagen);
