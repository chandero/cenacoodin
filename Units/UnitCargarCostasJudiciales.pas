            ...
            with IBSQL1 do begin
                  ...
                  try
                   ...
                   with IBSQL2 do begin
                    Close;
                    SQL.Clear;
                    SQL.Add('select ID_CLASIFICACION,ID_GARANTIA,ID_EVALUACION, ID_CATEGORIA, ID_ESTADO_COLOCACION from "col$colocacion" where');
                   ...
                   if Evaluacion < Categoria then Evaluacion := Categoria;
