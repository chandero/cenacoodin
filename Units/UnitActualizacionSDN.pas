...
uses unitDmGeneral,UnitGlobales, ShellApi;
...
begin
        ShowMessage('Favor hacer doble clic sobre el archivo que se Encuentra en la carpeta "c:\Sipla", para descomprimir su contenido y luego presione el boton Aceptar');
...
procedure TfrmActualizacionSDN.Borrar;
var
