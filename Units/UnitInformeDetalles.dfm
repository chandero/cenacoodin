object frmInformeDetalles: TfrmInformeDetalles
  Left = 352
  Top = 227
  BorderStyle = bsDialog
  Caption = 'Informe Diario de Cartera'
  ClientHeight = 207
  ClientWidth = 250
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 123
      Height = 13
      Caption = 'Digite el Login del Usuario'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object EdFechaInforme: TDateTimePicker
      ...
      ParseInput = False
      TabOrder = 0
      OnEnter = EdFechaInformeEnter
      OnExit = EdFechaInformeExit
      OnKeyPress = EdFechaInformeKeyPress
    end
    object EdEmpleado: TEdit
      ...
      TabOrder = 2
      Visible = False
      OnEnter = EdEmpleadoEnter
      OnExit = EdEmpleadoExit
    end
    ...
    object RGTipo: TRadioGroup
      ...
      Width = 199
      Height = 45
      Caption = 'Informe de Detalles de '
      Columns = 2
      ItemIndex = 0
      Items.Strings = (
        'Asociados'
  ...
  object IBQuery2: TClientDataSet
    ...
    Data = {
      ...
      
      02000F000000}
    object IBQuery2ID_AGENCIA: TIntegerField
      FieldName = 'ID_AGENCIA'
    end
    object IBQuery2CUENTA: TIntegerField
      FieldName = 'CUENTA'
    end
    object IBQuery2DIGITO: TIntegerField
      FieldName = 'DIGITO'
    end
    object IBQuery2NOMBRE: TStringField
      FieldName = 'NOMBRE'
      Size = 255
    end
    object IBQuery2PRIMER_APELLIDO: TStringField
      FieldName = 'PRIMER_APELLIDO'
      Size = 30
    end
    object IBQuery2SEGUNDO_APELLIDO: TStringField
      FieldName = 'SEGUNDO_APELLIDO'
      Size = 30
    end
    object IBQuery2FECHA: TDateField
      FieldName = 'FECHA'
    end
    object IBQuery2HORA: TTimeField
      FieldName = 'HORA'
    end
    object IBQuery2ANO: TStringField
      FieldName = 'ANO'
      Size = 4
    end
    object IBQuery2ID_EMPLEADO: TStringField
