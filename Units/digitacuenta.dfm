object digita: Tdigita
  ...
  object Panel1: TPanel
    ...
    object pnlRetiroCheque: TPanel
      ...
      TabOrder = 10
      Visible = False
      object chkRetiroCheque: TCheckBox
        Left = 4
        Top = 2
        Width = 236
        Height = 18
        Caption = 'Marque, si la operaci'#243'n es retiro en cheque'
        TabOrder = 0
        OnExit = chkRetiroChequeExit
      end
    end
  end
