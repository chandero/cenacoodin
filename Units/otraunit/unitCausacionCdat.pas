...
//**
          ...
          Application.ProcessMessages;
          frmProgreso.InfoLabel := 'Iniciando Proceso de Causaci?n';
...
// Evaluar la tasa a liquidar
          ...
          frmProgreso.Cerrar;
          MessageDlg('Proceso de Causaci?n Culminado con Exito!',mtInformation,[mbok],0);
          Liquidado := True;
...
begin
 ...
 {      SQL.Clear;
       ...
       vNocomprobanteCausacion := IntToStr(ObtenerConsecutivo(IBSQL1));
//       vNocomprobanteCausacion := IntToStr(ObtenerConsecutivoTmp(IBSQL1));
     ...
     with IBAplicar do
      try
        ...
        MessageDlg('Error Grabando Intereses de Captaci?n:' + Format('%.7d',[FieldByName('NUMERO_CUENTA').AsInteger]),mtError,[mbok],0);
...
// Realizo comprobante de Edades CDAT
    if Lista.Count > 0 then begin
      vNocomprobanteAjuste := IntToStr(ObtenerConsecutivo(IBSQL1));
