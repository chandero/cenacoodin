...
//Comparar Saldos y Contabilizar
               ...
               Codigo := '415005000000000000'{YA ES NIIF}{YA ES NIIF}{YA ES NIIF}{YA ES NIIF};
               IBSQL3.SQL.Clear;
               IBSQL3.SQL.Add('select NOMBRE from CON$PUC where CODIGO = :CODIGO');
...
//Comparar Saldos y Contabilizar
               ...
               Codigo := '511526000000000000'{YA ES NIIF};
               IBSQL3.SQL.Clear;
               IBSQL3.SQL.Add('select NOMBRE from CON$PUC where CODIGO = :CODIGO');
               ...
               Codigo := '511517000000000000'{YA ES NIIF};
               if Consumo <> 0 then begin
                 New(ar);
                 IBSQL3.Close;
                 IBSQL3.ParamByName('CODIGO').AsString := Codigo;
               ...
               Codigo := '511520000000000000'{YA ES NIIF};
               if Vivienda <> 0 then begin
                 New(ar);
                 IBSQL3.Close;
                 IBSQL3.ParamByName('CODIGO').AsString := Codigo;
...
{               Codigo := '511518000000000000'{YA ES NIIF};
               IBSQL3.SQL.Clear;
               IBSQL3.SQL.Add('select NOMBRE from CON$PUC where CODIGO = :CODIGO');
...
// Validar Contra Saldo Actual
                     Codigo := '146810000000000000'{YA ES NIIF};
//  Buscar en Puc Saldos Actuales
                     IBSQL3.Close;
                     IBSQL3.SQL.Clear;
                     IBSQL3.SQL.Add('select CON$PUC.SALDOINICIAL AS SALDO');
...
//Comparar Saldos y Contabilizar
               ...
               Codigo := '511529000000000000'{YA ES NIIF};
               IBSQL3.SQL.Clear;
               IBSQL3.SQL.Add('select NOMBRE from CON$PUC where CODIGO = :CODIGO');
...
//Comparar Saldos y Contabilizar
               ...
               Codigo := '415005000000000000'{YA ES NIIF}{YA ES NIIF}{YA ES NIIF};
               IBSQL3.SQL.Clear;
               IBSQL3.SQL.Add('select NOMBRE from CON$PUC where CODIGO = :CODIGO');
               ...
               Codigo := '415010000000000000'{YA ES NIIF}{YA ES NIIF};
               if Consumo <> 0 then begin
                 New(ar);
                 IBSQL3.Close;
                 IBSQL3.ParamByName('CODIGO').AsString := Codigo;
...
begin
        ...
        with IBQuery1 do begin
            ...
            with IBSQL4 do begin
                ...
                SQL.Add(':CAUSADOS,:CONTINGENCIAS,:APORTES,:PCAPITAL,:PINTERES,');
                SQL.Add(':PCOSTAS,:CORTO_PL,:LARGO_PL,:COSTAS,:ID_ESTADO,:PROV_ANUAL)');
                ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                ParamByName('FECHA_CORTE').AsDate := EdFechaCorte.Date;
                ParamByName('ID_CLASIFICACION').AsInteger := IBQuery1.FieldByName('ID_CLASIFICACION').AsInteger;
...
procedure TfrmCausacionCarteraDiaria.CmdImprimirComprobanteClick(
  Sender: TObject);
begin
