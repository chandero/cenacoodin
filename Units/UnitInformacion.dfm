object FrmInformacion: TFrmInformacion
      ...
      object Pagina1: TPageControl
        ...
        object Economico: TTabSheet
          ...
          object GroupBox4: TGroupBox
            ...
            object DbOcupacion: TDBLookupComboBox
              Left = 64
              Top = 14
              Width = 179
              Height = 21
      ...
      object Paginac: TPageControl
        ...
        object Tlaboral: TTabSheet
          ...
          object GroupBox11: TGroupBox
            ...
            object DbOcupacionCod: TDBLookupComboBox
              Left = 64
              Top = 14
              Width = 178
              Height = 21
  ...
  object IBinfreferencias: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  "gen$referencias".PARENTESCO_REFERENCIA,'
      '  "gen$tiposreferencia".ID_REFERENCIA as TIPO_REFERENCIA'
      'FROM'
      '  "gen$referencias"'
  ...
  object IBlinea: TIBQuery
    ...
    Transaction = IBTransaction1
    SQL.Strings = (
      'select * from "col$lineas" where ESTADO <> 0')
    Left = 272
    Top = 536
  end
  ...
  object frDBDSenfermedad: TfrDBDataSet
    DataSet = IBQenfermedad
    Left = 408
    Top = 456
  end
  object IBQenfermedad: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = dmGeneral.IBTransaction1
    SQL.Strings = (
      'SELECT * FROM GEN$ENFERMEDAD')
    Left = 408
    Top = 424
  end
end
