...
uses
  ...
  IBQuery, DBClient, IBSQL, DateUtils, pr_Common, pr_TxClasses, StrUtils;
...
uses UnitDmGeneral, UnitdmColocacion, Unitglobales, UnitGlobalesCol, UnitvistaPreliminar;
...
//       dmGeneral.IBTransaction1.StartTransaction;
       With IBQuery1 do
        Try
         ...
         ParamByName('DESCRIPCION').AsString := 'Reversi?n de Abono a Cartera Pagar? No.' + Trim(EdNumeroColocacion.Text);
