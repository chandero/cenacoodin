unit UnitRecuperacionsaldosNew;
...
type
  TfrmrecuperacionsaldosNew = class(TForm)
    btnaceptar: TBitBtn;
    IBQuery1: TIBQuery;
    IBQuery2: TIBQuery;
...
var
  frmrecuperacionsaldosNew: TfrmrecuperacionsaldosNew;
...
procedure TfrmrecuperacionsaldosNew.btnaceptarClick(Sender: TObject);
var
codigo       : string;
agencia      : integer;
debito       : currency;
    ...
    begin
      ...
      try
        while not Eof do
         begin
           ...
           with ibquery3 do
            begin
              ...
              IBQuery3.SQL.Add('EXTRACT (MONTH FROM CON$AUXILIAR.FECHA) AS MES,');
              IBQuery3.SQL.Add('SUM (CON$AUXILIAR.DEBITO) AS DEBITO,');
              IBQuery3.SQL.Add('SUM(CON$AUXILIAR.CREDITO) AS CREDITO');
              ...
              IBQuery3.SQL.Add('GROUP BY EXTRACT (MONTH FROM CON$AUXILIAR.FECHA)');
         ...
         if ReCalculoSaldosGeneralesNew then
         begin
//           IBQuery1.Transaction.Commit;
...
procedure TfrmrecuperacionsaldosNew.btnsalirClick(Sender: TObject);
begin
        self.Close;
end;
