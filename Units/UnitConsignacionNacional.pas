...
// Codigo GMF Credito
             CodGMFCre := '243005000000000000' { YA ES NIIF };
// Codigo IVA
             CodIva := '244010010000000000' { YA ES NIIF } ;
// Codigo Comision
             CodComision := '422010000000000000' { YA ES NIIF }; //CREDISERVIR
             //CodComision :=   '415098100000000000';
//             CodComision := '310505000000000000';
// Codigo Impuesto Asumido
             CodGMFDeb := '523050000000000000'{ YA ES NIIF };
...
// Insertar Movimientos en el Extracto
               ...
               begin
                ...
                SQL.Add(':DESCRIPCION_MOVIMIENTO,:VALOR_DEBITO,:VALOR_CREDITO,:ID)');
                if AR^.Valor > 0 then
                begin
                  ParamByName('ID_AGENCIA').AsInteger            := AR^.IdAgencia;
                  ParamByName('ID_TIPO_CAPTACION').AsInteger     := AR^.IdTipo;
