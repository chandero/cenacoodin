...
uses UnitDmGeneral, UnitVistaPreliminar, UnitGlobales, UnitGlobalesCol,
  UnitdmColocacion;
...
begin
    ...
    with IBQCol do begin
      ...
      if RecordCount > 0 then begin
          ...
          EdTasaVariable.Caption := FieldByName('DESCRIPCION_TASA').AsString ;
          Self.Caption := 'Extracto de Colocaci?n - Estado:' + FieldByName('DESCRIPCION_ESTADO_COLOCACION').AsString;
...
procedure TfrmExtractoCredito.Empleado;
begin
        with IBQuery do
         begin
           sql.Clear;
