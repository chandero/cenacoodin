object FrmBarridoTD: TFrmBarridoTD
  Left = 186
  Top = 191
  Width = 503
  Height = 359
  ...
  Caption = 'Barrido Cuota de Manejo Tarjetas D'#232'bito'
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    Width = 495
    Height = 291
    Caption = 'Resultados del Barrido'
    TabOrder = 0
    object DBbarrido: TDBGrid
      Left = 3
      Top = 13
      Width = 486
      Height = 251
      DataSource = DSbarrido
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
      ...
      TitleFont.Style = []
      OnColExit = DBbarridoColExit
      OnDrawColumnCell = DBbarridoDrawColumnCell
      Columns = <
        item
          Expanded = False
          FieldName = 'nombres'
  ...
  object CDbarrido: TClientDataSet
    Active = True
    Aggregates = <>
    FieldDefs = <
      item
    ...
    Top = 56
    Data = {
      }
    object CDbarridonombres: TStringField
      FieldName = 'nombres'
      Size = 255
    end
    object CDbarridoid_tarjeta: TStringField
      FieldName = 'id_tarjeta'
      Size = 16
    end
    object CDbarridonumero_cuenta: TIntegerField
      FieldName = 'numero_cuenta'
    end
    object CDbarridodigito_cuenta: TIntegerField
      FieldName = 'digito_cuenta'
    end
    object CDbarridofecha_descuento: TDateField
      FieldName = 'fecha_descuento'
    end
    object CDbarridodescuento: TBooleanField
      FieldName = 'descuento'
    end
    object CDbarridoid_tipo: TIntegerField
      FieldName = 'id_tipo'
    end
    object CDbarridoid_persona: TStringField
      FieldName = 'id_persona'
      Size = 15
    end
    object CDbarridonumero: TAggregateField
      FieldName = 'numero'
      Active = True
      Expression = 'count(numero_cuenta)'
    end
  end
  object DSbarrido: TDataSource
    DataSet = CDbarrido
    Left = 352
    Top = 88
  end
  object IBTdebito: TIBQuery
  ...
  object IbCodigos: TIBSQL
    Database = dmGeneral.IBDatabase1
    SQL.Strings = (
      
        'select * from "cap$tipocaptacion" where ID_TIPO_CAPTACION = :ID_' +
        'TIPO_CAPTACION')
    Transaction = dmGeneral.IBTransaction1
    Left = 96
    Top = 152
  end
  object IBimpuestos: TIBSQL
    Database = dmGeneral.IBDatabase1
    SQL.Strings = (
      
        'select * from CAP$CONTABLE where ID_CAPTACION = :ID_CAPTACION ' +
        'and ID_CONTABLE = :ID_CONTABLE')
    Transaction = dmGeneral.IBTransaction1
    Left = 160
    Top = 168
  end
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[CDbarrido.id_tipo]0[AGENCIA]-[:<000000>CDbarrido.numero_cuenta]' +
                  '-[CDbarrido.digito_cuenta]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'RESUMEN DESCUENTOS TARJETAS DEBITO : [:<yyyy/MM/dd>StartDateTime' +
                  ']')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
        ...
        object prTxMemoObj44: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'TOTAL DESCUENTOS : [CDbarrido.RecordCount]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
