object frmCertificaReteFuenteCap: TfrmCertificaReteFuenteCap
  ...
  object prReport1: TprReport
    ...
    object prPage2: TprPage
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                ...
                'COOPERATIVA ESPECIALIZADA DE AHORRO Y CREDITO [EMPRESA]'
                'NIT [NIT]')
              lBorder.Show = False
              lBorder.Style = psSolid
              lBorder.Color = clBlack
      ...
      object prHDetailBand1: TprHDetailBand
        VisibleFormula = 'CdCuentas.MONTO > 0'
        Height = 22
        UseVerticalBands = False
  ...
  object CDCuentas: TClientDataSet
    ...
    Data = {
      ...
      00010007535542545950450200490006004D6F6E65790009524554454E43494F
      4E080004000000010007535542545950450200490006004D6F6E6579000000}
    object CDCuentasTIPO: TStringField
      FieldName = 'TIPO'
      Size = 255
    end
    object CDCuentasMONTO: TCurrencyField
      FieldName = 'MONTO'
    end
    object CDCuentasRETENCION: TCurrencyField
      FieldName = 'RETENCION'
    end
  end
  ...
  object IBQuery2: TIBQuery
    ...
    Transaction = dmGeneral.IBTransaction1
    SQL.Strings = (
      'select VALOR_MINIMO FROM "gen$minimos" where ID_MINIMO = 61')
    Left = 64
    Top = 16
  end
end
