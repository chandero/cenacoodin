...
uses
  ...
  JvLabel, JvBlinkingLabel, JvSpecialLabel,
  OleServer, ComObj, AxCtrls, ActiveX, UnitPantallaHuella,
  JvStringGrid, StrUtils, DBClient,sdXmlDocuments, IdBaseComponent,
  IdComponent, IdTCPConnection, IdTCPClient, JclSysUtils, Math, IBDatabase,JPEG,
  IdHTTP, DPFPDevXLib_TLB, DPFPEngXLib_TLB, DPFPShrXLib_TLB,
  UnitPantallaProgreso,xmldom, XMLIntf, msxmldom, XMLDoc, IdCoder, IdHTTPServer, IdTCPServer,
  JvBaseDlg, JvCalc, JvTipOfDay;
...
type
  TfrmOperacionesCaja = class(TForm)
    ...
    Label22: TLabel;
    CmdRetornar: TBitBtn;
    EdMonedasCap: TJvCalcEdit;
    EdChequesCap: TJvCalcEdit;
    IBPagar: TIBSQL;
    IBOtros: TIBSQL;
    IBOtros1: TIBSQL;
    ...
    EdMonedasCer: TJvCalcEdit;
    EdChequesCer: TJvCalcEdit;
    ...
    EdMonedasGen: TJvCalcEdit;
    EdChequesGen: TJvCalcEdit;
    Label47: TLabel;
    EdDevolucionCap: TJvCalcEdit;
    CmdVerDevolucion: TBitBtn;
    Label48: TLabel;
    EdDevolucionCer: TJvCalcEdit;
    CmdVerDevolucionCer: TBitBtn;
    Label49: TLabel;
    EdDevolucionGen: TJvCalcEdit;
    ...
    Panel9: TPanel;
    CmdOkOtros: TBitBtn;
    EdMonedasOtr: TJvCalcEdit;
    EdChequesOtr: TJvCalcEdit;
    EdDevolucionOtr: TJvCalcEdit;
    ...
    EdMonedasCol: TJvCalcEdit;
    EdDevolucionCol: TJvCalcEdit;
    ...
    EdTotalBilletesCap: TJvCalcEdit;
    EdTotalBilletesCer: TJvCalcEdit;
    Label72: TLabel;
    STotalBilletes: TStaticText;
    EdTotalBilletesCol: TJvCalcEdit;
    EdTotalBilletesGen: TJvCalcEdit;
    Label50: TLabel;
    EdDocumentoOtr: TJvEdit;
    EdTotalBilletesOtr: TJvCalcEdit;
    Label93: TLabel;
    ...
    EdTotalMonedasCapAg: TJvCalcEdit;
    EdTotalChequesCapAg: TJvCalcEdit;
    EdDevolucionCapAg: TJvCalcEdit;
    CmdVerDevolucionAg: TBitBtn;
    EdTotalBilletesCapAg: TJvCalcEdit;
    ...
    CdTitular: TClientDataSet;
    CdTitularID: TIntegerField;
    CdTitularIDPERSONA: TStringField;
    CdTitularIDCOMBO: TIntegerField;
    ...
    listTipoRecaudo: TDBLookupComboBox;
    IBQtiporecaudo: TIBQuery;
    DStiporecaudo: TDataSource;
    GrpDatosUsuarioRecaudo: TGroupBox;
    Label181: TLabel;
    Label182: TLabel;
    Label196: TLabel;
    Label197: TLabel;
    edIdentificacionOtros: TEdit;
    edPrimerApellidoOtros: TEdit;
    edSegundoApellidoOtros: TEdit;
    edNombreOtros: TEdit;
    btnGuardarOtros: TBitBtn;
    GrpDatosUsuariosOtros: TGroupBox;
    Label198: TLabel;
    Label199: TLabel;
    Label200: TLabel;
    Label201: TLabel;
    edIdentificacionGen: TEdit;
    edPrimerApellidoGen: TEdit;
    edSegundoApellidoGen: TEdit;
    edNombreGen: TEdit;
    btnGrabarGen: TBitBtn;
    tabPersonaColManual: TTabSheet;
    GrpDatosUsuariosColManual: TGroupBox;
    Label202: TLabel;
    Label203: TLabel;
    Label204: TLabel;
    Label205: TLabel;
    edIdentificacionColManual: TEdit;
    edPrimerApellidoColManual: TEdit;
    edSegundoApellidoColManual: TEdit;
    edNombreColManual: TEdit;
    btnGuardarColManual: TBitBtn;
    PageControl3: TPageControl;
    TabCastigadaAbono: TTabSheet;
    ...
    TabCastigadaPersona: TTabSheet;
    GroupBox15: TGroupBox;
    Label206: TLabel;
    Label207: TLabel;
    Label208: TLabel;
    Label209: TLabel;
    edDocumentoCas: TEdit;
    edPrimerApellidoCas: TEdit;
    ...
    procedure edIdentificacionColManualExit(Sender: TObject);
    procedure edIdentificacionGenExit(Sender: TObject);
    procedure btnGrabarGenClick(Sender: TObject);
    procedure edIdentificacionOtrosExit(Sender: TObject);
    procedure edDocumentoCasExit(Sender: TObject);
    procedure edNombreCasExit(Sender: TObject);
    procedure TabColocacionesManualEnter(Sender: TObject);
  private
    ...
    procedure BuscarDatoAsociadoAg;
    function GetURLAsString(const aURL: string): string;
    function PostURLAsString(const aURL: string; const aRequest: TStrings): string;
  public
    jpgFirma :TJPEGImage;
    { Public declarations }
...
uses UnitRelacionCheques,UnitArqueoDevolucion, UnitGlobalesCol,
  ...
  UnitVistaPreliminar, ZlibEx, UnitFirmas,
  UnitVisacionRetirosCaja, UnitDeclaracion,
  UnitImagenJpeg;
...
begin
        ...
        if (CapOperacion = 'R') or (CapOperacion = 'S') or (CapOperacion = 'M') then
         if (VGeneral-TCheques) > SaldoEnCaja then
          begin
            MessageDlg('Est? sobrepasando el efectivo disponible en caja',mtError,[mbcancel],0);
          end;
        ...
        if CapOperacion = 'R' then
         begin
           ...
           begin
             MessageDlg('Est? sobrepasando el disponible de la cuenta',mtInformation,[mbok],0);
          end;
          if (VGeneral = Saldo) and ( EstadoAct = 1 ) then
          begin
            MessageDlg('Est? digitando el saldo exacto de la cuenta y el Estado de la cuenta es Activa',mtInformation,[mbok],0);
          end;
        end;
...
begin
        ...
        TipoCaptacion := 3;
        Opcion := 2;
        GBOperaciones.Caption := 'Subcuenta';
        Caption := 'Operaciones de Caja - SUBCUENTA DE AHORROS';
        PageControl1.ActivePage := TabCaptaciones;
        EdOpcion.Text := '0';
        EdOpcion.SetFocus;
end;
...
//        if not Recuperararqueo then Exit;
        ...
        EdEstadoActualCap.Caption := 'En Consignaci?n';
        case OrigenM of
        ...
        begin
         ...
         begin
                ...
                try
                  ...
                  MessageDlg('Error Buscando la Captaci?n',mtError,[mbcancel],0);
                  EdNumeroCap.SelectAll;
                  EdNumeroCap.SetFocus;
                  Exit;
                end;
                CdTitular.CancelUpdates;
                _iIdCombo := 0;
                IBTitulares.Close;
                ...
                try
                 ...
                 begin
                    if IBTitulares.FieldByName('NUMERO_TITULAR').AsInteger = 1 then begin
                      ...
                      _sNombreAsociado := IBTitulares.FieldByName('PRIMER_APELLIDO').AsString + ' ' +
                                          IBTitulares.FieldByName('SEGUNDO_APELLIDO').AsString + ' ' +
                                          IBTitulares.FieldByName('NOMBRE').AsString;
                      validarUltimaActualizacion(Id, Identificacion);
                    end;
                    CBTitulares.Items.Add(IntToStr(IBTitulares.FieldByName('ID_IDENTIFICACION').AsInteger) + '-' +
                                                   ...
                                                   IBTitulares.FieldByName('NOMBRE').AsString);
                    CdTitular.Append;
                    CdTitular.FieldValues['ID'] := IBTitulares.FieldByName('ID_IDENTIFICACION').AsInteger;
                    CdTitular.FieldValues['IDPERSONA'] := IBTitulares.FieldByName('ID_PERSONA').AsString;
                    CdTitular.FieldValues['IDCOMBO'] := _iIdCombo;
                    CdTitular.Post;
                    _iIdCombo := _iIdCombo + 1;
                    IBTitulares.Next;
                 end;
...
// Consulta de Canje
                ...
                begin
                  ...
                  begin
                     MessageDlg('Ya Cumplio el Total de las Cuotas. Favor Confirmar con la Secci?n de Ahorros',mtWarning,[mbok],0);
                     EdNumeroCap.SelectAll;
                     EdNumeroCap.SetFocus;
                     Exit;
                  end;
                  {
                  if vFechaDecuento > FechaFin then
                  begin
                     MessageDlg('La Cuota del Mes ya se Encuentra Cancelada. Favor Confirmar con la Secci?n de Ahorros',mtWarning,[mbok],0);
                     EdNumeroCap.SelectAll;
                     EdNumeroCap.SetFocus;
                     Exit;
                  end;
...
begin
       ...
       begin
          ...
          Mensaje.Caption := 'Debe diligenciar el n?mero de documento';
//          MessageDlg('Debe diligenciar el n?mero de documento',mtError,[mbcancel],0);
end;
...
begin
        if EdChequesCap.Value <> 0 then
          ...
          begin
            MessageDlg('Debe diligenciar la relaci?n de cheques',mtError,[mbcancel],0);
            CmdVerCheques.Click;
          end;

        if TGeneral <= 0 then
        begin
           MessageDlg('No se registrara la consignaci?n',mtInformation,[mbok],0);
        ...
        begin
           ...
           begin
               ...
               FValidar.Nombre := _sNombreAsociado;
               FValidar.AgenciaOrigen := FormatCurr('00',Agencia);
               FValidar.RealizaOp := edNombreUsuario.Text + ' ' + edPrimerApellidoUsuario.Text;
               Validar := FValidar;
               ShowModal;
               Free;
           end;

           MessageDlg('Consignacion Realizada con Exito!',mtInformation,[mbok],0);
        end
        else
           MessageDlg('Error al Realizar la Consignaci?n, consulte con sistemas',mtError,[mbcancel],0);
...
begin
       if TGeneral > SaldoEnCaja then
        ...
        if TGeneral = 0 then
        begin
           MessageDlg('No se registrara ning?n retiro',mtInformation,[mbok],0);
           CmdOKCaptacion.Enabled := True;
           EdChequesCap.SetFocus;
           Exit;
        end;
        ...
        with IBSQL1 do begin
         ...
         try
           ...
           begin
             MessageDlg('El tipo de captación no existe, Consulte con sistemas'+#13+
                        'Operaci?n no registrada',mtError,[mbcancel],0);
             Exit;
           end;
         except
           MessageDlg('Error al Buscar Tipo de Captaci?n',mtError,[mbcancel],0);
           Exit;
         end;
         if (FieldByName('RETIRO_PARCIAL').AsInteger = 0) and
            ...
            MessageDlg('Este tipo de captación, no permite retiros parciales'+#13+
                       'Por Favor verifique su operaci?n',mtError,[mbcancel],0);
            EdChequesCap.SetFocus;
            CmdOKCaptacion.Enabled := True;
            Exit;
         end;
...
// Validar Retiro M?ximo Caja Normal
       if not Servicaja then begin
         ...
         if (TotalOp + 1) > TopeTotalOp then begin
            MessageDlg('Ya se realizaron el m?ximo de operaciones para autorizados, no puede retirar',mtError,[mbcancel],0);
            Exit;
         end;
...
// Fin Validaci?n Retiros Autorizados
       end;
// Fin Autorizados

// Validar Visaci?n de Retiro
// Verificar si el monto necesita de visaci?n
        with IBSQL3 do
        begin
        ...
        begin
// Fin Verificaci?n
{ TODO 5 -oAlex -cCajas - Tesoreria : Incluir aqui proceso de solicitud de visaci?n de retiro }
...
// Fin Validaci?n Visaci?n de Retiro
...
begin
        ...
        //Registro de Delcaraci?n de Movimientos de Operaciones En Efectivo
        if ((TBilletes + TMonedas) >= _vMinimoSARLAFT) then
        begin

          FrmDeclaracion := TFrmDeclaracion.Create(Self);
          FrmDeclaracion._iTipoAgencia := 0;
          FrmDeclaracion._iTipoDocumento := _iDocumentoTitular;
          FrmDeclaracion._iTipoCaptacion := TipoCaptacion;
          FrmDeclaracion._iNumeroCuenta := EdNumeroCap.Text;
          FrmDeclaracion._cOrigen := CapOperacion;
          FrmDeclaracion._cValorOperacion := TBilletes + TMonedas;
          FrmDeclaracion.ShowModal;
          edDocumentoUsuario.Text := FrmDeclaracion.EdDocumento.Text;
          FrmDeclaracion.Free;
        end;
...
begin
              ...
              begin
               ...
               IBPagar.ParamByName('DESCRIPCION_MOVIMIENTO').AsString := Format('%-50s',['CONSIG. EFECTIVO - ' + edNombreUsuario.Text + ' ' + edPrimerApellidoUsuario.Text + ' ' + edSegundoApellidoUsuario.Text]);
               IBPagar.ParamByName('VALOR_DEBITO').AsCurrency := Valor;
               IBPagar.ParamByName('VALOR_CREDITO').AsCurrency := 0;
               IBPagar.ParamByName('ID').AsInteger := _idext;
                try
                  IBPagar.ExecQuery;
                ...
                // Grabar Extracto Extra Info
                IBOtros1.Close;
                IBOtros1.SQL.Clear;
                IBOtros1.SQL.Add('INSERT INTO "cap$extractoextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
                IBOtros1.ParamByName('ID').AsInteger := _idext;
                if (edDocumentoUsuario.Text <> '') then
                begin
                        IBOtros1.ParamByName('ID_IDENTIFICACION').AsInteger := 3;
                        IBOtros1.ParamByName('ID_PERSONA').AsString := edDocumentoUsuario.Text;
                end
                else
                begin
                        IBOtros1.ParamByName('ID_IDENTIFICACION').Clear;
                        IBOtros1.ParamByName('ID_PERSONA').Clear;
                end;
                IBOtros1.ParamByName('NOMBRE').AsString := edNombreUsuario.Text;
                IBOtros1.ParamByName('APELLIDO').AsString := edPrimerApellidoUsuario.Text + ' ' + edSegundoApellidoUsuario.Text;
                IBOtros1.ExecQuery;
// Grabando Canje Monedas
              ...
              begin
               ...
               IBPagar.ParamByName('DOCUMENTO_MOVIMIENTO').AsString := EdDocumentoCap.Text;
               IBPagar.ParamByName('DESCRIPCION_MOVIMIENTO').AsString := Format('%-50s',['CONSIG. CHEQUE - ' + edNombreUsuario.Text + ' ' + edPrimerApellidoUsuario.Text + ' ' + edSegundoApellidoUsuario.Text]);
               ...
               IBPagar.ParamByName('VALOR_CREDITO').AsCurrency := 0;
                try
                  ...
                  if IBPagar.RowsAffected < 1 then
                  begin
                   MessageDlg('Error Grabando Consignaci?n',mtError,[mbok],0);
                   IBPagar.Transaction.Rollback;
                   Result := False;
                   Exit;
                  end
...
//Fin Caso Contractual
              ...
              IBOtros.SQL.Add(':DOCUMENTO,:CHEQUES_MOVIMIENTO,:BILLETES,:MONEDAS,:CHEQUES,:HUELLA,:ID_PERSONA,:ID)');
              IBOtros.ParamByName('ID_AGENCIA').AsInteger := Agencia;
              IBOtros.ParamByName('ID_CAJA').AsInteger := StrToInt(EdCaja.Caption);
              ...
              IBOtros.ParamByName('ID').AsInteger := _id;
              try
                IBOtros.ExecQuery;
                if IBOtros.RowsAffected < 1 then
                 begin
              ...
              IBOtros1.Close;
              IBOtros1.SQL.Clear;
              IBOtros1.SQL.Add('INSERT INTO "caj$movimientoextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
              IBOtros1.ParamByName('ID').AsInteger := _id;
              if (edDocumentoUsuario.Text <> '') then
              begin
                      IBOtros1.ParamByName('ID_IDENTIFICACION').AsInteger := 3;
                      IBOtros1.ParamByName('ID_PERSONA').AsString := edDocumentoUsuario.Text;
                  ...
                  try
                     ...
                     try
                        ...
                        if IBOtros1.RowsAffected < 1 then
                         begin
                          IBOtros1.Transaction.RollbackRetaining;
                          MessageDlg('Error actualizando arqueo de caja devoluci?n',mtError,[mbcancel],0);
                          Result := False;
                          Exit;
                         end;
                     except
...
begin
              ...
              begin
               ...
               IBPagar.ParamByName('DOCUMENTO_MOVIMIENTO').AsString := EdDocumentoCap.Text;
               IBPagar.ParamByName('DESCRIPCION_MOVIMIENTO').AsString := Format('%-50s',['RETIR. EFECTIVO - ' + edNombreUsuario.Text + ' ' + edPrimerApellidoUsuario.Text + ' ' + edSegundoApellidoUsuario.Text]);
              ...
              begin
               ...
               IBPagar.ParamByName('DOCUMENTO_MOVIMIENTO').AsString := EdDocumentoCap.Text;
               IBPagar.ParamByName('DESCRIPCION_MOVIMIENTO').AsString := Format('%-50s',['RETIR. CHEQUE - ' + edNombreUsuario.Text + ' ' + edPrimerApellidoUsuario.Text + ' ' + edSegundoApellidoUsuario.Text]);
               IBPagar.ParamByName('VALOR_DEBITO').AsCurrency := 0;
...
// Validar Excenta
              ...
              IBOtros.Close;
              IBOtros.SQL.Clear;
              IBOtros.SQL.Add('INSERT INTO "caj$movimientoextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
              IBOtros.ParamByName('ID').AsInteger := _id;
              if (edDocumentoUsuario.Text <> '') then
              begin
                      IBOtros.ParamByName('ID_IDENTIFICACION').AsInteger := 3;
                      IBOtros.ParamByName('ID_PERSONA').AsString := edDocumentoUsuario.Text;
              end
              else
              begin
                      IBOtros.ParamByName('ID_IDENTIFICACION').Clear;
                      IBOtros.ParamByName('ID_PERSONA').Clear;
              end;
              IBOtros.ParamByName('NOMBRE').AsString := edNombreUsuario.Text;
              IBOtros.ParamByName('APELLIDO').AsString := edPrimerApellidoUsuario.Text + ' ' + edSegundoApellidoUsuario.Text;
              IBOtros.ExecQuery;
...
// Generales
       ...
       GrpColocacionAutoriza.Visible := False;
       edDocumentoOpColUsuario.Text := '';
       edPrimerApellidoOpColUsuario.Text := '';
       edSegundoApellidoOpColUsuario.Text := '';
       edNombreOpColUsuario.Text := '';

       GrpCertificadoAutoriza.Visible := False;
       edDocumentoOpCertUsuario.Text := '';
       edPrimerApellidoOpCertUsuario.Text := '';
       edSegundoApellidoOpCertUsuario.Text := '';
       edNombreOpCertUsuario.Text := '';
end;
...
//        if not Recuperararqueo then Exit;
        ...
        PageControl.Visible := True;
        GrpCertificadoAutoriza.Visible := true;
        ...
        begin
         ...
         begin
                ...
                try
                  ...
                  if RecordCount < 1 then
                  begin
                    MessageDlg('Captaci?n No Exite',mtError,[mbcancel],0);
                  ...
                  if not EsDeMovimiento then
                  begin
                     MessageDlg('Esta Captaci?n No Se Puede Trabajar',mtError,[mbcancel],0);
                     EdNumeroCer.SelectAll;
                     EdNumeroCer.SetFocus;
                     Exit;
                  end;
                ...
                try
                 ...
                 while not IBTitulares.Eof do
                 begin
                    if IBTitulares.RecNo = 0 then
                       _iDocumentoTitular := IBTitulares.FieldByName('ID_IDENTIFICACION').AsInteger;
                    CBTitularesCer.Items.Add(IntToStr(IBTitulares.FieldByName('ID_IDENTIFICACION').AsInteger) + '-' +
                                                   IBTitulares.FieldByName('ID_PERSONA').AsString + '   ' +
                                                   IBTitulares.FieldByName('PRIMER_APELLIDO').AsString + ' ' +
                                                   IBTitulares.FieldByName('SEGUNDO_APELLIDO').AsString + ' ' +
                                                   IBTitulares.FieldByName('NOMBRE').AsString);
                    if _sNombreAsociado = '' then
                       _sNombreAsociado := IBTitulares.FieldByName('PRIMER_APELLIDO').AsString + ' ' +
                                           IBTitulares.FieldByName('SEGUNDO_APELLIDO').AsString + ' ' +
                                           IBTitulares.FieldByName('NOMBRE').AsString;
                    ...
                    CdTitular.FieldValues['ID'] := IBTitulares.FieldByName('ID_IDENTIFICACION').AsInteger;
                    CdTitular.FieldValues['IDPERSONA'] := IBTitulares.FieldByName('ID_PERSONA').AsString;
                    CdTitular.FieldValues['IDCOMBO'] := _idCombo;
                    CdTitular.Post;
                    _idCombo := _idcombo + 1;
                    IBTitulares.Next;
                 end;
...
begin
       ...
       begin
          ...
          begin
            Close;
            SQL.Clear;
            SQL.Add('select CREDITO from CON$AUXILIAR where CODIGO = :CODIGO AND ID_COMPROBANTE = :ID');
            ParamByName('ID').AsInteger := Libreta;
            ParamByName('CODIGO').AsString := '110505000000000000'{YA ES NIIF};
            ExecQuery;
            Saldo := FieldByName('CREDITO').AsCurrency;
            EdTotalBilletesCer.Value := Saldo;
          end;
       end;
...
{        if ((TBilletes + TMonedas) >= _vMinimoSARLAFT) then
        ...
        if MessageDlg('Seguro de Realizar la Operaci?n',mtConfirmation,[mbyes,mbno],0) = mrno then
          Exit;
        ...
        begin
          ...
          FrmDeclaracion._iTipoDocumento := _iDocumentoTitular;
          FrmDeclaracion._iTipoCaptacion := TipoCaptacion;
          FrmDeclaracion._iNumeroCuenta := EdNumeroCer.Text;
          FrmDeclaracion._cOrigen := CapOperacion;
          FrmDeclaracion._cValorOperacion := TBilletes + TMonedas;
          FrmDeclaracion.ShowModal;
          edDocumentoOpCertUsuario.Text := FrmDeclaracion.EdDocumento.Text;
          FrmDeclaracion.Free;
        end;
...
begin
        ...
        begin
           MessageDlg('El Valor Distribuido no corresponde al valor de la Captaci?n',mtError,[mbcancel],0);
           EdMonedasCer.SetFocus;
           Exit;
        end;
...
begin
              ...
              IBOtros.ParamByName('NOMBRE').AsString := edNombreOpCertUsuario.Text;
              IBOtros.ParamByName('APELLIDO').AsString := edPrimerApellidoOpCertUsuario.Text + ' ' + edSegundoApellidoOpCertUsuario.Text;
              IBOtros.ExecQuery;
...
//Actualizar Estado de la Captaci?n
               ...
               begin
                ...
                try
                  ...
                  begin
                    MessageDlg('No se pudo actualizar la Captaci?n',mtError,[mbcancel],0);
                    Result:=False;
                    Exit;
                  end
                except
...
//        if not Recuperararqueo then Exit;
        ...
        TabsNoVisibles;
        edIdentificacionGen.Text := '';
        edPrimerApellidoGen.Text := '';
        edSegundoApellidoGen.Text := '';
        edNombreGen.Text := '';
...
//        if not Recuperararqueo then Exit;
        ...
        edSegundoApellidoGen.Text := '';
        edNombreGen.Text := '';
        GrpDatosUsuariosOtros.Enabled := True;
        EdDocumentoGen.SetFocus;
...
begin
        ...
        begin
           ...
           begin
               ...
               FValidar.AgenciaOrigen := FormatCurr('00',Agencia);
               FValidar.Nombre := '';
               FValidar.RealizaOp := edNombreGen.Text + ' ' + edPrimerApellidoGen.Text + ' ' + edSegundoApellidoGen.Text;
               Validar := FValidar;
               ShowModal;
               Free;
           end;
...
//Grabar Movimiento
              ...
              IBOtros.SQL.Add('INSERT INTO "caj$movimientoextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
              IBOtros.ParamByName('ID').AsInteger := _id;
              if (edIdentificacionGen.Text <> '') then
              begin
                IBOtros.ParamByName('ID_IDENTIFICACION').AsInteger := 3;
                IBOtros.ParamByName('ID_PERSONA').AsString := edIdentificacionGen.Text;
              end
              else
              begin
                IBOtros.ParamByName('ID_IDENTIFICACION').Clear;
              ...
              IBOtros.ParamByName('NOMBRE').AsString := edNombreGen.Text;
              IBOtros.ParamByName('APELLIDO').AsString := edPrimerApellidoGen.Text + ' ' + edSegundoApellidoGen.Text;
              IBOtros.ExecQuery;
              IBOtros.Close;
        ...
        begin
         {
           ...
           begin
               ...
               FValidar.Nombre := '';
               FValidar.AgenciaOrigen := FormatCurr('00',Agencia);
               FValidar.RealizaOp :=  edNombreOtros.Text + ' ' + edPrimerApellidoOtros.Text;
               Validar := FValidar;
               ShowModal;
               Free;
           end;
...
//Grabar Movimiento
              ...
              IBOtros.SQL.Add(':DOCUMENTO,:BILLETES,:MONEDAS,:ID)');
              IBOtros.ParamByName('ID_AGENCIA').AsInteger := Agencia;
              IBOtros.ParamByName('ID_CAJA').AsInteger := StrToInt(EdCaja.Caption);
              IBOtros.ParamByName('FECHA_MOV').AsDateTime := StrToDateTime(EdFecha.Caption + ' ' + EdHora.Caption);
              IBOtros.ParamByName('ORIGEN_MOVIMIENTO').AsInteger := OrigenM;
              IBOtros.ParamByName('ID_RECAUDO').AsInteger := listTipoRecaudo.KeyValue;
              ...
              IBOtros.SQL.Clear;
              IBOtros.SQL.Add('INSERT INTO "caj$recaudosextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
              IBOtros.ParamByName('ID').AsInteger := _id;
              if (edIdentificacionOtros.Text <> '') then
              begin
                IBOtros.ParamByName('ID_IDENTIFICACION').AsInteger := 3;
                IBOtros.ParamByName('ID_PERSONA').AsString := edIdentificacionOtros.Text;
              end
              else
              begin
                IBOtros.ParamByName('ID_IDENTIFICACION').Clear;
              ...
              IBOtros.ParamByName('NOMBRE').AsString := edNombreOtros.Text;
              IBOtros.ParamByName('APELLIDO').AsString := edPrimerApellidoOtros.Text + ' ' + edSegundoApellidoOtros.Text;
              IBOtros.ExecQuery;
              IBOtros.Close;
...
begin
        ...
        begin
                ...
                begin
                      ...
                      _iDocumentoTitular := FieldByName('ID_IDENTIFICACION').AsInteger;
...
procedure TfrmOperacionesCaja.InicializarRecaudo;
begin
        IBQtiporecaudo.Close;
        IBQtiporecaudo.Active := True;
        IBQtiporecaudo.Last;
        DStiporecaudo.Enabled := True;
        listTipoRecaudo.KeyValue := 0;
        EdTotalBilletesOtr.Value := 0;
        EdDocumentoOtr.Text := '';
        EdMonedasOtr.Value := 0;
        EdChequesOtr.Value := 0;
        ...
        EdTotalOtr.Caption := '';
        STotalBilletesOtr.Caption := '';
        SDiferenciaOtr.Caption := '';
        edNombreOtros.Text := '';
        edPrimerApellidoOtros.Text := '';
        edSegundoApellidoOtros.Text := '';
        edIdentificacionOtros.Text := '';
end;
...
begin
        ...
        begin
           ...
           begin
               ...
               CValidar.AgenciaOrigen := FormatCurr('00',Agencia);
               CValidar.RealizadoPor := edNombreOpColUsuario.Text + ' ' + edPrimerApellidoOpColUsuario.Text;
               Validar := CValidar;
               ShowModal;
               Free;
           end;
...
//Grabar Movimiento
              ...
              IBOtros.SQL.Add(':DOCUMENTO,:CAPITAL,:INTERESES,:DEVOLUCION,:OTROS,:BILLETES,:MONEDAS,:ID_PERSONA, :ID)');
              IBOtros.ParamByName('ID_AGENCIA').AsInteger := Agencia;
              IBOtros.ParamByName('ID_CAJA').AsInteger := StrToInt(EdCaja.Caption);
              IBOtros.ParamByName('FECHA_MOV').AsDateTime := StrToDateTime(EdFecha.Caption + ' ' + EdHora.Caption);
              ...
              IBOtros.Close;
              IBOtros.SQL.Clear;
              IBOtros.SQL.Add('INSERT INTO "caj$movimientocolextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
              IBOtros.ParamByName('ID').AsInteger := _id;
              ...
              IBOtros.ParamByName('NOMBRE').AsString := edNombreOpColUsuario.Text;
              IBOtros.ParamByName('APELLIDO').AsString := edPrimerApellidoOpColUsuario.Text + ' ' + edSegundoApellidoOpColUsuario.Text;
              IBOtros.ExecQuery;
...
begin
        ...
        with IBQuery1 do
         begin
          ...
          SQL.Add('"col$extracto"."TIPO_ABONO", "col$extracto"."ID")');
          SQL.Add(' Values (');
          ...
          SQL.Add(':"INTERES_PAGO_HASTA", :"CAPITAL_PAGO_HASTA", :"TIPO_ABONO", :"ID")');
          ParamByName('ID_AGENCIA').AsInteger := Agencia;
          ParamByName('ID_CBTE_COLOCACION').AsInteger := StrToInt(vNoComprobante);
          ParamByName('ID_COLOCACION').AsString := Colocacion;
          ParamByName('FECHA_EXTRACTO').AsDate := StrToDate(EdFecha.Caption);
          ...
          _idext := GetColExtId;
          ParamByName('ID').AsInteger := _idext;
          try
             ExecSQL;
             Close;
          except
          ...
          SQL.Clear;
          SQL.Add('INSERT INTO "col$extractoextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
          ParamByName('ID').AsInteger := _idext;
          if (edDocumentoOpColUsuario.Text <> '') then
          begin
              ParamByName('ID_IDENTIFICACION').AsInteger := 3;
              ParamByName('ID_PERSONA').AsString := edDocumentoOpColUsuario.Text;
          end
          else
          begin
              ParamByName('ID_IDENTIFICACION').Clear;
              ParamByName('ID_PERSONA').Clear;
          end;
          ParamByName('NOMBRE').AsString := edNombreOpColUsuario.Text;
          ParamByName('APELLIDO').AsString := edPrimerApellidoOpColUsuario.Text + ' ' + edSegundoApellidoOpColUsuario.Text;
          ExecSQL;
          Close;
...
begin
       ...
       CmdImagenesCap.Enabled := False;
       CdTitular.Filtered := False;
       CdTitular.Filter := 'IDCOMBO = ' + IntToStr(CBTitulares.ItemIndex);
       CdTitular.Filtered := True;
       FrmImagenJpg := TFrmImagenJpg.Create(Self);
       with FrmImagenJpg do
       begin
         _iIdentificacion := CdTitular.FieldByName('ID').AsInteger;
         _sIdPersona := CdTitular.FieldByName('IDPERSONA').AsString;
         FCaptacion.IdAgencia := Agencia;
         FCaptacion.IdCaptacion :=  TipoCaptacion;
         FCaptacion.IdNumeroCuenta := StrToInt(EdNumeroCap.Text);
         FCaptacion.IdDigitoCuenta := StrToInt(EdDigitoCap.Caption);
       ...
       FrmImagenJpg.ShowModal;
       FrmImagenJpg.Free;
       CmdImagenesCap.Enabled := True;
end;
...
{       frmImagenesPersona := TfrmImagenesPersona.Create(Self);
       ...
       CmdImagenesCer.Enabled := False;
       CdTitular.Filtered := False;
       CdTitular.Filter := 'IDCOMBO = ' + IntToStr(CBTitularesCer.ItemIndex);
       CdTitular.Filtered := True;
       FrmImagenJpg := TFrmImagenJpg.Create(Self);
       with FrmImagenJpg do
       begin
...
{        if ((TBilletes + TMonedas) >= _vMinimoSARLAFT) then
        ...
        begin
          ...
          FrmDeclaracion._iTipoAgencia := 0;
          FrmDeclaracion._iTipoDocumento := _iDocumentoTitular;
          FrmDeclaracion._iTipoCaptacion := 7;
          FrmDeclaracion._iNumeroCuenta := EdNumeroColocacion.Text;
          FrmDeclaracion._cOrigen := CapOperacion;
          FrmDeclaracion._cValorOperacion := TBilletes + TMonedas;
          FrmDeclaracion.ShowModal;
          edDocumentoOpColUsuario.Text := FrmDeclaracion.EdDocumento.Text;
          FrmDeclaracion.Free;
        end;
...
begin
        ...
        if CapOperacion = 'C' then
           ...
           EdNuevoSaldoCap.Caption := FormatCurr('#,#0.00',(Saldo - TGeneral));
        ///Registro de Declaraci?n de Movimientos
        {if (TBilletes + TMonedas) >= _vMinimoSARLAFT then
          GrDatosUsuario.Visible := True
        else
...
begin
        TBilletes := EdTotalBilletesCol.Value;
        TGeneral := TBilletes + TMonedas + TCheques;
        {if (TGeneral) >= _vMinimoSARLAFT then
          GrpColocacionAutoriza.Visible := True
        else
          GrpColocacionAutoriza.Visible := False;}
end;
        ...
        begin
                ...
                begin
                      ...
                      if (IdEstado > 2) or (vSaldoActual <= 0) then begin
                        MessageDlg('No se permite liquidar esta colocaci?n',mtError,[mbcancel],0);
                        Exit;
                      end;
...
//        if (TipoCuota = 1) or (TipoCuota = 3) then TasaLiquidacion := TasaNominalVencida(TasaLiquidacion,Amortizacion);
        ...
        with IBQuery do
         begin
          ...
          SQL.Add('INSERT INTO "col$extractoextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
          ParamByName('ID').AsInteger := _idext;
          if (edIdentificacionColManual.Text <> '') then
          begin
              ParamByName('ID_IDENTIFICACION').AsInteger := 3;
              ParamByName('ID_PERSONA').AsString := edIdentificacionColManual.Text;
          end
          else
          begin
              ParamByName('ID_IDENTIFICACION').Clear;
          ...
          ParamByName('NOMBRE').AsString := edNombreColManual.Text;
          ParamByName('APELLIDO').AsString := edPrimerApellidoColManual.Text + ' ' + edSegundoApellidoColManual.Text;
          ExecSQL;
          Close;
         ...
         if (vCuotaTipo = 'F') and
          ...
          begin
            ...
            if IdEstado <> 2 then
              ...
              ParamByName('FECHAK').AsDate := FechaCapAnt;
    ...
    if MessageDlg('Seguro de Realizar el Abono?',mtConfirmation,[mbYes,mbNo],0) = mrYes then
     begin
              ...
              begin
                ...
                FrmDeclaracion._iTipoDocumento := _iDocumentoTitular;
                FrmDeclaracion._iTipoCaptacion := 7;
                FrmDeclaracion._iNumeroCuenta := EdNumeroColocacionManual.Text;
                FrmDeclaracion._cOrigen := CapOperacion;
                FrmDeclaracion._cValorOperacion := TGeneral;
                FrmDeclaracion.ShowModal;
                edDocumentoOpColUsuario.Text := FrmDeclaracion.EdDocumento.Text;
                FrmDeclaracion.Free;
              end;
...
//              CmdGenerarInformeManual.Visible := False;
              ...
              if (not dmGeneral.IBTransaction1.InTransaction) then dmGeneral.IBTransaction1.StartTransaction;
              ...
              with IBQuery do begin
                ...
                if vhonorarios > 0 then begin
                   ...
                   Close;
                   SQL.Clear;
                   SQL.Add('INSERT INTO "cap$extractoextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
                   ParamByName('ID').AsInteger := _idext;
                   if (edIdentificacionColManual.Text <> '') then
                   begin
                     ParamByName('ID_IDENTIFICACION').AsInteger := 3;
              ...
              begin
                 IBOtros.ParamByName('ID_IDENTIFICACION').AsInteger := 3;
                 IBOtros.ParamByName('ID_PERSONA').AsString := edIdentificacionColManual.Text;
              end
              else
              begin
                 IBOtros.ParamByName('ID_IDENTIFICACION').Clear;
              ...
              IBOtros.ParamByName('NOMBRE').AsString := edNombreColManual.Text;
              IBOtros.ParamByName('APELLIDO').AsString := edPrimerApellidoColManual.Text + ' ' + edSegundoApellidoColManual.Text;
              IBOtros.ExecQuery;
...
//
        ...
        Timer.Enabled := False;
           ...
           begin
               ...
               CValidar.AgenciaOrigen := FormatCurr('00',Agencia);
               CValidar.RealizadoPor := edNombreColManual.Text + ' ' + edPrimerApellidoColManual.Text;
               Validar := CValidar;
               ShowModal;
               Free;
           end;
...
// Coloco Caja
        ...
        edIdentificacionColManual.SetFocus;
           ...
           begin
            try
                ...
                if BlobStream.Size = 0 then begin
                   MessageDlg('No tiene informaci?n Registrada',mtError,[mbcancel],0);
                   Exit;
                end;
...
begin
        ...
        begin
                ...
                if FieldByName('ID_ESTADO_COLOCACION').AsInteger <> 3 then
                 begin
                   MessageDlg('Esta Colocaci?n no est? Castigada',mtError,[mbOK],0);
                   EdCasNumeroColocacion.SetFocus;
                   Exit;
                 end;
                ...
                begin
                  ...
                  vFechaCapital := FieldByname('FECHA_CAPITAL').AsDateTime;
                  vFechaCapitalCas := vFechaCapital;
                ...
                with IBSQL2 do
                 ...
                 TabCastigadaAbono.Visible := True;
...
begin
    try
        ...
        TabCastigadaPersona.Visible := True;
        edDocumentoCas.SetFocus;
//        CmdAceptarCas.Visible := False;
...
begin
    if MessageDlg('Seguro de Realizar el Abono?',mtConfirmation,[mbYes,mbNo],0) = mrYes then
     begin
              ...
              IBOtros.SQL.Add('INSERT INTO "caj$movimientocolextra" VALUES (:ID,:ID_IDENTIFICACION,:ID_PERSONA,:NOMBRE,:APELLIDO)');
              IBOtros.ParamByName('ID').AsInteger := _id;
              if (edDocumentoCas.Text <> '') then
              begin
                      IBOtros.ParamByName('ID_IDENTIFICACION').AsInteger := 3;
                      IBOtros.ParamByName('ID_PERSONA').AsString := edDocumentoCas.Text;
              end
              else
              begin
                      IBOtros.ParamByName('ID_IDENTIFICACION').Clear;
              ...
              IBOtros.ParamByName('NOMBRE').AsString := edNombreCas.Text;
              IBOtros.ParamByName('APELLIDO').AsString := edPrimerApellidoCas.Text + ' ' + edSegundoApellidoCas.Text;
              IBOtros.ExecQuery;
        ...
        with IBQuery do
         begin
          ...
          if (vAbonoInteresCas = 0) and (vAbonoAprov = 0) then
             ParamByName('INTERES_PAGO_HASTA').AsDate := vFechaInteresCas;

          ParamByName('CAPITAL_PAGO_HASTA').AsDate := vFechaCapitalCas;
          ...
          begin
            ...
            ParamByName('FECHA_CAPITAL').AsDate := vFechaCapitalCas;
            ExecSql;
            Close;
           end;
...
//        ChkAutorizadoag.Enabled := False;
        ...
        EdEstadoActualCapag.Caption := 'En Consignaci?n';
        case OrigenM of
         2: EdEstadoActualCap.Color := clBlue;
         1: EdEstadoActualCap.Color := clPurple;
         4: EdEstadoActualCap.Color := clFuchsia;
...
begin
        ...
        e1nd;}
          ...
          if (Agencia = 5) and (EdCapAgencia.KeyValue = 1) then
             PuertoServidor := PuertoServidor + StrToInt(EdCaja.Caption);
...
{var NumeroS:string;
    ...
    Digito:Integer;
    EsDeMovimiento:Boolean;
    EsDeMovimientoEntrada:Boolean;
    i :Integer;
    cadena : String;
    XMLResult : IXMLDocument;
    XMLAccount, XMLCustomer : IXMLNode;
    PrimerApellido: String;
    SegundoApellido: String;
    Nombre: String;
    dataHuella: String;
    dataFirma: String;
    dataFoto: String;
    msHuella,msFirma,msFoto: TMemoryStream;
    bytes: TIdBytes;
    asignadoTitular: Boolean; }
begin
{        asignadoTitular := False;
        CDFirma.EmptyDataSet;
        CDHuella.EmptyDataSet;
        CDFoto.EmptyDataSet;
        ...
        begin
         ...
         frmProgreso.Titulo := 'Recibiendo Informaci?n de ' + EdCapAgencia.Text;
         cadena := GetURLAsString('http://'+HostServidor+':'+IntToStr(PuertoServidor)+'/sif/rest/as/'+IntToStr(EdCapAgencia.KeyValue) + '/'+ IntToStr(TipoCaptacion) + '/' + NumeroS + '/' + IntToStr(Digito));
         if (cadena <> '') then begin
          XMLResult := LoadXMLData(cadena);
          try
             if (not XmlResult.ChildNodes.Count > 0) then
             begin
                MessageDlg('No se Encontraron Datos Para Esa Cuenta con Mensaje',mtInformation,[mbok],0);
                ednumerocapag.SetFocus;
                Exit;
             end;
             for i := 0 to XMLResult.ChildNodes.Nodes['account'].ChildNodes.Count - 1 do
             begin
              if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'customer') then
              begin  // inicio del customer
              // A mover
                 XMLCustomer := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i];
                 if (Assigned(XMLCustomer)) then
                 begin
                    dataHuella := '';
                    dataFirma := '';
                    dataFoto := '';
                    ...
                    Nombre := '';
                    try
                     if (Assigned(XMLCustomer.ChildNodes.Nodes['primerapellido'])) then
                       PrimerApellido := XMLCustomer.ChildNodes.Nodes['primerapellido'].NodeValue;
                    except
                    end;
                    try
                     if (Assigned(XMLCustomer.ChildNodes.Nodes['segundoapellido'])) then
                       SegundoApellido := XMLCustomer.ChildNodes.Nodes['segundoapellido'].NodeValue;
                    except
                    end;
                    Nombre := XMLCustomer.ChildNodes.Nodes['primernombre'].NodeValue;
                    id_persona_titular := XMLCustomer.ChildNodes.Nodes['numerodocumento'].NodeValue;
                    id_identificacion_titular := XMLCustomer.ChildNodes.Nodes['tipodocumento'].NodeValue;
                    try
                      if (Assigned(XMLCustomer.ChildNodes.Nodes['datahuella'])) then
                        dataHuella := XMLCustomer.ChildNodes.Nodes['datahuella'].NodeValue;
                    except
                        dataHuella := '';
                    end;
                    try
                      if (Assigned(XMLCustomer.ChildNodes.Nodes['foto'])) then
                        dataFoto := XMLCustomer.ChildNodes.Nodes['foto'].NodeValue;
                    except
                        dataFoto := '';
                    end;
                    try
                      if (Assigned(XMLCustomer.ChildNodes.Nodes['firma'])) then
                        dataFirma := XMLCustomer.ChildNodes.Nodes['firma'].NodeValue;
                    except
                        dataFirma := '';
                    end;

                    Asociado_Titular := PrimerApellido + ' ' + SegundoApellido + ' ' + Nombre;
                    if not asignadoTitular then  begin
                        _sNombreAsociado := Asociado_Titular;
                        asignadoTitular := True;
                    end;
                    _iDocumentoTitular := id_identificacion_titular;
                    CBTitularesAg.Items.Add(Asociado_Titular);
                    msHuella := TMemoryStream.Create;
                    if (Length(dataHuella) > 0) then begin
                     CDhuella.Append;
                     IdDecoderMIME1.DecodeStream(dataHuella,msHuella);
                     CDhuelladatos_huella.LoadFromStream(msHuella);
                     CDhuella.FieldValues['titular'] := Asociado_Titular;
                     CDhuella.Post;
                    end;
                    FreeAndNil(msHuella);
                    msFirma := TMemoryStream.Create;
                    if (Length(dataFirma) > 0) then begin
                     CDfirma.Append;
                     IdDecoderMIME1.DecodeStream(dataFirma,msFirma);
                     CDfirmafirma.LoadFromStream(msFirma);
                     CDfirma.FieldValues['titular'] := Asociado_Titular;
                     CDfirma.Post;
                    end;
                    FreeAndNil(msFirma);
                    msFoto := TMemoryStream.Create;
                    if (Length(dataFoto) > 0) then begin
                     CDfoto.Append;
                     IdDecoderMIME1.DecodeStream(dataFoto,msFoto);
                     CDfotofoto.LoadFromStream(msFoto);
                     CDfoto.FieldValues['titular'] := Asociado_Titular;
                     CDfoto.Post;
                    end;
                    FreeAndNil(msFoto);
                  // fin a mover
                 end; // fin del assigned customer
                end
                else
                begin
              // A mover

                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'idestado') then
                 begin
                    vIdestadoAg := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                    EstadoAct := vIdestadoAg;
                 end;
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'descripcionestado') then
                   EdEstadoCapAg.Caption := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'firmas') then
                   EdFirmasAg.Caption := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'protectografos') then
                   EdprotectografosAg.Caption := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'sellos') then
                   EdsellosAg.Caption := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                   //VparaSaldarAg := IntToBool(XmlResC.Root.ReadInteger('parasaldar'));
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'libretainicial') then
                   EdRangoIniAg.Caption := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'libretafinal') then
                   EdRangoFinAg.Caption := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'saldo') then
                 begin
                   edSaldoCapAg.Caption := FormatCurr('$#,0.00',XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue);
                   Saldo := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                 end;
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'canje') then
                   EdCanjeCapAg.Caption := FormatCurr('$#,0.00',XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue);
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'disponible') then begin
                   EdDisponibleCapAg.Caption := FormatCurr('$#,0.00',XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue);
                   Disponible := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                 end;
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'permitemovimiento') then
                   EsDeMovimiento := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                 if (XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].LocalName = 'permitemovimientoentrada') then
                   EsDeMovimientoEntrada := XMLResult.ChildNodes.Nodes['account'].ChildNodes[i].NodeValue;
                 // fin a mover
                end;
              end;
           except
        ...
        if not EsDeMovimiento then
        begin
            MessageDlg('Con esta Captaci?n no se puede Trabajar',mtInformation,[mbok],0);
            EdCapAgencia.SetFocus;
            Exit;
        end;

        //Buscar Informaci?n de Direcci?n y Telefono Asociado
        //BuscarDatoAsociadoAg;
}
end;

procedure TfrmOperacionesCaja.CmdConfrontarHuellaAgClick(Sender: TObject);
var
    HuellaStream:TMemoryStream;
    BlobField:TBlobField;
    i:Integer;
begin
        with CDhuella do
        begin
           ...
           begin
            try
                HuellaStream := TMemoryStream.Create;
                (FieldByName('datos_huella') as TBlobField).SaveToStream(HuellaStream);
                vTamano := HuellaStream.Size;
                if HuellaStream.Size = 0 then begin
                   MessageDlg('No Tiene Huella Registrada',mtError,[mbcancel],0);
                   EdDocumentoCapAg.SetFocus;
                   //CmdRetornar.Click;
                   Exit;
                end;
                HuellaStream.Position := 0;
                HuellaStream.read(pvData,vTamano);
            finally
                HuellaStream.Free;
            end;
            ValidarHuella;
...
var
    FotoStream,FirmaStream:TMemoryStream;
    i:Integer;
    noFirma, noFoto: Boolean;
    jpgFirma, jpgFoto: TJPEGImage;
begin
        noFoto := False;
        noFirma := False;
        with CDfirma do
        begin
           ...
           begin
            try
                ...
                FirmaStream := TMemoryStream.Create;
                (FieldByName('firma') as TBlobField).SaveToStream(FirmaStream);
                if FirmaStream.Size = 0 then begin
                  noFirma := true;
                end
                else
                begin
                 FirmaStream.Position := 0;
                 jpgFirma.LoadFromStream(FirmaStream);
                 noFirma := false;
                end;
            finally
                FreeAndNil(FirmaStream);
            end;
           end
           else
               noFirma := true;
        ...
        begin
           ...
           begin
            try
                ...
                (FieldByName('foto') as TBlobField).SaveToStream(FotoStream);
                if FotoStream.Size = 0 then begin
                  noFoto := True;
                end
                else
                begin
                  FotoStream.Position := 0;
                  jpgFoto.LoadFromStream(FotoStream);
                  noFoto := False;
                end;
            finally
                FreeAndNil(FotoStream);
            end;
           end
           else
               noFoto := true;
        ...
        if (not noFirma) then
           FrmFirmas.ImFirma.Picture.Bitmap.Assign(jpgFirma);
        if (not noFoto) then
           FrmFirmas.ImFoto.Picture.Bitmap.Assign(jpgFoto);
        FrmFirmas.ShowModal;
        Application.ProcessMessages;
        FreeAndNil(jpgfirma);
        FreeAndNil(jpgfoto);
...
begin
          if Valida_Tcp then
             ...
             AWorkMode := wmWrite;
          if AWorkMode = wmRead then
             frmProgreso.Titulo := 'Recibiendo Informaci?n de ' + EdCapAgencia.Text + ' Tama?o: ' + CurrToStr(AWorkCountMax/1000) + ' Kbs'
          else
             frmProgreso.Titulo := 'Recibiendo Informaci?n de ' + EdCapAgencia.Text + ' Tama?o: ' + CurrToStr(AWorkCountMax/1000) + ' Kbs';
...
begin
        ...
        TBilletes := EdTotalBilletesCapAg.Value;
        TGeneral := TBilletes + TMonedas + TCheques;
        //Registro declaraci?n de Movimientos
        {if (TBilletes + TMonedas) >= _vMinimoSARLAFT then
...
{        if ((TBilletes + TMonedas) >= _vMinimoSARLAFT) then
        ...
        begin
          BuscarDatoAsociadoAg;
          FrmDeclaracion := TFrmDeclaracion.Create(Self);
          FrmDeclaracion._iTipoAgencia := EdCapAgencia.KeyValue;
          FrmDeclaracion._iTipoDocumento := _iDocumentoTitular;
          FrmDeclaracion.EdDocumentoTit.Text := id_persona_titular;
          FrmDeclaracion.EdNombreTit.Text := Asociado_Titular;
          FrmDeclaracion.EdDireccionTit.Text := _sDireccionAsociado;
          FrmDeclaracion.EdTelTit.Text := _sTelefonoAsociado;
          FrmDeclaracion._iTipoCaptacion := TipoCaptacion;
          FrmDeclaracion._iNumeroCuenta := EdNumeroCapAg.Text;
          FrmDeclaracion._cOrigen := CapOperacion;
          FrmDeclaracion._cValorOperacion := TBilletes + TMonedas;
          FrmDeclaracion.ShowModal;
          edDocumentoUsuarioAg.Text := FrmDeclaracion.EdDocumento.Text;
          FrmDeclaracion.Free;
        end;
...
var     i :Integer;
        ...
        cadena : String;
        numero_caja :Integer;
        XMLPeticion: TXMLDocument;
        XMLResult : IXMLDocument;
        XMLData : IXMLNode;
        XMLCheques, XMLCheque : IXMLNode;
begin
        with IBSQL1 do
        begin
          Close;
        ...
        VchequesComision := 0;
        Vcomision := 0;
        XMLPeticion :=  TXMLDocument.Create(nil);
        XMLPeticion.Active := True;
        //XMLPeticion.Encoding := 'UTF-8';
        XMLData := XMLPeticion.AddChild('request');
        XMLData.ChildValues['tipo'] := CapOperacion;
        XMLData.ChildValues['origen'] := OrigenM;
        XMLData.ChildValues['agenciaremota'] := Agencia;
        XMLData.ChildValues['agencia'] := EdCapAgencia.KeyValue;
        XMLData.ChildValues['numero'] := EdNumeroCapAg.Text;
        XMLData.ChildValues['digito'] := EdDigitoCapAg.Caption;
        XMLData.ChildValues['documento'] := EdDocumentoCapAg.Text;
        XMLData.ChildValues['caja'] := EdCaja.Caption;
        XMLData.ChildValues['escredito'] := ChkCreditos.Checked;
        XMLData.ChildValues['billetes'] := TBilletes;
        XMLData.ChildValues['monedas'] := TMonedas;
        XMLData.ChildValues['cheques'] := TCheques;

        if (TCheques > 0) then
        begin
         XMLCheques := XMLData.AddChild('listacheques');
         for i := 0 to ListaCheques.Count - 1 do
          begin
            ARecord := ListaCheques.Items[I];
            XMLCheque := XMLCheques.AddChild('cheque');
            XMLCheque.ChildValues['codigo'] := ARecord^.Codigo;
            XMLCheque.ChildValues['numero'] := StrToInt(ARecord^.Numero);
            XMLCheque.ChildValues['plaza'] := ARecord^.Plaza;
            XMLCheque.ChildValues['valor'] := ARecord^.Valor;
          end;
        end;
        cadena := PostURLAsString('http://'+HostServidor+':'+IntToStr(PuertoServidor)+'/sif/rest/as/os',XMLPeticion.XML);
        if (cadena <> '') then
           XMLResult := LoadXMLData(cadena);
        ...
        try
          if (not XmlResult.ChildNodes.Count > 0) then
          begin
              MessageDlg('No se recibi? respuesta de la Agencia Remota, por favor confirme la operaci?n',mtInformation,[mbok],0);
              Result := False;
              Exit;
          end;
          for i := 0 to XMLResult.ChildNodes.Nodes['result'].ChildNodes.Count - 1 do
          begin
            if (XMLResult.ChildNodes.Nodes['result'].ChildNodes[i].LocalName = 'comision') then
            begin
                  Vcomision :=  XMLResult.ChildNodes.Nodes['result'].ChildNodes[i].NodeValue;
            end;
            if (XMLResult.ChildNodes.Nodes['result'].ChildNodes[i].LocalName = 'executed')  then
            begin
                  Result := XMLResult.ChildNodes.Nodes['result'].ChildNodes[i].NodeValue;
            end;
          end;
         except
              MessageDlg('No se recibi? respuesta de la Agencia Remota, por favor confirme la operaci?n',mtInformation,[mbok],0);
...
//***
        ...
        begin
          ...
          begin
             Application.ProcessMessages;
             MessageDlg('Error en la Conexi?n' + #13 + e.Message,mtError,[mbok],0);
             EdNumeroCapAg.SetFocus;
             //frmProgreso.Cerrar;
             Exit;
          end;
...
// TODO: Proceso por Realizar;
        ...
        XMLResult := LoadXMLData(
                     PostURLAsString('http://'+HostServidor+':'+IntToStr(PuertoServidor)+'/sif/rest/as/os',XMLPeticion.XML)
                     );
        ...
        try
          ...
          begin
            ...
            if (XMLResult.ChildNodes.Nodes['result'].ChildNodes[i].LocalName = 'status')  then
            begin
                  Status := XMLResult.ChildNodes.Nodes['result'].ChildNodes[i].NodeValue;
            end;
          end;
         except
              MessageDlg('No se recibi? respuesta de la Agencia Remota, por favor confirme la operaci?n',mtInformation,[mbok],0);
        ...
        if (Status = 230) then
        begin
              MessageDlg('N?mero de Tal?n ya Usado!!, por favor confirme la operaci?n',mtInformation,[mbok],0);
              Result := False;
              Exit;
        end;
...
//**** REGISTRO DEL VALOR DE LA COMISION
              ...
              begin
               ...
               begin
                 ...
                 IBOtros.SQL.Add(':DIGITO_CUENTA,:DOCUMENTO,:ENVIADO,:FECHA_ENVIO)');
                 IBOtros.ParamByName('ID_CAJA').AsInteger := StrToInt(EdCaja.Caption);
                 IBOtros.ParamByName('ID_AGENCIA').AsInteger := EdCapAgencia.KeyValue;
                 IBOtros.ParamByName('ID_TIPO_CAPTACION').AsInteger := TipoCaptacion;
                 IBOtros.ParamByName('NUMERO_CUENTA').AsInteger := StrToInt(EdNumeroCapag.Text);
                 IBOtros.ParamByName('DIGITO_CUENTA').AsInteger := StrToInt(EdDigitoCapAg.Caption);
                 IBOtros.ParamByName('FECHA').AsDate := StrToDate(EdFecha.Caption);
               ...
               //FIN DEL INGRESO DEL CHEQUE A LA CAJA
...
//***** FIN DEL REGISTRO DE LA COMISUON
           ...
           MessageDlg('Consignaci?n Realizada con Exito!',mtInformation,[mbok],0);
        end;
        Timer.Enabled := True;
        CmdRetornar.Click;
end;
...
begin
       if TGeneral > SaldoEnCaja then
        ...
        begin
            MessageDlg('No Tiene Disponibilidad para este retiro' + #13 +
                       'Verifique los valores O el Monto de la Comisi?n',mtError,[mbcancel],0);
            CmdokCaptacionAg.Enabled := True;
            //EdTotalChequesCapAg.SetFocus;
            Exit;
        end;
...
{        FrmRemotaConsulta := TFrmRemotaConsulta.Create(self);
        ...
        FrmRemotaConsulta.Host_remoto := buscaservicio(EdCapAgencia.KeyValue,3).vHost;
        ...
        {
        FrmRemotaConsulta.Puerto_Remoto := buscaservicio(EdCapAgencia.KeyValue,3).vPuerto;
...
begin
        ...
        if (vAbonoAprov <> 0) and (vAbonoInteresCas <> 0) then
         ...
         begin
           vFechaInicialInteresA := CalculoFecha(vFechaInteresCas,1);
           vFechaFinalInteresA := CalculoFechaManual(vFechaInicialInteresA,vDiasA);
           EdFechaInicialA.Date := vFechaInicialInteresA;
           EdFechaFinalA.Date := vFechaFinalInteresA;
         end;
...
begin
        ...
        if (PersonaData.Existe) and (edDocumentoUsuario.Text <> '') then
        begin
...
begin
        ...
        if (PersonaData.Existe) and (edDocumentoOpCertUsuario.Text <> '') then
        begin
...
begin
        ...
        if (PersonaData.Existe) and (edDocumentoOpColUsuario.Text <> '') then
        begin
...
begin
        ...
        if (PersonaData.Existe) and (edDocumentoUsuarioAg.Text <> '') then
        begin
...
procedure TfrmOperacionesCaja.BuscarDatoAsociadoAg;
var     AList,AListCampos:TList;
        i,tamano :Integer;
        cadena :string;
        XmlPetCdato :TsdXmlDocument;
        XmlresCdato :TsdXmlDocument;
        nododato,nodo1dato :TXmlNode;
        Astreamdato :TMemoryStream;
        sentenciadato :string;
begin
// TODO: Proceso por realizar
{
         tamano := 0;
         sentenciadato := 'select DIRECCION, TELEFONO1 from "gen$direccion" where ID_PERSONA = ' + QuotedStr(id_persona_titular) + ' and ID_IDENTIFICACION = ' + IntToStr(id_identificacion_titular) + ' AND ID_DIRECCION = 1';
         XmlPetcdato := TsdXmlDocument.CreateName('query_info');
         XmlPetcdato.XmlFormat := xfReadable;

         Nododato := XmlPetcdato.Root.NodeNew('querys');
         Nodo1dato := nododato.NodeNew('query');
         Nodo1dato.WriteString('tipo','select');
         nodo1dato.WriteString('sentencia',sentenciadato);

         XmlPetCdato.SaveToFile('c:\wer.xml');
         Astreamdato := TMemoryStream.Create;

         XmlresCdato := TsdXmlDocument.Create;
         XmlresCdato.XmlFormat := xfReadable;
         with IdTCPClient1dato do
         begin
           Port := buscaservicio(EdCapAgencia.KeyValue,1).vPuerto;
           Host := buscaservicio(EdCapAgencia.KeyValue,1).vHost;
           try
             Application.ProcessMessages;
             Connect;
           except
         ...
         begin
              Application.ProcessMessages;
              Cadena := ReadLn();
              XmlPetCdato.SaveToStream(AStreamdato);
              WriteInteger(AStreamdato.Size);
              OpenWriteBuffer;
              WriteStream(AStreamdato);
              CloseWriteBuffer;
              FreeAndNil(AStreamdato);
              tamano := ReadInteger;
              AStreamdato := TMemoryStream.Create;
              ReadStream(Astreamdato,tamano,False);
              XmlRescdato.LoadFromStream(AStreamdato);
              Disconnect;
         end;
         end;
         XmlresCdato.SaveToFile('c:\wum1.xml');
         AList := TList.Create;
         Nododato := XmlRescdato.Root.NodeByName('consulta000');
         Nododato.NodesByName('Registro',AList);
         for i := 0 to AList.Count -1 do
         begin
           AListCampos := TList.Create;
           TXmlNode(AList[i]).NodesByName('campo',AListCampos);
           _sDireccionAsociado := TXmlNode(AListCampos[0]).ValueAsString;
           _sTelefonoAsociado := TXmlNode(AListCampos[1]).ValueAsString;
         end;
}
end;

procedure TfrmOperacionesCaja.DPFPCapture1Complete(ASender: TObject;
  const ReaderSerNum: WideString; const pSample: IDispatch);
begin
       Process(pSample);
end;

procedure TfrmOperacionesCaja.Process(pSample: IDispatch);
var
...
begin
       ...
       begin
          ...
          if (Response.Verified = true) then
           begin
                 ShowMessage('OK - Huella Concuerda con la Registrada');
           end
           else
           begin
                 ShowMessage('ERROR - Huella No Concuerda con la Registrada');
           end;
       end;
       frmPantallaHuella.Destroy;
       StopCapture();
end;

function TfrmOperacionesCaja.ExtractFeatures(pSample : IDispatch; dPurpose: DPFPDataPurposeEnum): IDispatch;
var
...
procedure TfrmOperacionesCaja.DrawFingerPrint(pBitmap: IDispatch);
begin
     SetOlePicture(frmPantallaHuella.Image1.Picture, IPictureDisp(pBitmap));
end;

function TfrmOperacionesCaja.ConvertSampleToBitmap(pSample: IDispatch): IDispatch;
var
...
procedure TfrmOperacionesCaja.StopCapture();
begin
     DPFPCapture1.StopCapture;
end;

function TfrmOperacionesCaja.GetURLAsString(const aURL: string): string;
var
 IdHTTP1 : TIdHTTP;
begin
  try
...
function TfrmOperacionesCaja.PostURLAsString(const aURL: string; const aRequest: TStrings): string;
var
  aBody: TStringStream;
  aResponse: String;
  IdHTTP1 : TIdHTTP;
...
{  try
     frmProgreso.Show;
   try
      aBody := TStringStream.Create(aRequest.GetText);
      frmProgreso.Memo := aBody.DataString;
      IdHTTP1 := TIdHTTP.Create(self);
      IdHTTP1.Request.Accept := 'application/xml';
      IdHTTP1.Request.ContentType := 'text/xml';
      IdHTTP1.Request.ContentEncoding := 'utf-8';
      Result := IdHTTP1.Post(aURL, aBody);
   except
     on E : Exception do
       ShowMessage(E.ClassName+' error generado, with message : '+E.Message);
   end;
...
procedure TfrmOperacionesCaja.edIdentificacionColManualExit(
  Sender: TObject);
var
 PersonaData:TPersonaData;
begin
        PersonaData := ValidarPersona(edIdentificacionColManual.Text);
        if (PersonaData.Existe) and (edIdentificacionColManual.Text <> '') then
        begin
              edPrimerApellidoColManual.Text := PersonaData.PrimerApellido;
              edSegundoApellidoColManual.Text := PersonaData.SegundoApellido;
              edNombreColManual.Text := PersonaData.Nombre;
              edPrimerApellidoColManual.Enabled := false;
              edSegundoApellidoColManual.Enabled := false;
              edNombreColManual.Enabled := false;
              btnGuardarColManual.Enabled := False;
              _bDocumentoUsuarioValido := True;
              CmdAceptarManual.SetFocus;
        end
        else
        begin
              edPrimerApellidoColManual.Enabled := True;
              edSegundoApellidoColManual.Enabled := True;
              edNombreColManual.Enabled := True;
              if (edIdentificacionColManual.Text <> '') then
                 btnGuardarColManual.Enabled := True
              else
                 btnGuardarColManual.Enabled := False;
              _bDocumentoUsuarioValido := False;
              edPrimerApellidoColManual.SetFocus;
          end;
end;

procedure TfrmOperacionesCaja.edIdentificacionGenExit(Sender: TObject);
var
 PersonaData:TPersonaData;
begin
        PersonaData := ValidarPersona(edIdentificacionGen.Text);
        if (PersonaData.Existe) and (edIdentificacionGen.Text <> '') then
        begin
              edPrimerApellidoGen.Text := PersonaData.PrimerApellido;
              edSegundoApellidoGen.Text := PersonaData.SegundoApellido;
              edNombreGen.Text := PersonaData.Nombre;
              edPrimerApellidoGen.Enabled := false;
              edSegundoApellidoGen.Enabled := false;
              edNombreGen.Enabled := false;
              btnGrabarGen.Enabled := False;
              _bDocumentoUsuarioValido := True;
              CmdOKGenerales.SetFocus;
        end
        else
        begin
              edPrimerApellidoGen.Enabled := True;
              edSegundoApellidoGen.Enabled := True;
              edNombreGen.Enabled := True;
              if (edIdentificacionGen.Text <> '') then
                      btnGrabarGen.Enabled := True
              else
                      btnGrabarGen.Enabled := False;
              _bDocumentoUsuarioValido := False;
              edPrimerApellidoGen.SetFocus;
          end;
end;

procedure TfrmOperacionesCaja.btnGrabarGenClick(Sender: TObject);
var
  DataPersona : TPersonaData;
begin
        DataPersona.Documento := EdDocumentoGen.Text;
        DataPersona.PrimerApellido := edPrimerApellidoGen.Text;
        DataPersona.SegundoApellido := edSegundoApellidoGen.Text;
        DataPersona.Nombre := edNombreGen.Text;
        try
          if GuardarPersona(DataPersona) then
          begin
                _bDocumentoUsuarioValido := True;
...
procedure TfrmOperacionesCaja.edIdentificacionOtrosExit(Sender: TObject);
var
 PersonaData:TPersonaData;
begin
        PersonaData := ValidarPersona(edIdentificacionOtros.Text);
        if (PersonaData.Existe) and (edIdentificacionOtros.Text <> '') then
        begin
              edPrimerApellidoOtros.Text := PersonaData.PrimerApellido;
              edSegundoApellidoOtros.Text := PersonaData.SegundoApellido;
              edNombreOtros.Text := PersonaData.Nombre;
              edPrimerApellidoOtros.Enabled := false;
              edSegundoApellidoOtros.Enabled := false;
              edNombreOtros.Enabled := false;
              btnGuardarOtros.Enabled := False;
              _bDocumentoUsuarioValido := True;
              CmdOkOtros.SetFocus;
        end
        else
        begin
              edPrimerApellidoOtros.Enabled := True;
              edSegundoApellidoOtros.Enabled := True;
              edNombreOtros.Enabled := True;
              if (edIdentificacionOtros.Text <> '') then
                 btnGuardarOtros.Enabled := True
              else
                 btnGuardarOtros.Enabled := False;
              _bDocumentoUsuarioValido := False;
              edPrimerApellidoOtros.SetFocus;
          end;
end;

procedure TfrmOperacionesCaja.edDocumentoCasExit(Sender: TObject);
var
 PersonaData:TPersonaData;
begin
        PersonaData := ValidarPersona(edDocumentoCas.Text);
        if (PersonaData.Existe) and (edDocumentoCas.Text <> '') then
        begin
              edPrimerApellidoCas.Text := PersonaData.PrimerApellido;
              edSegundoApellidoCas.Text := PersonaData.SegundoApellido;
              edNombreCas.Text := PersonaData.Nombre;
              edPrimerApellidoCas.Enabled := false;
              edSegundoApellidoCas.Enabled := false;
              edNombreCas.Enabled := false;
              btnGuardarCas.Enabled := False;
              _bDocumentoUsuarioValido := True;
              CmdAceptarCas.SetFocus;
        end
        else
        begin
              edPrimerApellidoCas.Enabled := True;
              edSegundoApellidoCas.Enabled := True;
              edNombreCas.Enabled := True;
              if (edDocumentoCas.Text <> '') then
                 btnGuardarCas.Enabled := True
              else
                 btnGuardarCas.Enabled := False;
              _bDocumentoUsuarioValido := False;
              edPrimerApellidoCas.SetFocus;
          end;
end;

procedure TfrmOperacionesCaja.edNombreCasExit(Sender: TObject);
begin
        CmdRecaudarCas.SetFocus;
end;

procedure TfrmOperacionesCaja.TabColocacionesManualEnter(Sender: TObject);
begin
        edIdentificacionColManual.Text := '';
        edPrimerApellidoColManual.Text := '';
        edSegundoApellidoColManual.Text := '';
        edNombreColManual.Text := '';
end;
