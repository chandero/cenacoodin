object frmResumenColocaciones: TfrmResumenColocaciones
  Left = 632
  Top = 366
  Width = 287
  Height = 143
  ...
  object Rarrastre: TprTxReport
    ...
    Values = <
      item
        Name = 'Vdesembolso'
        AggFunction = prafSum
        Formula = 'CDArrastre.v_desembolso'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'CDArrastre'
      end
      item
        Name = 'Vdeuda'
        AggFunction = prafSum
        Formula = 'CDArrastre.saldo'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'CDArrastre'
      end>
    ...
    object prTxPage1: TprTxPage
      ...
      object prTxHDetailHeaderBand1: TprTxHDetailHeaderBand
        Height = 7
        UseVerticalBands = False
        DetailBand = Rarrastre.prTxHDetailBand1
        ColCount = 0
        ColDirection = prcdTopBottomLeftRight
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'Descripcion : Creditos a los Cuales se les aplico ley de Arrastr' +
                  'e')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
