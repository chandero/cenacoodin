object frmChequesenCaja: TfrmChequesenCaja
  Left = 527
  Top = 239
  ...
  object Panel3: TPanel
    ...
    object ChkListaCheques: TJvxCheckListBox
      ...
      ParentFont = False
      TabOrder = 0
      OnStateChange = ChkListaChequesStateChange
      InternalVersion = 202
    end
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[IBQuery1.ID_TIPO_CUENTA][:<00>IBQuery1.ID_AGENCIA]-[:<0000000>I' +
                  'BQuery1.NUMERO_CUENTA]-[IBQuery1.DIGITO_CUENTA]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
  ...
  object IBQuery1: TIBQuery
    ...
    Transaction = dmGeneral.IBTransaction1
    SQL.Strings = (
      'select * from "caj$tmpcheques" where ID_CAJA = :ID_CAJA')
    Left = 220
    Top = 24
    ParamData = <
      item
    ...
    object IBQuery1ID_CAJA: TSmallintField
      FieldName = 'ID_CAJA'
      Origin = 'caj$tmpcheques.ID_CAJA'
      Required = True
    end
    object IBQuery1ID_BANCO: TSmallintField
      FieldName = 'ID_BANCO'
      Origin = 'caj$tmpcheques.ID_BANCO'
      Required = True
    end
    object IBQuery1NUMERO_CHEQUE: TIntegerField
      FieldName = 'NUMERO_CHEQUE'
      Origin = 'caj$tmpcheques.NUMERO_CHEQUE'
      Required = True
    end
    object IBQuery1FECHA: TDateField
      FieldName = 'FECHA'
      Origin = 'caj$tmpcheques.FECHA'
    end
    object IBQuery1PLAZA: TIBStringField
      FieldName = 'PLAZA'
      Origin = 'caj$tmpcheques.PLAZA'
      Required = True
      FixedChar = True
      Size = 1
    end
    ...
    object IBQuery1ID_AGENCIA: TSmallintField
      ...
      Origin = 'caj$tmpcheques.ID_AGENCIA'
      Required = True
    end
    object IBQuery1ID_TIPO_CUENTA: TSmallintField
      FieldName = 'ID_TIPO_CUENTA'
      Origin = 'caj$tmpcheques.ID_TIPO_CUENTA'
      Required = True
    end
    object IBQuery1NUMERO_CUENTA: TIntegerField
      FieldName = 'NUMERO_CUENTA'
      Origin = 'caj$tmpcheques.NUMERO_CUENTA'
    end
    object IBQuery1DIGITO_CUENTA: TIntegerField
      FieldName = 'DIGITO_CUENTA'
      Origin = 'caj$tmpcheques.DIGITO_CUENTA'
    end
    object IBQuery1DOCUMENTO: TIBStringField
      FieldName = 'DOCUMENTO'
      Origin = 'caj$tmpcheques.DOCUMENTO'
      Size = 15
    end
    object IBQuery1ENVIADO: TSmallintField
      FieldName = 'ENVIADO'
      Origin = 'caj$tmpcheques.ENVIADO'
    end
    object IBQuery1FECHA_ENVIO: TDateField
      FieldName = 'FECHA_ENVIO'
      Origin = 'caj$tmpcheques.FECHA_ENVIO'
    end
  end
  object IBSQL2: TIBSQL
    ...
    SQL.Strings = (
      'insert into "tes$cheques"'
        ...
        'ADO", "tes$cheques"."CONSIGNADO","tes$cheques"."LIBERADO", '
      ...
      'values'
        ...
        '   :"FECHA_CONSIGNADO", :"FECHA_PROCESADO", :"CONSIGNADO",:"LIBE' +
        'RADO", :"DEVUELTO")')
    Transaction = dmGeneral.IBTransaction1
    Left = 276
    Top = 64
