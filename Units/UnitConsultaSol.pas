...
uses
  ...
  IBCustomDataSet, IBQuery, IBDatabase, IBSQL, XStringGrid, Menus;
...
uses UnitDmSolicitud, UnitDescObservacion, UnitGlobales, UnitAgregarObservacionSol,
  UnitDireccionesAsociados, UnitPantallaProgreso, UnitConsultaProductos,
  UnitdmGeneral;
...
procedure TFrmConsultaSol.InformacinGeneral1Click(Sender: TObject);
begin
            frmConsultaProductos := TfrmConsultaProductos.Create(self);
            frmConsultaProductos.id_identificacion_sol := IBGeneral.fieldbyname('ID_IDENTIFICACION').AsInteger;
            frmConsultaProductos.id_persona_sol := IBGeneral.fieldbyname('ID_PERSONA').AsString;
