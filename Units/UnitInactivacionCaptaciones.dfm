object frmInactivacionCaptaciones: TfrmInactivacionCaptaciones
  Left = 357
  Top = 284
  ...
  object Label1: TLabel
    ...
    Width = 150
    Height = 13
    Caption = 'Tiempo para inactivaci'#243'n (dias):'
  end
  ...
  object IBQTabla: TClientDataSet
    ...
    Top = 62
    Data = {
      320100009619E0BD01000000180000000A00000000000300000032010A49445F
      ...
      
      0100490000000100055749445448020002000F000000}
    object IBQTablaID_AGENCIA: TIntegerField
      FieldName = 'ID_AGENCIA'
    end
    object IBQTablaID_TIPO_CAPTACION: TIntegerField
      FieldName = 'ID_TIPO_CAPTACION'
    end
    object IBQTablaNUMERO_CUENTA: TIntegerField
      FieldName = 'NUMERO_CUENTA'
    end
    object IBQTablaDIGITO_CUENTA: TIntegerField
      FieldName = 'DIGITO_CUENTA'
    end
    object IBQTablaID_PERSONA: TStringField
    ...
    object IBQTablaFECHA: TStringField
      FieldName = 'FECHA'
      Size = 15
    end
  end
  object Reporte: TprTxReport
    Values = <
      item
        ...
        Formula = 'IBQTabla.NUMERO_CUENTA'
        ResetOn = rvtReport
    ...
    Variables = <
      ...
      item
        Name = 'EMPLEADO'
        ValueType = 'prvvtString'
        Value = 'DEPARTAMENTO DE SISTEMAS'
      end>
    Left = 180
    Top = 62
    SystemInfo = (
        ...
        object prTxMemoObj8: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'INFORME DE CUENTAS A INACTIVAR')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj9: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'CORTE:[:<yyyy/mm/dd>StartDateTime]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[IBQTabla.ID_TIPO_CAPTACION][:<00>IBQTabla.ID_AGENCIA]-[:<000000' +
                  '0>IBQTabla.NUMERO_CUENTA]-[IBQTabla.DIGITO_CUENTA]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  '[Trim(IBQTabla.PRIMER_APELLIDO+" "+IBQTabla.SEGUNDO_APELLIDO+" "' +
                  '+IBQTabla.NOMBRE)]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
        ...
        object prTxMemoObj12: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'TOTAL CUENTAS A INACTIVAR:[:<0000>TOTAL]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
