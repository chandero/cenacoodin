...
type
  TfrmRecuperacionesCartera = class(TForm)
    ...
    CDRecuperaASOCIADO: TStringField;
    CDRecuperaID_PERSONA: TStringField;
    CdCausacionID_PERSONA: TStringField;
...
begin
        ...
        with IBSQL1 do begin
          ...
          SQL.Add('"gen$persona".ID_PERSONA, "gen$persona".NOMBRE  || '' '' || "gen$persona".PRIMER_APELLIDO  || '' '' || "gen$persona".SEGUNDO_APELLIDO AS ASOCIADO,');
          ...
          while not IBSQL1.Eof do begin
            ...
            CDRecupera.FieldValues['ID_PERSONA'] := FieldByName('ID_PERSONA').AsString;
            CDRecupera.FieldValues['ASOCIADO'] := FieldByName('ASOCIADO').AsString;
