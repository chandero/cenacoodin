...
uses
  ...
  IBCustomDataSet, IBQuery, DBCtrls, IBDatabase, JvStaticText;
...
implementation
uses UnitGlobales, UnitDmSolicitud, IBSQL;
...
//           DBente.KeyValue := 0;
        ...
        begin
          ...
          if (DBente.KeyValue = 0 ) or (DBente.KeyValue = 1) or (DBente.KeyValue = 4) then
          begin
            Empleado;
            Nombre.Text := Nombres + ' ' + Apellidos;
