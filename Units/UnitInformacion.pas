...
type
  TFrmInformacion = class(TForm)
    ...
    DbOcupacion: TDBLookupComboBox;
    DbOcupacionCod: TDBLookupComboBox;
    DsOcupacion: TDataSource;
    IbOcupacion: TIBQuery;
    lblAdvertencia: TLabel;
    frDBDSenfermedad: TfrDBDataSet;
    IBQenfermedad: TIBQuery;
...
uses UnitDmSolicitud,Unitdmgeneral, UnitImpresion, UnitMain,
  ...
  UnitdmColocacion, UnitRiesgos, UnitGlobalescol, UnitCdatSoliicutd,
  UnitVida;
...
begin
        ...
        begin
          ...
          SQL.Add('VALUES (:ID_SOLICITUD,0,1,0,0,0,:ES_FUNDACION)');
          ParamByName('ID_SOLICITUD').AsString := numero_radicado;
          if Role = 'CREDITOS' then
             ParamByName('ES_FUNDACION').AsInteger := 0
          else
             ParamByName('ES_FUNDACION').AsInteger := 1;
          Open;
          Close;
          Transaction.Commit;
        end;
...
var _sLog :string;
begin
      //Validar si se encuentra marcado en incapacitados
      _sLog := ValidaIncapacitado(DBidentificacion.KeyValue,JvDocumento.Text);
      if StrLen(PChar(_sLog)) > 2 then
      begin
        ShowMessage('Este Documento se Encuenta como Incapacitado en el area de Ahorros: ' + #13 + _sLog);
        JvDocumento.Text := '';
...
//           SQL.Add('SELECT * FROM P_CAP_0008_JUD (:ID_AGENCIA,:ID_TIPO_CAPTACION,:ID_IDENTIFICACION,:ID_PERSONA)');
           SQL.Add('SELECT P_CAP_0008_JUD.NUMERO_CUENTA, P_CAP_0008_JUD.DIGITO_CUENTA, P_CAP_0008_JUD.ID_ESTADO, P_CAP_0008_JUD.ES_PRIVILEGIADO ');
           SQL.Add('FROM P_CAP_0008_JUD(:ID_AGENCIA, :ID_TIPO_CAPTACION, :ID_IDENTIFICACION, :ID_PERSONA)');
//           SQL.Add('INNER JOIN "col$colocacion" ON (P_CAP_0008_JUD.NUMERO_CUENTA = "col$colocacion".NUMERO_CUENTA)');
//           SQL.Add('WHERE ("col$colocacion".ID_ESTADO_COLOCACION <> 3)');
           ...
           if FieldByName('ES_PRIVILEGIADO').AsInteger = 1 then
           begin
               lblAdvertencia.Caption := 'Advertencia: Es Asociado Privilegiado';
           end
           else
           begin
               lblAdvertencia.Caption := '';
           end;
           ...
           begin
             MessageDlg('El Asociado Posee Créditos Castigados',mtError,[mbok],0);
             DBidentificacion.SetFocus;
             Exit;
           end;
...
//***** Adicional gen$persadicinal codeudor
           SQL.Clear;
           ...
           DBtipoviviendacod.KeyValue := FieldByName('ID_TIPOVIVIENDA').AsInteger;
           DbOcupacionCod.KeyValue := FieldByName('ID_OCUPACION').AsInteger;
//***** Adicional gen$persadicinal codeudor
...
begin
        ...
        begin
          ...
          begin
            Append;
            FieldValues['tipo_id_referencia'] := DBidentificacion.KeyValue;
            FieldValues['id_persona'] := JvDocumento.Text;
...
begin
        ...
        // Actualiza gen$persadicional
        DbOcupacionCod.KeyValue := -1;
        // Actualiza gen$persadicional
...
//****  Adicional "Genpersona"
           ...
           begin
             ...
             ParamByName('ID_IDENTIFICACION').AsInteger := DBidentificacion.KeyValue;
             ParamByName('ID_PERSONA').AsString := JvDocumento.Text;
             ParamByName('NUMERO_HIJOS').AsInteger := 0;
             ParamByName('ID_OCUPACION').AsInteger := DbOcupacion.KeyValue;
             ParamByName('ID_TIPOCONTRATO').AsInteger := 0;
             ParamByName('DESCRIPCION_CONTRATO').AsString := '';
             ParamByName('ID_SECTOR').AsInteger := 0;
             ParamByName('DESCRIPCION_SECTOR').AsString := '';
             ParamByName('VENTA_ANUAL').AsCurrency := 0;
             ParamByName('FECHA_ULTIMO_BALANCE').Clear;
             ParamByName('NUMERO_EMPLEADOS').AsInteger := 0;
             ParamByName('DECLARA_RENTA').AsInteger := 0;
             ParamByName('PERSONAS_A_CARGO').AsInteger := 0;
             ParamByName('ID_ESTRATO').AsInteger := 0;
             ParamByName('CABEZAFAMILIA').AsInteger := 0;
             ParamByName('ID_ESTUDIO').AsInteger := DBnivelestudio.KeyValue;
             ParamByName('ID_TIPOVIVIENDA').AsInteger := DBtipovivienda.KeyValue;
             ExecSQL;
           end
           else
           begin
             SQL.Clear;
             SQL.Add('update "gen$persadicional" set ');
             SQL.Add('ID_ESTUDIO = :ID_ESTUDIO,');
             SQL.Add('ID_TIPOVIVIENDA = :ID_TIPOVIVIENDA,');
             SQL.Add('ID_OCUPACION = :ID_OCUPACION');             
             SQL.Add('where ');
...
//****  Adicional "Genpersona"
        ...
        begin
           ...
           //dATOS QUE APARECEN EN LA CONSULTA DE PRODUCTOS;
{           if Role = 'CREDITOS' then
           begin
              Close;
              SQL.Clear;
              ...
              Open;
              _iConsecutivoR := FieldByName('CONSECUTIVO').AsInteger + 1;
              Close;
              SQL.Clear;
              SQL.Add('insert into "col$registroinformacion" values (:ID_REGISTRO,:ID_PERSONA,:ID_IDENTIFICACION,:FECHA,:ES_LOCAL,:NOMBRE,:ID_EMPLEADO,1)');
              ParamByName('ID_REGISTRO').AsInteger := _iConsecutivoR;
              ParamByName('ID_PERSONA').AsString := JVdocumento.Text;
              ParamByName('ID_IDENTIFICACION').AsInteger := DBidentificacion.KeyValue;
              ParamByName('FECHA').AsDateTime := fFechaActual + fHoraActual;
              ParamByName('ES_LOCAL').AsBoolean := True;
              ParamByName('NOMBRE').AsString := EDnombre.Text + ' ' + EDapellido1.Text + ' ' + EDapellido2.Text;
...
begin
        ...
        begin
           ...
           ParamByName('OCUPACION').AsString := DbOcupacionCod.Text;
...
//***** Adicional gen$persadicinal codeudor
           ...
           begin
             ...
             ParamByName('ID_PERSONA').AsString := JVidentificacionCod.Text;
             ParamByName('NUMERO_HIJOS').AsInteger := 0;
             ParamByName('ID_OCUPACION').AsInteger := DbOcupacionCod.KeyValue;
             ParamByName('ID_TIPOCONTRATO').AsInteger := 0;
             ParamByName('DESCRIPCION_CONTRATO').AsString := '';
             ParamByName('ID_SECTOR').AsInteger := 0;
             ParamByName('DESCRIPCION_SECTOR').AsString := '';
             ...
             ParamByName('CABEZAFAMILIA').AsInteger := 0;
             ParamByName('ID_ESTUDIO').AsInteger := DBestudiocod.KeyValue;
             ParamByName('ID_TIPOVIVIENDA').AsInteger := DBtipoviviendacod.KeyValue;
             ExecSQL;
           end
           else
           begin
        ...
        begin
          ...
          if Transaction.InTransaction then
            ...
            begin
              ...
              CDFamiliar.FieldValues['id_entrada'] := 0;
              CDFamiliar.Post;
              Next;
            end;
          end;
...
//****** Adicional Gen$persadicional
           ...
           DBtipovivienda.KeyValue := FieldByName('ID_TIPOVIVIENDA').AsInteger;
           DbOcupacion.KeyValue := FieldByName('ID_OCUPACION').AsInteger;
//****** Adicional Gen$persadicional
...
begin
            ...
            begin
              ...
              SQL.Add('FROM');
              SQL.Add('"col$requisitos" order BY ID_REQUISITO');
              Open;
              while not Eof do
              begin
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  FrmRequisitoscre.JVrequisitos.Checked[FieldByName('id_requisito').AsInteger] := True;
                 end;
               Next;
              end;
            end;
...
begin
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                IBSQL7.Close;
                IBSQL7.SQL.Clear;
                IBSQL7.SQL.Add('SELECT ');
                IBSQL7.SQL.Add('SUM ("col$colocacion".VALOR_DESEMBOLSO - "col$colocacion".ABONOS_CAPITAL) AS SALDO');
                IBSQL7.SQL.Add('FROM');
                IBSQL7.SQL.Add('"col$colocacion"');
                IBSQL7.SQL.Add('WHERE');
                IBSQL7.SQL.Add('"col$colocacion".ID_COLOCACION = :ID_COLOCACION AND ');
                IBSQL7.SQL.Add('"col$colocacion".ID_LINEA IN (14,15) AND');
                IBSQL7.SQL.Add('"col$colocacion".ID_PERSONA = :ID_PERSONA AND ');
                IBSQL7.SQL.Add('"col$colocacion".ID_IDENTIFICACION = :ID_IDENTIFICACION');
                IBSQL7.ParamByName('ID_COLOCACION').AsString := CDinfCrediticiaid_colocacion.AsString;
                IBSQL7.ParamByName('ID_PERSONA').AsString := JvDocumento.Text;
                IBSQL7.ParamByName('ID_IDENTIFICACION').AsInteger := DBidentificacion.KeyValue;;
                IBSQL7.ExecQuery;
                _cSaldoNuevaLinea := _cSaldoNuevaLinea + IBSQL7.FieldByName('SALDO').AsCurrency;
                Next;
             end;
             Filtered := False;
          end;
          ...
          ParamByName('ID_LINEA').AsInteger := DBlineas.KeyValue;
          Open;
          if ((JVvalorprestamo.Value + _cValorLineaSocial) - _cSaldoNuevaLinea)  > FieldByName('MONTO').AsCurrency then
          begin
             ShowMessage('Máximo monto permitido para esta Linea es: ' + CurrToStrF(FieldByName('MONTO').AsCurrency,ffNumber,0));
             DBlineas.SetFocus;
             Exit;
          end;
          Close;
          ...
          SQL.Add('PLAZO');
          SQL.Add('FROM');
          SQL.Add('"col$validalinea"');
          SQL.Add('WHERE');
          SQL.Add(':MONTO BETWEEN MONTO_MIN AND MONTO_MAX');
          SQL.Add('AND ID_LINEA = :ID_LINEA');
          ParamByName('ID_LINEA').AsInteger := DBlineas.KeyValue;
          ParamByName('MONTO').AsCurrency := JVvalorprestamo.Value;
          Open;
          if JVplazo.Value > FieldByName('PLAZO').AsInteger then
          begin
            ShowMessage('El plazo máximo es: ' + CurrToStrF(FieldByName('PLAZO').AsInteger,ffnumber,0));
            DBlineas.SetFocus;
            Exit;
          end;
          end;
          //Fin Validar Nueva Linea
          SQL.Clear;
          SQL.Add('SELECT');
        ...
        begin
           ...
           begin
             with IBSQL7 do begin
              ...
              if FieldByName('TOTAL').AsInteger >= 2 then begin
                MessageDlg('El Asociado Posee el Máximo de Créditos por esta Linea',mtError,[MbOk],0);
                DBlineas.KeyValue := 1;
                Exit;
              end;
              Close;
              ...
              ExecQuery;
              if FieldByName('TOTAL').AsInteger >= 2 then begin
                MessageDlg('El Asociado Posee el Máximo de Solicitudes por esta Linea',mtError,[MbOk],0);
                DBlineas.KeyValue := 1;
                Exit;
              end;
              Close;
           ...
           begin
             ...
             begin
              ...
              _cValorLineaSocial := 0;
               ...
               begin
                 ShowMessage('Esta sobrepasando el Monto permitido por Asociado, Favor revise');
                 DBlineas.SetFocus;
                 Exit;
               end;
              end;
           ...
           begin
             ...
             begin
               ...
               if JVvalorprestamo.Value < FieldByName('MONTO_MIN').AsInteger then
               begin
                 ShowMessage('El Monto Minimo es: ' + CurrToStrF(FieldByName('PLAZO').AsInteger,ffnumber,0));
                 JVplazo.SetFocus;
                 Exit;
               end;
             end;
           end;
           //Fin validación nueva linea
        //Validaciòn Plazo y Monto
             with IBSQL7 do
             begin
               Close;
               SQL.Clear;
               ...
               ParamByName('ID_LINEA').AsInteger := DBlineas.KeyValue;
               ExecQuery;
               if JVvalorprestamo.Value  < FieldByName('MONTO_MIN').AsCurrency then
               begin
                 ShowMessage('Minimo Monto permitido para esta Linea es: ' + CurrToStrF(FieldByName('MONTO_MIN').AsCurrency,ffNumber,0));
                 JVvalorprestamo.SetFocus;
                 Exit;
               end;
               if JVvalorprestamo.Value  > FieldByName('MONTO_MAX').AsCurrency then
               begin
                 ShowMessage('Máximo Monto permitido para esta Linea es: ' + CurrToStrF(FieldByName('MONTO_MAX').AsCurrency,ffNumber,0));
                 JVvalorprestamo.SetFocus;
                 Exit;
               end;
               if JVplazo.Value  > FieldByName('PLAZO').AsCurrency then
               begin
                 ShowMessage('Máximo Plazo permitido para esta Linea es: ' + CurrToStrF(FieldByName('PLAZO').AsCurrency,ffNumber,0));
                 JVvalorprestamo.SetFocus;
                 Exit;
               end;
             end;
