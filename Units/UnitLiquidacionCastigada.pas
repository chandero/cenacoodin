...
uses
  ...
  DBClient, JvEdit, JvTypedEdit, Grids, JvStringGrid, StrUtils, pr_Classes;
...
begin
        ...
        for I := 0 to (MyCuotasLiq.Lista.Count - 1) do
         begin
           ...
           prReportCartera.Variables.ByName['CapitalHasta'].AsDateTime := FechaCapAnt;
                  ...
                  if IBSQL2.RecordCount > 0 then begin
                    ...
                    if FieldByName('ID_TIPO_CAPTACION').AsInteger = 1 then begin
                      ...
                      if vTotalAportes > 0 then
                        MessageDlg('Cr?dito Castigado con Saldo en Aportes' + #13,mtWarning,[mbok],0);
