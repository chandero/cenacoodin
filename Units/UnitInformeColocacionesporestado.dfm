object frminformecolocacionesporestado: Tfrminformecolocacionesporestado
  Left = 364
  Top = 188
  Width = 261
  Height = 125
  Caption = 'Informe de Colocaciones'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 168
      Height = 13
      Caption = 'Seleccione el Estado a Filtrar'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object CBEstado: TDBLookupComboBox
      ...
      ListSource = dmColocacion.DSEstado
      TabOrder = 0
    end
  end
  ...
  object IBQueryColocacion: TIBQuery
    ...
    SQL.Strings = (
      ...
      '          sum("col$costas".VALOR_COSTAS) as VALOR_COSTAS,'
      
        '          sum("col$costas".VALOR_HONORARIOS) as VALOR_HONORARIOS' +
        ','
      '          sum("col$costas".VALOR_OTROS) as VALOR_OTROS'
      '          FROM'
      '          "col$colocacion"'
      
        '          LEFT JOIN "gen$persona" ON ("col$colocacion".ID_PERSON' +
        'A = "gen$persona".ID_PERSONA) AND ("col$colocacion".ID_IDENTIFIC' +
        'ACION = "gen$persona".ID_IDENTIFICACION)'
      
        '          LEFT JOIN "col$costas" ON ("col$colocacion".ID_AGENCIA' +
        ' = "col$costas".ID_AGENCIA) AND ("col$colocacion".ID_COLOCACION ' +
        '= "col$costas".ID_COLOCACION)'
      
        '          inner join "col$estado" on ("col$colocacion".ID_ESTADO' +
        '_COLOCACION = "col$estado".ID_ESTADO_COLOCACION)'
      '          where'
      
        '          "col$colocacion".ID_ESTADO_COLOCACION =:"ID_ESTADO_COl' +
        'OCACION"'
      '          group by'
      '          "col$colocacion".ID_COLOCACION,'
      '          "col$colocacion".NUMERO_CUENTA,'
      ...
      '          "col$colocacion".FECHA_INTERES,'
      '          "col$estado".DESCRIPCION_ESTADO_COLOCACION'
      '          ORDER BY "col$colocacion".NUMERO_CUENTA')
    ParamData = <
      item
        DataType = ftUnknown
        Name = 'ID_ESTADO_COlOCACION'
        ParamType = ptUnknown
      end>
    object IBQueryColocacionID_COLOCACION: TIBStringField
      FieldName = 'ID_COLOCACION'
      ProviderFlags = []
      FixedChar = True
      Size = 11
    end
    object IBQueryColocacionNUMERO_CUENTA: TIntegerField
      FieldName = 'NUMERO_CUENTA'
      ProviderFlags = []
    end
    object IBQueryColocacionID_PERSONA: TIBStringField
      FieldName = 'ID_PERSONA'
      ProviderFlags = []
      Size = 15
    end
    object IBQueryColocacionNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      ProviderFlags = []
      Size = 255
    end
    object IBQueryColocacionPRIMER_APELLIDO: TIBStringField
      FieldName = 'PRIMER_APELLIDO'
      ProviderFlags = []
      Size = 30
    end
    object IBQueryColocacionSEGUNDO_APELLIDO: TIBStringField
      FieldName = 'SEGUNDO_APELLIDO'
      ProviderFlags = []
      Size = 30
    end
    object IBQueryColocacionFECHA_DESEMBOLSO: TDateField
      FieldName = 'FECHA_DESEMBOLSO'
      ProviderFlags = []
    end
    object IBQueryColocacionVALOR_DESEMBOLSO: TIBBCDField
      FieldName = 'VALOR_DESEMBOLSO'
      ProviderFlags = []
      Precision = 18
      Size = 3
    end
    object IBQueryColocacionSALDO: TIBBCDField
      FieldName = 'SALDO'
      ProviderFlags = []
      Precision = 18
      Size = 3
    end
    object IBQueryColocacionPLAZO_COLOCACION: TIntegerField
      FieldName = 'PLAZO_COLOCACION'
      ProviderFlags = []
    end
    object IBQueryColocacionFECHA_VENCIMIENTO: TDateField
      FieldName = 'FECHA_VENCIMIENTO'
      ProviderFlags = []
    end
    object IBQueryColocacionABONOS_CAPITAL: TIBBCDField
      FieldName = 'ABONOS_CAPITAL'
      ProviderFlags = []
      Precision = 18
      Size = 3
    end
    object IBQueryColocacionFECHA_CAPITAL: TDateField
      FieldName = 'FECHA_CAPITAL'
      ProviderFlags = []
    end
    object IBQueryColocacionFECHA_INTERES: TDateField
      FieldName = 'FECHA_INTERES'
      ProviderFlags = []
    end
    object IBQueryColocacionDESCRIPCION_ESTADO_COLOCACION: TIBStringField
      FieldName = 'DESCRIPCION_ESTADO_COLOCACION'
      ProviderFlags = []
      Size = 100
    end
    object IBQueryColocacionVALOR_COSTAS: TIBBCDField
      FieldName = 'VALOR_COSTAS'
      ProviderFlags = []
      Precision = 18
      Size = 3
    end
    object IBQueryColocacionVALOR_HONORARIOS: TIBBCDField
      FieldName = 'VALOR_HONORARIOS'
      ProviderFlags = []
      Precision = 18
      Size = 3
    end
    object IBQueryColocacionVALOR_OTROS: TIBBCDField
  ...
  object RColocacionEstado: TprTxReport
    FromPage = 1
    ToPage = 1
    ...
    object prTxPage1: TprTxPage
        ...
        object prTxMemoObj2: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'LISTADO GENERAL DE CARTERA Estado : [Titulo]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
      ...
      object prTxHDetailHeaderBand1: TprTxHDetailHeaderBand
        Height = 3
        UseVerticalBands = False
        DetailBand = RColocacionEstado.prTxHDetailBand1
        ColCount = 0
