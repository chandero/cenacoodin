...
begin
        ...
        with IBSQL1 do begin
          ...
          if RecordCount > 0 then begin
            MessageDlg('La Colocaci?n ya se Liquid?',mtError,[mbOK],0);
            CmdNuevo.Click;
            Exit;
          end;
          Close;
        ...
        begin
          ...
          Self.Caption := 'Liquidaci?n Cartera para Desembolso - Estado:' + FieldByName('DESCRIPCION_ESTADO_COLOCACION').AsString;
...
//             EdEstado.Caption := DescripcionEstado;
             ...
             if (Estado = 2) then begin
               ...
               MessageDlg('La Colocaci?n NO est? Judicial o Castigada',mtError,[mbOK],0);
               inicializar;
               Exit;
             end;
             ...
             with IBSQL2 do
              begin
                ...
                if RecordCount > 0 then
                  ...
                  MessageDlg('No se encuentra Solicitud para esta Colocaci?n',mtError,[mbOK],0);
                  inicializar;
                  Exit;
                end;
                Close;
