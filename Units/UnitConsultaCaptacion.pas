...
uses  unitGlobales, unitGlobalesCol, UnitdmGeneral,UnitImagenAmpliada,UnitGuardaImagen;
...
begin
        DataModule.IBTiposCaptacion.Close;
        DataModule.IBTiposIdentificacion.Close;
           ...
           begin
               ...
               begin
                ...
                EdNombresTitAho.Caption := FieldByName('NOMBRE').AsString;
                 _rimagen := _iImagen.ConsultaImagen(ARecord^.TipoId,ARecord^.NumeroId);
...
begin
        ...
        with IBQuery1 do BEGIN
         ...
         _rimagen := _iImagen.ConsultaImagen(_iIdIdentificacion,_sIdPersona);
            if _rImagen.Foto.Size > 0 then
            begin
              jpg := TJpegImage.Create;
              jpg.LoadFromStream(_rImagen.Foto);
...
begin
        ...
        begin
          ...
          begin
               ...
               SQL.Add('PUNTOS_ADICIONALES,MODALIDAD,AMORTIZACION,"cap$maestro".ID_ESTADO,"cap$tiposestado".DESCRIPCION,FECHA_VENCIMIENTO,ID_IDENTIFICACION,ID_PERSONA,');
...
begin
         ...
         frmImagenAmpliada.Imagen := ImgFotoC.Picture.Bitmap;
