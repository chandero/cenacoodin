object frmInformeDiarioDesembolsos: TfrmInformeDiarioDesembolsos
  Left = 450
  Top = 213
  Width = 274
  Height = 108
  Caption = 'Informe Diario de Desembolsos'
  Color = clBtnFace
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
      ...
      '                "col$colocacion" '
        ...
        '                INNER JOIN "col$lineas" ON ("col$colocacion".ID_' +
        'LINEA = "col$lineas".ID_LINEA)'
      
        '                INNER JOIN "col$garantia" ON ("col$colocacion".I' +
        'D_GARANTIA = "col$garantia".ID_GARANTIA) '
      
        '                LEFT OUTER JOIN "col$tasavariables" ON ("col$col' +
        'ocacion".ID_INTERES = "col$tasavariables".ID_INTERES) '
      
        '                INNER JOIN "col$tiposcuota" ON ("col$colocacion"' +
        '.ID_TIPO_CUOTA = "col$tiposcuota".ID_TIPOS_CUOTA) '
      
        '                LEFT OUTER JOIN "gen$persona" ON ("col$colocacio' +
        'n".ID_IDENTIFICACION = "gen$persona".ID_IDENTIFICACION) AND ("co' +
        'l$colocacion".ID_PERSONA = "gen$persona".ID_PERSONA) '
      '                 WHERE'
  ...
  object InformeDiario: TprTxReport
    ...
    OnUnknownVariable = InformeDiarioUnknownVariable
    WrapAfterColumn = 0
