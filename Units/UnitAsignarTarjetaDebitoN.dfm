object frmAsignarTarjetaDebitoN: TfrmAsignarTarjetaDebitoN
  Left = 338
  Top = 120
    ...
    object DBGCanal: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'VICA_NOPE'
          Title.Caption = 'OPERACIONES'
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'VICA_MONTO'
          Title.Caption = 'MONTO'
          Visible = True
        end>
    end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object MarcarPlstico1: TMenuItem
      Caption = 'Marcar Pl'#225'stico'
      object Formato11: TMenuItem
        Caption = 'Formato 1'
        OnClick = Formato11Click
      end
      object Formato21: TMenuItem
        Caption = 'Formato 2'
        OnClick = Formato21Click
      end
    end
  end
  ...
  object prMarcarPTD: TprReport
    ...
    object prPage1: TprPage
      ...
      tMargin = 10
      bMargin = 4
      PageScaleInfo.ScaleMode = psmUserSelected
  ...
  object CDScanal: TClientDataSet
    Active = True
    Aggregates = <>
    Params = <>
    Left = 312
    Top = 224
    Data = {
      
      490006004D6F6E6579000000}
    object CDScanalVICA_ID: TIntegerField
      FieldName = 'VICA_ID'
    end
    object CDScanalVICA_DESCRIPCION: TStringField
      FieldName = 'VICA_DESCRIPCION'
      Size = 250
    end
    object CDScanalVICA_NOPE: TIntegerField
      FieldName = 'VICA_NOPE'
    end
    object CDScanalVICA_MONTO: TCurrencyField
      FieldName = 'VICA_MONTO'
    end
  end
  ...
  object IBQvirtual_canal: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = dmGeneral.IBTransaction1
    SQL.Strings = (
