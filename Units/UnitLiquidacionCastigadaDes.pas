...
begin
          ...
          TGeneral := vAbonoCapital + vAbonoInteres + vcostas + vhonorarios + vPapeleria + vExAsociados;
...
procedure TfrmLiquidacionCastigada.EdTasaAplicadaExit(
  Sender: TObject);
begin
...
begin
        with IBQuery do
         begin
          ...
          ParamByName('ABONO_SERVICIOS').AsCurrency := vAbonoInteres;
          ...
          begin
            ...
            ParamByName('FECHA_CAPITAL').AsDate := fFechaActual; //FechaCapAnt;
            ExecSql;
            Close;
           end;
