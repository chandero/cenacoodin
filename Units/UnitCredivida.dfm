object FrmCredivida: TFrmCredivida
  Left = 387
  Top = 196
  Width = 497
  Height = 212
  ...
  Caption = 'Seguro de Vida Cr'#233'divida'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet3: TTabSheet
      ...
      object DBtipocuenta: TDBLookupComboBox
        ...
        TabOrder = 0
        OnEnter = DBtipocuentaEnter
        OnKeyPress = DBtipocuentaKeyPress
      end
  ...
  object Panel1: TPanel
    ...
    object JVdocumento: TStaticText
      Left = 334
      Top = 7
      Width = 70
      Height = 19
    ...
    object EDcert: TMaskEdit
      ...
      TabOrder = 3
      OnExit = EDcertExit
      OnKeyPress = EDcertKeyPress
    end
  end
  object Gforma: TGroupBox
    Left = 186
    Top = 84
    Width = 169
    Height = 55
    ...
    Enabled = False
    TabOrder = 2
    object RBahorro: TRadioButton
      Left = 15
      Top = 13
      Width = 143
      Height = 17
      Caption = 'Descuento de Ahorros'
      TabOrder = 0
      OnKeyPress = RBahorroKeyPress
    end
    object RBcaja: TRadioButton
      Left = 15
      Top = 33
      Width = 143
      Height = 17
      Caption = 'Pago por Caja General'
      TabOrder = 1
      OnKeyPress = RBcajaKeyPress
    end
  end
  object GroupBox2: TGroupBox
    ...
    object Label11: TLabel
      ...
      Width = 66
      Height = 13
      Caption = 'Saldo Aportes'
    end
    object JVnumeroC: TJvStaticText
      Left = 81
      Top = 16
      Width = 99
      Height = 19
    ...
    object JVaportes: TJvStaticText
      Left = 81
      Top = 94
      Width = 98
      Height = 19
  ...
  object Panel2: TPanel
    ...
    object ChCredivida: TCheckBox
      ...
      Width = 141
      Height = 17
      Caption = '&Descuento Cr'#233'divida'
      TabOrder = 0
    end
  end
