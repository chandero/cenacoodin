...
begin
        ...
        //ExtraerRemoto(buscaservicio(5,1).vPuerto,buscaservicio(5,1).vHost,'SANTA CLARA');
end;
...
begin
        ...
        begin
          Filtered := False;
          Filter := 'id_identificacion = ' + IntToStr(id_identificacion) + ' and id_persona = ' + QuotedStr(id_persona);
          Filtered := True;
          while not Eof do
          begin
