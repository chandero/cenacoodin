...
begin
        ...
        ExtraerRemoto(3052,'192.168.203.2','AGUACHICA');
          ...
          // AStream := TMemoryStream.Create;
           ...
           begin
             ...
             begin
                ...
                if Desc_Agencia = 'CONVENCION' then begin
                  BarConvencion.Min := 0;
                  BarConvencion.Max := AList.Count-1;
                  BarConvencion.Position := 0;
                end else
                if Desc_Agencia = 'AGUACHICA' then begin
                  BarAguachica.Min := 0;
                ...
                begin
                  ...
                  begin
                    ...
                    else if Desc_Agencia = 'AGUACHICA' then
