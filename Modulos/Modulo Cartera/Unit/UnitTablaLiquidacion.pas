...
uses
  ...
  CECheckList, IBQuery, UnitDmGeneral, DB, IBCustomDataSet, IBTable,
  DBGrids;
...
procedure TfrmTablaLiquidacion.DSTablaDataChange(Sender: TObject;
  Field: TField);
begin
        cambios := true;
end;

procedure TfrmTablaLiquidacion.DSTablaUpdateData(Sender: TObject);
begin
        cambios := true;
end;

procedure TfrmTablaLiquidacion.DSTablaStateChange(Sender: TObject);
begin
        cambios := true;
end;

procedure TfrmTablaLiquidacion.DBGridTablaDrawColumnCell(Sender: TObject;
...
procedure TfrmTablaLiquidacion.DBGridTablaColExit(Sender: TObject);
begin
        if DBGridTabla.SelectedField.FieldName = DBCheckBox1.DataField then
        DBCheckBox1.Visible := False
end;

procedure TfrmTablaLiquidacion.DBGridTablaKeyPress(Sender: TObject;
  var Key: Char);
begin
