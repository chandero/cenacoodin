object frmEvaluacion: TfrmEvaluacion
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      Caption = 'Tabla de Provisi'#243'n'
      ImageIndex = 1
      object DBGPorc: TDBGrid
        Left = 0
        Top = 0
        Width = 830
        Height = 361
  ...
  object IBQRangoProv: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM "col$porccausacioneval" p WHERE p.ID_CLASIFICACION' +
        ' = :ID_CLASIFICACION and p.ID_GARANTIA = :ID_GARANTIA and p.ID_E' +
        'DAD = :ID_EDAD')
    Left = 704
    Top = 32
    ParamData = <
  ...
  object IBPorc: TIBTable
    Database = dmGeneral.IBDatabase1
    Transaction = IBTransaction1
    TableName = 'col$porccausacioneval'
    Left = 592
    Top = 8
  end
  object DSporc: TDataSource
    DataSet = IBPorc
    Left = 568
    Top = 24
  end
