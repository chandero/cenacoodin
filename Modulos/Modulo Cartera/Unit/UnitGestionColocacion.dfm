object frmGestionColocacion: TfrmGestionColocacion
  Left = 425
  Top = 206
  Width = 683
  Height = 398
  Caption = 'Gesti'#243'n de Colocaci'#243'n'
  Color = clBtnFace
  ...
  object GroupBox2: TGroupBox
    ...
    object EdFechaCapital: TDateTimePicker
      ...
      Date = 42709.4952861227
      Time = 42709.4952861227
      DateFormat = dfShort
      DateMode = dmComboBox
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      ...
      ParentFont = False
      TabOrder = 26
      OnChange = EdFechaCapitalChange
    end
    object chkFechaSync: TCheckBox
      Left = 214
      Top = 251
      Width = 17
      Height = 17
    ...
    object edNuevaCuota: TJvCurrencyEdit
      Left = 105
      Top = 183
      Width = 104
      Height = 21
    ...
    object btnGuardarCuota: TBitBtn
      Left = 214
      Top = 180
      Width = 131
      Height = 25
      Hint = 'Guardar Cambio en las Fechas'
      Caption = '&Aplicar Nueva Cuota'
      Enabled = False
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
    ...
    object edRecalculos: TStaticText
      Left = 456
      Top = 144
      Width = 65
      Height = 21
  ...
  object Panel4: TPanel
    ...
    object btnRecalcularCuota: TBitBtn
      Left = 7
      Top = 81
      Width = 106
      Height = 25
      ...
      TabOrder = 5
      OnClick = btnRecalcularCuotaClick
      Glyph.Data = {
        36050000424D3605000000000000360400002800000010000000100000000100
        08000000000000010000D30E0000D30E00000001000000010000008C00000094
        0000009C000000A5000000940800009C100000AD100000AD180000AD210000B5
