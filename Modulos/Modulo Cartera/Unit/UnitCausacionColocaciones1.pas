unit UnitCausacionColocaciones1;
...
type
  TfrmCausacionColocaciones1 = class(TForm)
    Panel2: TPanel;
    Panel3: TPanel;
...
var
  frmCausacionColocaciones1: TfrmCausacionColocaciones1;
...
procedure TfrmCausacionColocaciones1.FormCreate(Sender: TObject);
begin
        dmColocacion := TdmColocacion.Create(self);
end;


procedure TfrmCausacionColocaciones1.FormShow(Sender: TObject);
var I:Integer;
begin
...
procedure TfrmCausacionColocaciones1.CmdCerrarClick(Sender: TObject);
begin
        Close;
end;

procedure TfrmCausacionColocaciones1.CmdProcesarClick(Sender: TObject);
begin
...
procedure TfrmCausacionColocaciones1.EvaluarCortoPlazo;
begin
...
procedure TfrmCausacionColocaciones1.FormDestroy(Sender: TObject);
begin
        dmColocacion.Free;
end;

function TfrmCausacionColocaciones1.EvaluarEdad(Clasificacion,
...
function TfrmCausacionColocaciones1.CalculoAportes(id: integer;
  pr: string): currency;
begin
// Calculo Aportes
            with IBSQL3 do begin
...
procedure TfrmCausacionColocaciones1.CmdImprimirClick(Sender: TObject);
...
procedure TfrmCausacionColocaciones1.CmdAplicarClick(Sender: TObject);
var Total:Integer;
...
procedure TfrmCausacionColocaciones1.EdFechaCorteChange(Sender: TObject);
var Fecha:TDateTime;
begin
...
procedure TfrmCausacionColocaciones1.CmdComprobanteClick(Sender: TObject);
begin
        ...
        xsauxiliar.Cols[2].Text  := 'D?bitos';
        xsauxiliar.Cols[3].Text  := 'Cr?ditos';
...
procedure TfrmCausacionColocaciones1.PrimerPasoComprobante;
var AR : Plist;
...
procedure TfrmCausacionColocaciones1.ActualizarGrid;
var
i:integer;
ARecord: PList;
...
procedure TfrmCausacionColocaciones1.SegundoPasoComprobante;
var AR:PList;
    Codigo:string;
    Valor:Currency;
    Aplica :Boolean;
...
procedure TfrmCausacionColocaciones1.TercerPasoComprobante;
var AR:PList;
    Valor:Currency;
    Codigo:string;
...
procedure TfrmCausacionColocaciones1.CuartoPasoComprobante;
var AR:PList;
    Valor:Currency;
    Codigo:string;
    Comercial,Consumo,Vivienda,Microcredito:Currency;
...
procedure TfrmCausacionColocaciones1.QuintoPasoComprobante;
var AR:PList;
    Valor:Currency;
    Codigo:string;
    Comercial,Consumo,Vivienda,Microcredito:Currency;
...
procedure TfrmCausacionColocaciones1.SextoPasoComprobante;
var AR:PList;
    Valor:Currency;
    Codigo:string;
...
procedure TfrmCausacionColocaciones1.SeptimoPasoComprobante;
var AR:PList;
    Valor:Currency;
    Codigo:string;
    Comercial,Consumo,Vivienda,Microcredito:Currency;
...
procedure TfrmCausacionColocaciones1.OctavoPasoComprobante;
var AR:PList;
    Valor:Currency;
    Codigo:string;
    Comercial,Consumo,Vivienda,Microcredito:Currency;
...
procedure TfrmCausacionColocaciones1.PrimerPasoCausacion;
var I :Integer;
begin
        frmPantallaProgreso := TfrmProgreso.Create(Self);
// Actualizar tabla de tasas
...
procedure TfrmCausacionColocaciones1.SegundoPasoCausacion;
var id_ant:Integer;
    pr_ant:string;
    edad_ant:string;
    primerpaso:Boolean;
...
procedure TfrmCausacionColocaciones1.NovenoPasoComprobante;
var AR:PList;
   i:Integer;
...
procedure TfrmCausacionColocaciones1.DecimoPasoComprobante;
var I:Integer;
...
procedure TfrmCausacionColocaciones1.TercerPasoCausacion;
begin
...
procedure TfrmCausacionColocaciones1.CmdImprimirComprobanteClick(
  Sender: TObject);
begin
...
function TfrmCausacionColocaciones1.BuscoTasaAnt(Ag: integer;
...
procedure TfrmCausacionColocaciones1.PrimerPC;
var AR : Plist;
    CortoActual,LargoActual:Currency;
    CodigoCorto,CodigoLargo:string;
    ValorCorto,ValorLargo:Currency;
...
procedure TfrmCausacionColocaciones1.SegundoPC;
var AR:PList;
    Codigo:string;
...
procedure TfrmCausacionColocaciones1.TercerPC;
var AR:PList;
...
procedure TfrmCausacionColocaciones1.CuartoPC;
var AR:PList;
...
procedure TfrmCausacionColocaciones1.QuintoPC;
var AR:PList;
    Valor,ValorProvision:Currency;
    Codigo:string;
    Comercial,Consumo,Vivienda,Microcredito:Currency;
...
procedure TfrmCausacionColocaciones1.SextoPC;
var AR:PList;
    Valor:Currency;
    Codigo:string;
    Colocaciones:Currency;
...
procedure TfrmCausacionColocaciones1.SeptimoPC;
var AR:PList;
...
procedure TfrmCausacionColocaciones1.OctavoPC;
var AR:PList;
...
procedure TfrmCausacionColocaciones1.NovenoPC;
var AR:PList;
   i:Integer;
   Valor,Valor1:Currency;
begin
...
procedure TfrmCausacionColocaciones1.DecimoPC;
var I:Integer;
    TotalDebito:Currency;
    TotalCredito:Currency;
    ARecord:PList;
