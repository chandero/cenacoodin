...
uses
  ...
  ExtCtrls, unitDmGeneral, ComCtrls;
...
procedure TfrmConsultaColocacion.CmdGrabarClick(Sender: TObject);
begin
...
procedure TfrmConsultaColocacion.EdFechaInteresChange(Sender: TObject);
begin
        if (chkFechaSync.Checked) then
               EdFechaCapital.Date := EdFechaInteres.Date;
end;

procedure TfrmConsultaColocacion.EdFechaCapitalChange(Sender: TObject);
begin
        if (chkFechaSync.Checked) then
