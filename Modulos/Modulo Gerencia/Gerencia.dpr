...
uses
  ...
  UnitInformeGeneraldeCaptaciones1 in 'reporte\UnitInformeGeneraldeCaptaciones1.pas' {frmInformeGeneraldeCaptaciones1},
  ...
  UnitCambioSistemas in '..\..\Units\UnitCambioSistemas.pas' {FrmCambioSistemas},
  UnitGuardaImagen in '..\..\Units\UnitGuardaImagen.pas',
  UnitInformeAsociadosDetalle in 'UnitInformeAsociadosDetalle.pas' {frmInformeAsociadosDetalle};
