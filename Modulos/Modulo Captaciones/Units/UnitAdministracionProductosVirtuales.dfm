object frmAdministracionProductosVirtuales: TfrmAdministracionProductosVirtuales
  ...
  object IBQCuentas: TIBQuery
    ...
    SQL.Strings = (
      'SELECT * FROM "cap$maestrotitular" t'
        ...
        'WHERE t.ID_TIPO_CAPTACION IN (2,4) and t.ID_IDENTIFICACION = :ID' +
        '_IDENTIFICACION and t.ID_PERSONA = :ID_PERSONA'
  ...
  object frReport1: TfrReport
    ...
    ReportForm = {
      ...
      000000000000004D000717B6C7545DE3401495BE7E785BE540}
  end
