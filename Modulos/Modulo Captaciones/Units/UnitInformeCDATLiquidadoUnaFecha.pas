unit UnitInformeCDATLiquidadoUnaFecha;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, DB, IBCustomDataSet, IBQuery, StdCtrls, Buttons, ComCtrls, DataSetToExcel;

type
  TfrmInformeCDATLiquidadoUnaFecha = class(TForm)
    Label1: TLabel;
...
procedure TfrmInformeCDATLiquidadoUnaFecha.BitBtn2Click(Sender: TObject);
  var
