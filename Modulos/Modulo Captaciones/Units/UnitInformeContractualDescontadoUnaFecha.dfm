object frmInformeContractualDescontadoUnaFecha: TfrmInformeContractualDescontadoUnaFecha
  Left = 562
  Top = 249
  Width = 366
  Height = 108
  Caption = 'Informe Contractual Descontado Una Fecha'
  Color = clBtnFace
  ...
  object IBQuery1: TIBQuery
    SQL.Strings = (
        ...
        'IDO || '#39' '#39' || p.NOMBRE) AS NOMBRE, ce.VALOR_DEBITO AS DESCUENTO,' +
        ' m.ID_TIPO_CAPTACION_ABONO, m.NUMERO_CUENTA_ABONO FROM "cap$extr' +
        'acto" ce'
        ...
        'WHERE ce.ID_TIPO_CAPTACION  = 5 AND ce.ID_TIPO_MOVIMIENTO = 6 AN' +
        'D ce.FECHA_MOVIMIENTO = :FECHA_MOVIMIENTO AND ce.VALOR_DEBITO > ' +
        '0')
    Left = 8
    Top = 40
    ParamData = <
