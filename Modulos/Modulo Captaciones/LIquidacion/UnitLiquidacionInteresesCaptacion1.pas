unit UnitLiquidacionInteresesCaptacion1;
...
uses
  ...
  pr_TxClasses, UnitPantallaProgreso, IBStoredProc, IB, DBClient,IBDatabasE;

type
  TfrmLiquidacionInteresesCaptacion1 = class(TForm)
    GroupBox9: TGroupBox;
    Label24: TLabel;
    Label3: TLabel;
...
var
  frmLiquidacionInteresesCaptacion1: TfrmLiquidacionInteresesCaptacion1;
  Liquidado:Boolean;
  TasaR:Extended;
  DiarioR:Currency;
...
procedure TfrmLiquidacionInteresesCaptacion1.CmdCerrarClick(Sender: TObject);

begin
        Close;
end;

procedure TfrmLiquidacionInteresesCaptacion1.RadioTipoLiquidacionClick(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionInteresesCaptacion1.CmdLiquidarClick(
  Sender: TObject);
var forma:Integer;
    interesCada :Integer;
    interes :Double;
...
procedure TfrmLiquidacionInteresesCaptacion1.CasoAhorros(Tipo:Integer;cada:Integer;TasaN:Double);
...
procedure TfrmLiquidacionInteresesCaptacion1.CasoCertificados;
var MinCaptacion,MaxCaptacion:Integer;
    Ag,Numero,Digito:Integer;
    L:tInteres;
    FechaCorte:TDate;
...
procedure TfrmLiquidacionInteresesCaptacion1.Inicializar;
begin
     if dmGeneral.IBTransaction1.InTransaction then
...
procedure TfrmLiquidacionInteresesCaptacion1.DBLCBTipoCaptacionEnter(
  Sender: TObject);
begin
        DBLCBTipoCaptacion.DropDown;
end;

procedure TfrmLiquidacionInteresesCaptacion1.FormShow(Sender: TObject);
begin
        Inicializar;
end;

procedure TfrmLiquidacionInteresesCaptacion1.FormCreate(Sender: TObject);
begin
        dmLiquidacionCaptacion:=TdmLiquidacionCaptacion.Create(Self);
end;

procedure TfrmLiquidacionInteresesCaptacion1.FormDestroy(Sender: TObject);
begin
        dmLiquidacionCaptacion.Free;
end;

procedure TfrmLiquidacionInteresesCaptacion1.CmdVerClick(Sender: TObject);
...
begin
        ...
        with ReporteCon do
        begin
           LoadTemplateFromFile(FrmMain.Ruta1+'\reporte\RepContractual.prt',False);
           Variables.ByName['EMPRESA'].AsString := Empresa;
           Variables.ByName['NIT'].AsString := Nit;
           Variables.ByName['FECHACORTE'].AsDateTime := EdFecha.Date;
           Variables.ByName['AGENCIA'].AsString := NameAgencia;
...
procedure TfrmLiquidacionInteresesCaptacion1.CmdAplicarClick(
  Sender: TObject);
...
// Fin Consecutivo
        ...
        begin
           ...
           FieldByName('DESCRIPCION').AsString := 'Liquidación de Intereses en la Fecha ' +
                                                  'Tasa de Liquidación: ' + EdTasaN.Caption + ', ' +
                                                  'Saldo Mínimo en cuenta: ' + EdSaldoMinimo.Caption;
...
procedure TfrmLiquidacionInteresesCaptacion1.CmdComprobanteClick(
  Sender: TObject);
begin
...
procedure TfrmLiquidacionInteresesCaptacion1.FormCloseQuery(Sender: TObject;
...
procedure TfrmLiquidacionInteresesCaptacion1.CasoProgramado;
var MinCaptacion,MaxCaptacion:Integer;
    Ag,Numero,Digito:Integer;
                ...
                begin
                   ...
                   try
                    ...
                    if IBSQL1.RecordCount > 0 then begin
                       if IBSQL1.FieldByName('SALDO_DISPONIBLE').AsCurrency >= FieldByName('VALOR_INICIAL').AsCurrency then
                        begin
                         CDSContractual.FieldByName('DESCUENTO').AsCurrency := FieldByName('VALOR_INICIAL').AsCurrency;
                    ...
                    begin
                         CDSContractual.FieldByName('DESCUENTO').AsCurrency := FieldByName('VALOR_INICIAL').AsCurrency;
                         CDSContractual.FieldByName('ESTADO').AsString := 'E';
                    end;
                   except
                    Transaction.Rollback;
                    frmProgreso.Cerrar;
...
procedure TfrmLiquidacionInteresesCaptacion1.AplicarProgramado;
var Total:Integer;
    Ag:Integer;
    Tipo : Integer;
    Numero:Integer;
...
begin
        ...
        with CDSContractual do begin
           ...
           Comprobante := ObtenerConsecutivo(IBSQL2);
           ...
           begin
              ...
              begin
                ...
                IBSQL1.ParamByName('FECHA_DESCUENTO').AsDate := FieldByName('FECHA_DESCUENTO').AsDateTime;
                try
                 IBSQL1.ExecQuery;
        ...
        begin
           ...
           FieldByName('TIPO_COMPROBANTE').AsInteger := 1;
           FieldByName('FECHADIA').AsDateTime := EdFecha.Date;
           FieldByName('DESCRIPCION').AsString := 'Descuento Ahorro Contractual';
           FieldByName('TOTAL_DEBITO').AsCurrency := VrDescuento + GMF;
           FieldByName('TOTAL_CREDITO').AsCurrency := VrDescuento + GMF;
           FieldByName('ESTADO').AsString := 'O';
           FieldByName('IMPRESO').AsInteger := 1;
           FieldByName('ANULACION').AsString := '';
           FieldByName('ID_EMPLEADO').AsString := DBAlias;
        ...
        begin
           ...
           FieldByName('CODIGO').AsString := Codigo_Captacion;
           FieldByName('DEBITO').AsCurrency := 0;
           FieldByName('CREDITO').AsCurrency := VrDescuento;
           FieldByName('ID_CUENTA').AsInteger :=0;
           FieldByName('ID_COLOCACION').Clear;
           FieldByName('ID_IDENTIFICACION').AsInteger := 0;
           FieldByName('ID_PERSONA').Clear;
           FieldByName('MONTO_RETENCION').AsCurrency := 0;
           FieldByName('TASA_RETENCION').AsFloat := 0;
           FieldByName('ESTADOAUX').AsString := 'O';
           Post;

           if ValorCap2 > 0 then begin
            Append;
            FieldByName('ID_COMPROBANTE').AsInteger := Comprobante;
            FieldByName('ID_AGENCIA').AsInteger := Agencia;
            FieldByName('FECHA').AsDateTime := EdFecha.Date;
            FieldByName('CODIGO').AsString := Codigo_Captacion2;
            FieldByName('DEBITO').AsCurrency := ValorCap2;
            FieldByName('CREDITO').AsCurrency := 0 ;
            FieldByName('ID_CUENTA').AsInteger :=0;
            FieldByName('ID_COLOCACION').Clear;
            FieldByName('ID_IDENTIFICACION').AsInteger := 0;
           ...
           if ValorCap4 > 0 then begin
            Append;
            FieldByName('ID_COMPROBANTE').AsInteger := Comprobante;
            FieldByName('ID_AGENCIA').AsInteger := Agencia;
            FieldByName('FECHA').AsDateTime := EdFecha.Date;
            FieldByName('CODIGO').AsString := Codigo_Captacion4;
            FieldByName('DEBITO').AsCurrency := ValorCap4;
            FieldByName('CREDITO').AsCurrency := 0 ;
            FieldByName('ID_CUENTA').AsInteger :=0;
            FieldByName('ID_COLOCACION').Clear;
            FieldByName('ID_IDENTIFICACION').AsInteger := 0;
           ...
           FieldByName('ID_AGENCIA').AsInteger := Agencia;
           FieldByName('FECHA').AsDateTime := EdFecha.Date;
           FieldByName('CODIGO').AsString := Codigo_GMF;
           FieldByName('DEBITO').AsCurrency := 0;
           FieldByName('CREDITO').AsCurrency := GMF;
           FieldByName('ID_CUENTA').AsInteger :=0;
           FieldByName('ID_COLOCACION').Clear;
           FieldByName('ID_IDENTIFICACION').AsInteger := 0;
           FieldByName('ID_PERSONA').Clear;
           ...
           FieldByName('ID_AGENCIA').AsInteger := Agencia;
           FieldByName('FECHA').AsDateTime := EdFecha.Date;
           FieldByName('CODIGO').AsString := Codigo_GGMF;
           FieldByName('DEBITO').AsCurrency := GMF;
           FieldByName('CREDITO').AsCurrency := 0;
           FieldByName('ID_CUENTA').AsInteger :=0;
           FieldByName('ID_COLOCACION').Clear;
           FieldByName('ID_IDENTIFICACION').AsInteger := 0;
...
procedure TfrmLiquidacionInteresesCaptacion1.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
        EnterTabs(Key,Self);
end;
