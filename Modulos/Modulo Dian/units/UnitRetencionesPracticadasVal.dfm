object frmRetencionesPracticadasVal: TfrmRetencionesPracticadasVal
  Left = 223
  Top = 225
  Width = 384
  Height = 150
  ...
  object GroupBox1: TGroupBox
    ...
    object fecha1: TDateTimePicker
      ...
      Date = 39281.6937329977
      Time = 39281.6937329977
      DateFormat = dfShort
      DateMode = dmComboBox
      Kind = dtkDate
      ParseInput = False
    ...
    object fecha2: TDateTimePicker
      ...
      Height = 21
      CalAlignment = dtaLeft
      Date = 39281.6939572454
      Time = 39281.6939572454
      DateFormat = dfShort
      DateMode = dmComboBox
      Kind = dtkDate
      ParseInput = False
  ...
  object IBQuery2: TIBQuery
    SQL.Strings = (
      ...
      '  CON$RETEFUENTE'
        ...
        '  INNER JOIN "gen$persona" ON (CON$RETEFUENTE.ID_IDENTIFICACION ' +
        '= "gen$persona".ID_IDENTIFICACION) AND (CON$RETEFUENTE.ID_PERSON' +
        'A = "gen$persona".ID_PERSONA)'
      '  INNER JOIN CON$PUC ON (CON$RETEFUENTE.CODIGO = CON$PUC.CODIGO)'
      
        '  INNER JOIN "gen$tiposidentificacion" ON (CON$RETEFUENTE.ID_IDE' +
        'NTIFICACION = "gen$tiposidentificacion".ID_IDENTIFICACION)'
      
        ' INNER JOIN CON$RETEFUENTECSC ON (CON$RETEFUENTE.ID_PERSONA = CO' +
        'N$RETEFUENTECSC.ID_PERSONA)'
      'WHERE'
