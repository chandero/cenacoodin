unit UnitReporteColocacionesFogacoopEvaluacion;
...
type
  TfrmReporteColocacionesFogacoopEvaluacion = class(TForm)
    Label1: TLabel;
    CBMeses: TComboBox;
    IBQuery1: TIBQuery;
    IBQuery2: TIBQuery;
...
var
  frmReporteColocacionesFogacoopEvaluacion: TfrmReporteColocacionesFogacoopEvaluacion;
  FechaCorte:TDate;
  _fFechaAporte :TDate;
...
procedure TfrmReporteColocacionesFogacoopEvaluacion.CmdCerrarClick(Sender: TObject);
begin
        Close;
end;

procedure TfrmReporteColocacionesFogacoopEvaluacion.CmdProcesarClick(Sender: TObject);
var
Dia:Integer;
NRuta:string;
begin
...
procedure TfrmReporteColocacionesFogacoopEvaluacion.Cartera;
var 
    Dia:Integer;
    Total:Integer;
    Lineas:TColocacion;
...
begin
    ...
    AssignFile(ARCHIVO,'C:/PlanosFinMes/CARTERA_RECALIFICADA' + FormatCurr('00',IBAgencia.FieldByName('ID_AGENCIA').AsInteger) + Cadena + '.TXT');
    Rewrite(Archivo);
    Cadena := 'TIPO ID'+ #9 +
              'IDENTIFICACION' + #9 +
              'NOMBRE' + #9 +
...
// Fin Busco si fue recalificado
              ...
              Cadena := Lineas.Tipo_Identificacion + #9 +
                          ...
                          Lineas.Provision_Capital_Evaluado + #9 +
...
procedure TfrmReporteColocacionesFogacoopEvaluacion.FormShow(Sender: TObject);
begin
        EdAno.Value := YearOf(Date);
        CBMeses.ItemIndex := MonthOf(Date);
end;

function TfrmReporteColocacionesFogacoopEvaluacion.CalculoAportes(Agencia:Integer;id: Integer; pr: string): Currency;
var
