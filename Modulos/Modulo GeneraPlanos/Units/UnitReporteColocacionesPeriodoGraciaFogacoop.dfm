object frmReporteColocacionesPeriodoGraciaFogacoop: TfrmReporteColocacionesPeriodoGraciaFogacoop
  Left = 633
  Top = 309
  Width = 404
  Height = 155
  Caption = 'Proceso Colocaciones Periodo Gracia'
  Color = clBtnFace
  ...
  object SD1: TSaveDialog
    DefaultExt = 'txt'
    Title = 'Ubicaci'#243'n para el Archivo'
    Left = 152
    Top = 48
  end
end
