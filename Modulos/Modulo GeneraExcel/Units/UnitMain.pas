...
type
  TfrmMain = class(TForm)
    ...
    GenerarExcelTransaccionesCaja1: TMenuItem;
    ...
    procedure GenerarExcelTransaccionesCaja1Click(Sender: TObject);
  private
...
uses UnitGlobales,UnitReporteCaptacionesFogacoop,UnitReporteColocacionesFogacoop,UnitCancelacionCdats, UnitCarteraFogacoop,
  ...
  UnitReporteBalance, UnitResumenProductos, UnitNivelIngresos, UnitAportesSociales_F21, UnitArchivoTransacciones;
...
procedure TfrmMain.GenerarExcelTransaccionesCaja1Click(Sender: TObject);
var
