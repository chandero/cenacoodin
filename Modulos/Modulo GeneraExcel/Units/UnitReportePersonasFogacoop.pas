      ...
      with IBSQL1 do
       begin
         ...
         SQL.Add('"gen$persona".ID_PERSONA = "gen$persadicional".ID_PERSONA)');
          SQL.Add(' WHERE');
          SQL.Add('  ("cap$maestro".ID_ESTADO IN (1,4,10) or "gen$persona".ID_TIPO_RELACION IN (3,4)) and "gen$persona".FECHA_REGISTRO <= :FECHA_CORTE');
         ...
         Close;
         SQL.Clear;
         SQL.Add('select "gen$persona".ID_IDENTIFICACION,"gen$persona".ID_PERSONA,PRIMER_APELLIDO,SEGUNDO_APELLIDO,NOMBRE,SEXO,ID_CIIU,FECHA_NACIMIENTO,ID_TIPO_ESTADO_CIVIL, "gen$persona".EMAIL, "gen$direccion".COD_MUNICIPIO,');
         SQL.Add('"cap$maestro".FECHA_APERTURA,"gen$direccion".TELEFONO1,"gen$direccion".DIRECCION, "gen$direccion".COD_MUNICIPIO,');
         SQL.Add('(INGRESOS_A_PRINCIPAL+INGRESOS_OTROS) AS INGRESOS,"gen$persadicional".CABEZAFAMILIA,"gen$persadicional".ID_ESTRATO,"gen$persadicional".ID_TIPOCONTRATO,"gen$persadicional".ID_SECTOR,"gen$persadicional".ID_OCUPACION,"gen$persadicional".ID_ESTUDIO');
