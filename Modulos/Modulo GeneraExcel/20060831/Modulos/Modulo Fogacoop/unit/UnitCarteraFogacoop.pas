...
// Ocaña
   DBpath1 := dbpath + '01' + FormatCurr('00',MonthOf(EdFechaCorte.Date)) + FormatCurr('0000',YearOf(EdFechaCorte.Date)) + '/';
   ...
   try
    ...
    AssignFile(Archivo,'//Archivos/publico/PlanosFinMes/RECCARTERA01' + Cadena + '.TXT');
...
// Abrego
   ...
   try
    ...
    Cadena := IntToStr(YearOf(EdFechaCorte.Date)) + IntToStr(MonthOf(EdFechaCorte.Date)) + IntToStr(DayOf(EdFechaCorte.Date));
    AssignFile(Archivo,'//Archivos/publico/PlanosFinMes/RECCARTERA02' + Cadena + '.TXT');
    //AssignFile(F,'C:/PlanosFinMes/Aportes' + Cadena);
...
// Convencion
   ...
   try
    ...
    Cadena := IntToStr(YearOf(EdFechaCorte.Date)) + IntToStr(MonthOf(EdFechaCorte.Date)) + IntToStr(DayOf(EdFechaCorte.Date));
    AssignFile(Archivo,'//Archivos/publico/PlanosFinMes/RECCARTERA03' + Cadena + '.TXT');
    //AssignFile(F,'C:/PlanosFinMes/Aportes' + Cadena);
