...
uses
  ...
  IdTCPClient, IdTime, ExtCtrls, DateUtils, IBSQL, ShellApi;
...
type
  TfrmMain = class(TForm)
    ...
    ConsolidacionBalance1: TMenuItem;
    MantenimientoLineas1: TMenuItem;
    Dian1: TMenuItem;
    Retenciones1: TMenuItem;
    Aportes10101: TMenuItem;
    InteresRecibido10071: TMenuItem;
    SaldosPrestamos10081: TMenuItem;
    PrestamosEfectuados10081: TMenuItem;
    RecuperacindeSaldosActual1: TMenuItem;
    GenerarSaldosdelMes1: TMenuItem;
    ImportarSaldosIniciales2: TMenuItem;
    ImportacinEnLnea1: TMenuItem;
    ImportarSaldosMes1: TMenuItem;
    EnLnea1: TMenuItem;
    ImportarCajaDiario1: TMenuItem;
    EnLnea2: TMenuItem;
    ...
    procedure ConsolidacionBalance1Click(Sender: TObject);
    procedure MantenimientoLineas1Click(Sender: TObject);
    procedure Retenciones1Click(Sender: TObject);
    procedure Aportes10101Click(Sender: TObject);
    procedure InteresRecibido10071Click(Sender: TObject);
    procedure SaldosPrestamos10081Click(Sender: TObject);
    procedure PrestamosEfectuados10081Click(Sender: TObject);
    procedure RecuperacindeSaldosActual1Click(Sender: TObject);
    procedure GenerarSaldosdelMes1Click(Sender: TObject);
    procedure ImportacinEnLnea1Click(Sender: TObject);
    procedure EnLnea1Click(Sender: TObject);
    procedure EnLnea2Click(Sender: TObject);
...
uses unitLogin, IniFiles,
     ...
     UnitBalanceConsolidadoTxt, UnitExportarSaldos, UnitCambios, UnitExtractoCredito,UnitMantenimientoLineas,UnitNotasCoop,
     UnitRetencion, UnitAportesPeriodo, UnitInteresesRecibidos,
     UnitPrestamosCorte, UnitPrestamos, UnitRecuperacionsaldosNew, UnitExportarSaldosMes, unitImportarSaldosInicialesEnLinea,
     UnitImportarSaldoCuentaEnLinea, UnitImportarCajaDiarioEnLinea, UnitLibroAsociados,
     UnitAuxiliar, UnitMayorYBalance, UnitBalance;
...
begin
  ...
  try
    ...
    host_abrego := ReadString('OFICINAS','ABREGO','0.0.0.0');
    host_ocana := ReadString('OFICINAS','OCANA','0.0.0.0');
    host_convencion := ReadString('OFICINAS','CONVENCION','0.0.0.0');
    _iCreacionNota := ReadInteger('ADICIONALES','nota',0);
...
var   FrmNotas : TFrmNotas;
      FrmNotasCoop : TFrmNotasCoop;
begin
        if _iCreacionNota <> 0 then
        begin
        ...
        begin
          FrmNotasCoop := TFrmNotasCoop.Create(Self);
          FrmNotasCoop.ShowModal;
        end;
end;
...
procedure TfrmMain.ConsolidacionBalance1Click(Sender: TObject);
var
  Parametros : string;
begin
  Parametros := DBAlias;
  Parametros := Parametros + ' ' + DBPasabordo;
          ShellExecute(self.Handle, 'open', PChar(ruta1+'\ConsolidacionBalance\ConsolidacionBalance.exe'),Pchar(Parametros), '' ,SW_NORMAL);
end;

procedure TfrmMain.MantenimientoLineas1Click(Sender: TObject);
var
        FrmMantenimientoLineas :TFrmMantenimientoLineas;
begin
        FrmMantenimientoLineas := TFrmMantenimientoLineas.Create(Self);
        FrmMantenimientoLineas.ShowModal;
end;
...
procedure TfrmMain.Aportes10101Click(Sender: TObject);
begin
        Timer2.Enabled := False;
...
procedure TfrmMain.PrestamosEfectuados10081Click(Sender: TObject);
begin
        Timer2.Enabled := False;
...
procedure TfrmMain.RecuperacindeSaldosActual1Click(Sender: TObject);
begin
        Timer2.Enabled := False;
        frmRecuperacionSaldosnew := Tfrmrecuperacionsaldosnew.Create(Self);
        frmRecuperacionSaldosnew.ShowModal;
        Timer2.Enabled := True;

end;

procedure TfrmMain.GenerarSaldosdelMes1Click(Sender: TObject);
var
  frmExportarSaldosMes : TfrmExportarSaldosMes;
begin
  frmExportarSaldosMes := TfrmExportarSaldosMes.Create(self);
  frmExportarSaldosMes.ShowModal;
end;

procedure TfrmMain.ImportacinEnLnea1Click(Sender: TObject);
var
        frmImportarSaldosIniciales:TfrmImportarSaldosInicialesEnLinea;
begin
         frmImportarSaldosIniciales := TfrmImportarSaldosInicialesEnLinea.Create(self);
         frmImportarSaldosIniciales.showModal;
end;

procedure TfrmMain.EnLnea1Click(Sender: TObject);
var
  frmImportarSaldoCuentaEnLinea: TfrmImportarSaldoCuentaEnLinea;
begin
      frmImportarSaldoCuentaEnLinea := TfrmImportarSaldoCuentaEnLinea.Create(self);
      frmImportarSaldoCuentaEnLinea.ShowModal;
end;

procedure TfrmMain.EnLnea2Click(Sender: TObject);
var
  frmImportarCajaDiarioEnLinea: TfrmImportarCajaDiarioEnLinea;
begin
    frmImportarCajaDiarioEnLinea := TfrmImportarCajaDiarioEnLinea.Create(self);
    frmImportarCajaDiarioEnLinea.ShowModal;
end;

procedure TfrmMain.Asociados1Click(Sender: TObject);
var
  frmLibroAsociados: TfrmLibroAsociados;
begin
        frmLibroAsociados := TfrmLibroAsociados.create(self);
        frmLibroAsociados.ShowModal;
end;

procedure TfrmMain.Auxiliar1Click(Sender: TObject);
var
...
procedure TfrmMain.Balance1Click(Sender: TObject);
var
...
procedure TfrmMain.Mayor1Click(Sender: TObject);
var
  frmMayor: TfrmMayorYBalance;
begin
    frmMayor := TfrmMayorYBalance.Create(self);
    frmMayor.ShowModal;
end;
