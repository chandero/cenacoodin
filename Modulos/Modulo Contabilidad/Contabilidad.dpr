...
uses
  ...
  UnitRecuperacionsaldosNew in '..\..\Units\UnitRecuperacionsaldosNew.pas' {frmrecuperacionsaldosNew},
  ...
  UnitMantenimientoLineas in '..\..\Units\UnitMantenimientoLineas.pas' {FrmMantenimientoLineas},
  ...
  UnitAportesPeriodo in '..\..\Units\UnitAportesPeriodo.pas' {frmAportesPeriodo},
  ...
  UnitExportarSaldosMes in '..\..\Units\UnitExportarSaldosMes.pas' {frmExportarSaldosMes},
  UnitImportarSaldosInicialesEnLinea in 'units\UnitImportarSaldosInicialesEnLinea.pas' {frmImportarSaldosInicialesEnLinea},
  UnitImportarSaldoCuentaEnLinea in 'units\UnitImportarSaldoCuentaEnLinea.pas' {frmImportarSaldoCuentaEnLinea},
  UnitImportarCajaDiarioEnLinea in 'units\UnitImportarCajaDiarioEnLinea.pas' {frmImportarCajaDiarioEnLinea},
