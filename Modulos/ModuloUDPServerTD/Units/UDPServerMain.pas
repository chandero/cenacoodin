 ...
 * Proposito: Servidor UDP atención peticiones TD
 * Version  : 1.0
...
uses
//  {$IFDEF Linux}
  QGraphics, QControls, QForms, QDialogs, QStdCtrls, QExtCtrls, DBXpress,
  FMTBcd, QTypes, DB, SqlExpr, IdBaseComponent, IdComponent, IdUDPBase,
  IdUDPServer, QButtons, Classes,
//  {$ELSE}
//  windows, messages, graphics, controls, qforms, dialogs, IdWinsock, stdctrls,
//  {$ENDIF}
  IniFiles,DateUtils, StrUtils, SysUtils,
  IdUDPClient, IdStack, IdSocketHandle,
  UnitDES,HexConvert,sdXmlDocuments;
