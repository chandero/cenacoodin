...
begin
        ...
        with IBQuery1 do begin
           ...
           while not eof do begin
             ...
             DataActual.FieldByName('FECHA_CORTE').AsDateTime := RecodeDay(EdFechaCorte.Date,Dayof(EndOfAMonth(YearOf(EdFechaCorte.Date),MonthOf(EdFechaCorte.Date))));
             DataActual.Post;
...
begin
   ...
   with IBSClientes do
    begin
      ...
      ParamByName('FECHA_CORTE').AsDate := EncodeDate(YearOf(EdFechaCorte.Date),MonthOf(EdFechaCorte.Date),DayOf(EdFechaCorte.Date));
      ExecQuery;
