unit copia2006UnitEntregaDetalles;
...
//                chkeducacion.Checked := xeducacion;
              ...
              try
                ...
                if IBSQL1.RecordCount > 0 then begin
                   ...
                   xApertura := True;
                   if IBSQL1.FieldByName('FECHA_APERTURA').AsDateTime > StrToDate('2005/12/31') then
                     xApertura := False
                   else
                     xApertura := True;
           ...
           if RecordCount > 0 then begin
              ...
              try
               ...
               if IBSQL1.RecordCount > 0 then begin
                  ...
                  if IBSQL1.FieldByName('FECHA_APERTURA').AsDate <= StrtoDate('2006/03/31') then
                   begin
                    xAperturaj := True;
               ...
               if IBSQL1.RecordCount > 0 then begin
                  ...
                  try
                    ...
                    begin
                       ...
                       IBQPersona.SQL.Add('"cap$maestrotitular".ID_AGENCIA,"cap$maestrotitular".ID_TIPO_CAPTACION,"cap$maestrotitular".NUMERO_CUENTA,"cap$maestrotitular".DIGITO_CUENTA,ID_ESTADO from "cap$maestrotitular"');
