...
//    AssignFile(Archivo,'//Archivos/publico/PlanosFinMes/BALANCE' + Cadena + '.TXT');
    ...
    with IBSQL1 do begin
     Close;
     SQL.Clear;
     SQL.Add('select * from BALANCE_GENERAL_CONSOLIDADO(:MES,4)');
     ...
     while not Eof do begin
       New(AR);
       AR^.Codigo := LeftStr(FieldByName('CODIGO').AsString,6);
