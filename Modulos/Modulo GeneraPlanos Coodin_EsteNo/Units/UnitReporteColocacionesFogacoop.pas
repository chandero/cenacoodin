...
begin
    ...
    AssignFile(ARCHIVO,'C:/PlanosFinMes/CARTERA' + Cadena + '.TXT');
    ...
    Cadena := 'TIPO ID'+ #9 +'IDENTIFICACION' + #9 + 'NOMBRE' + #9 + 'CLASIFICACION' + #9 + 'CALIFICACION' + #9 + 'CODIGO' + #9 + 'REESTRUCTURADO' + #9 + 'COLOCACION' + #9 + 'DESEMBOLSO' + #9 + 'VENCIMIENTO' + #9 + '' +
                  ...
                  'PRESTAMO' + #9 + 'CUOTA' + #9 + 'CAPITAL' + #9 + 'INTERES' + #9 + 'COSTAS' + #9 + 'GARANTIA' + #9 + 'AVALUO' + #9 + 'PROV CAPITAL' + #9 + 'PROV INTERES' + #9 + 'PROV COSTAS' + #9 +'ANTICIPADOS' + #9 + 'CONTINGEN' + #9 + ''+
       ...
       with IBQuery1 do begin
           ...
           SQL.Add('where');
           SQL.Add('FECHA_CORTE = :FECHA_CORTE AND DEUDA > 0');
...
procedure TfrmReporteColocacionesFogacoop.FormCreate(Sender: TObject);
begin
