object frmComprobanteC: TfrmComprobanteC
  Left = 493
  Top = 135
  Width = 689
  Height = 660
  Caption = 'Generaci'#243'n de Notas Contables'
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Panel4: TPanel
      ...
      object Label14: TLabel
        ...
        Width = 117
        Height = 13
        Caption = 'Detalle Individual Auxiliar'
      end
      ...
      object edDetalleAux: TMemo
        ...
        TabOrder = 1
        OnExit = edDetalleAuxExit
        OnKeyPress = edDetalleAuxKeyPress
      end
    end
  end
  object Panel1: TPanel
    ...
    object Label5: TLabel
      ...
      Height = 13
      Alignment = taCenter
      Caption = 'Detalle Para El Libro Auxiliar'
    end
    ...
    object Label8: TLabel
      ...
      Height = 13
      Alignment = taCenter
      Caption = 'Concepto Anulaci'#243'n'
      Visible = False
    end
    ...
    object dblcbtipo: TDBLookupComboBox
      ...
      ListSource = DsTipoC
      TabOrder = 0
      OnEnter = dblcbtipoEnter
      OnExit = dblcbtipoExit
      OnKeyPress = dblcbtipoKeyPress
    end
    object Edittotaldiferencia: TMemo
      Left = 427
      Top = 188
      Width = 108
      Height = 22
    ...
    object edFecha: TDateTimePicker
      ...
      Date = 40248.7265082523
      Time = 40248.7265082523
      DateFormat = dfShort
      DateMode = dmComboBox
      Kind = dtkDate
      ParseInput = False
  ...
  object Panel3: TPanel
    ...
    object btnGuardarPlantilla: TBitBtn
      Left = 4
      Top = 416
      Width = 97
      Height = 25
      Caption = 'Guardar Plan&tilla'
      TabOrder = 7
      OnClick = btnGuardarPlantillaClick
    end
    object btnRecuperarPlantilla: TBitBtn
      Left = 4
      Top = 447
      Width = 97
      Height = 25
      Caption = 'Recuperar &Plantilla'
      TabOrder = 8
      OnClick = btnRecuperarPlantillaClick
    end
  ...
  object QueryComprobante: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  CON$COMPROBANTE.DESCRIPCION AS DESCRIPCION1,'
  ...
  object prTxReportCartera: TprTxReport
    ShowProgress = True
    DesignerFormMode = fmMDIChild
    Title = 'Liquidaci'#243'n'
    ExportFromPage = 0
    ...
    object prTxPage1: TprTxPage
      ...
      object prTxHDetailHeaderBand1: TprTxHDetailHeaderBand
        Height = 3
        UseVerticalBands = False
        DetailBand = prTxReportCartera.prTxHDetailBand1
        ColCount = 0
        ColDirection = prcdTopBottomLeftRight
        ReprintOnEachPage = False
        LinkToDetail = False
  ...
  object prReportCartera: TprReport
    ...
    object prPage1: TprPage
        ...
        object prMemoObj4: TprMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'Comprobante[:<000000>comprobante]')
              lBorder.Show = False
              lBorder.Style = psSolid
              lBorder.Color = clBlack
              lBorder.Width = 1
        ...
        object prMemoObj3: TprMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'LIQUIDACION DE COLOCACION: [Colocacion]')
              lBorder.Show = True
              lBorder.Style = psSolid
              lBorder.Color = clBlack
              lBorder.Width = 1
      ...
      object prHDetailBand2: TprHDetailBand
        ...
        ColCount = 1
        ColDirection = prcdTopBottomLeftRight
        ParentDetail = prReportCartera.prHDetailBand1
        object prMemoObj24: TprMemoObj
          dRec.DefVersion = 0
          dRec.Versions = <
            item
