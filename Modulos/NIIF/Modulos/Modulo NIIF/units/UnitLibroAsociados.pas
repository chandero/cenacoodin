...
uses
  ...
  FR_DBSet, pr_Common, pr_Classes, UnitDmGeneral;
...
uses UnitGlobales, DataSetToExcel;
...
//        prReport1.LoadTemplateFromFile(Application.GetNamePath+'\ReportesCon\prLibroAsociados.prt', true);
        DateTimeToString(FechaCorte,'yyyy/mm/dd',FechaFinal);
        prReport1.Variables.ByName['FECHA_CORTE'].AsString := FechaCorte;
