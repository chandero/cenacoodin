object frmLibroBalanceGeneral: TfrmLibroBalanceGeneral
  Left = 404
  Top = 205
  Width = 369
  Height = 108
  Caption = 'Libro Balance General'
  Color = clBtnFace
  ...
  object IBQPuc: TIBQuery
    ...
    SQL.Strings = (
      ...
      'from CON$PUC'
        ...
        'INNER JOIN CON$SALDOSCUENTA ON (CON$PUC.CODIGO = CON$SALDOSCUENT' +
        'A.CODIGO and CON$PUC.ID_AGENCIA = CON$SALDOSCUENTA.ID_AGENCIA)'
      'where'
