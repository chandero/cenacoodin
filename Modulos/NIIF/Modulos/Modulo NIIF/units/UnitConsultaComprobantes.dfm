object frmConsultaComprobantes: TfrmConsultaComprobantes
  ...
  object Label1: TLabel
    ...
    Width = 152
    Height = 13
    Caption = 'Tipos de Comprobante Contable'
  end
  ...
  object Gtipocomprobante: TDBGrid
    Left = 688
    Top = 0
    Width = 320
    Height = 177
  ...
  object DBCBtipocomprobante: TDBLookupComboBox
    Left = 168
    Top = 5
    Width = 257
    Height = 21
  ...
  object IBQcomprobante: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = dmGeneral.IBTransaction1
    AfterScroll = IBQcomprobanteAfterScroll
    SQL.Strings = (
      
        'SELECT * FROM con$comprobante  WHERE TIPO_COMPROBANTE = :TIPO_CO' +
        'MPROBANTE and FECHADIA BETWEEN :FECHA_INICIAL AND :FECHA_FINAL'
      'ORDER BY FECHADIA, ID_COMPROBANTE ASC')
    Left = 504
    Top = 68
    ParamData = <
      item
    ...
    object IBQcomprobanteID_AGENCIA: TSmallintField
      FieldName = 'ID_AGENCIA'
      Origin = '"con$comprobante"."ID_AGENCIA"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object IBQcomprobanteTIPO_COMPROBANTE: TIBStringField
      FieldName = 'TIPO_COMPROBANTE'
      Origin = '"con$comprobante"."TIPO_COMPROBANTE"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      FixedChar = True
      Size = 2
    ...
    object IBQcomprobanteDESCRIPCION: TMemoField
      ...
      OnGetText = IBQcomprobanteDESCRIPCIONGetText
      BlobType = ftMemo
      Size = 8
    end
    ...
    object IBQcomprobanteID_EMPLEADO: TIBStringField
      FieldName = 'ID_EMPLEADO'
      Origin = '"con$comprobante"."ID_EMPLEADO"'
      Size = 50
    end
  end
  object IBAuxiliar: TIBQuery
    ...
    SQL.Strings = (
      ...
      '         "gen$persona".NOMBRE AS NOMBRE1,'
        ...
        '         "gen$persona".NOMBRE || '#39' '#39' || "gen$persona".PRIMER_APE' +
        'LLIDO || '#39' '#39' || "gen$persona".SEGUNDO_APELLIDO AS ASOCIADO,'
      '         con$auxiliar.DEBITO,'
      ...
      'con$comprobante'
        ...
        'auxiliar.ID_COMPROBANTE and con$comprobante.TIPO_COMPROBANTE = c' +
        'on$auxiliar.TIPO_COMPROBANTE and con$comprobante.ID_AGENCIA = co' +
        'n$auxiliar.ID_AGENCIA)'
      ...
      'LEFT JOIN con$puc ON (con$auxiliar.CODIGO = con$puc.CODIGO)'
        ...
        'LEFT JOIN "gen$persona" ON (con$auxiliar.ID_IDENTIFICACION = "ge' +
        'n$persona".ID_IDENTIFICACION and con$auxiliar.ID_PERSONA = "gen$' +
        'persona".ID_PERSONA )'
      
        'where            (con$comprobante.ID_COMPROBANTE = :"ID_COMPROBA' +
        'NTE" ) and (con$comprobante.TIPO_COMPROBANTE = :"TIPO_COMPROBANT' +
        'E")'
    ...
    object IBAuxiliarASOCIADO: TIBStringField
      FieldName = 'ASOCIADO'
      ProviderFlags = []
      Size = 317
    end
  ...
  object CDSauxiliar: TClientDataSet
    ...
    Left = 184
    Top = 344
    object CDSauxiliarID_COMPROBANTE: TIntegerField
      FieldName = 'ID_COMPROBANTE'
    end
    object CDSauxiliarDESCRIPCION_AGENCIA: TStringField
      FieldName = 'DESCRIPCION_AGENCIA'
      Size = 50
    end
    ...
    object CDSauxiliarFECHADIA: TDateField
      FieldName = 'FECHADIA'
      Required = True
    end
    object CDSauxiliarDESCRIPCION: TMemoField
      FieldName = 'DESCRIPCION'
      BlobType = ftMemo
      Size = 8
    end
    object CDSauxiliarPRIMER_APELLIDO: TStringField
      FieldName = 'PRIMER_APELLIDO'
      Size = 30
    end
    object CDSauxiliarSEGUNDO_APELLIDO: TStringField
      FieldName = 'SEGUNDO_APELLIDO'
      Size = 30
    end
    ...
    object CDSauxiliarCUENTA: TStringField
      FieldName = 'CUENTA'
      Size = 100
    end
    object CDSauxiliarID_CUENTA: TStringField
      FieldName = 'ID_CUENTA'
      FixedChar = True
      Size = 7
    end
    object CDSauxiliarID_COLOCACION: TStringField
      FieldName = 'ID_COLOCACION'
      FixedChar = True
      Size = 11
    end
    object CDSauxiliarID_IDENTIFICACION: TSmallintField
      FieldName = 'ID_IDENTIFICACION'
    end
    object CDSauxiliarID_PERSONA: TStringField
      FieldName = 'ID_PERSONA'
      Size = 15
    end
    object CDSauxiliarPRIMER_APELLIDO1: TStringField
      FieldName = 'PRIMER_APELLIDO1'
      Size = 30
    end
    object CDSauxiliarSEGUNDO_APELLIDO1: TStringField
      FieldName = 'SEGUNDO_APELLIDO1'
      Size = 30
    end
    object CDSauxiliarNOMBRE1: TStringField
      FieldName = 'NOMBRE1'
      Size = 255
    end
    object CDSauxiliarDEBITO: TBCDField
      FieldName = 'DEBITO'
      Precision = 18
      Size = 3
    end
    object CDSauxiliarCREDITO: TBCDField
      FieldName = 'CREDITO'
      Precision = 18
      Size = 3
    end
    object CDSauxiliarASOCIADO: TStringField
      FieldName = 'ASOCIADO'
      Size = 317
    end
  end
