object frmEquivalencias: TfrmEquivalencias
  ...
  object IBQparalelo: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = dmGeneral.IBTransaction1
    AfterScroll = IBQparaleloAfterScroll
    SQL.Strings = (
  ...
  object CDSparalelo: TClientDataSet
    Active = True
    Aggregates = <>
    Params = <>
    Left = 96
    Top = 472
    Data = {
      
      000100000000000000}
    object CDSparaleloCOLGAAP: TStringField
      FieldName = 'COLGAAP'
      Size = 18
    end
    object CDSparaleloCUENTA_COLGAAP: TStringField
      FieldName = 'CUENTA_COLGAAP'
      Size = 500
    end
    object CDSparaleloNIIF: TStringField
      FieldName = 'NIIF'
      Size = 18
    end
    object CDSparaleloCUENTA_NIIF: TStringField
      FieldName = 'CUENTA_NIIF'
      Size = 500
    end
    object CDSparaleloPORCENTAJE: TIntegerField
      FieldName = 'PORCENTAJE'
    end
  end
