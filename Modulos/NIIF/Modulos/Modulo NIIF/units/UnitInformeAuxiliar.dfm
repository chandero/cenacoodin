object frmInformeAuxiliares: TfrmInformeAuxiliares
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
      ...
      'from CON$AUXILIAR'
        ...
        'LEFT JOIN CON$COMPROBANTE ON (CON$AUXILIAR.ID_COMPROBANTE = CON$' +
        'COMPROBANTE.ID_COMPROBANTE and CON$AUXILIAR.TIPO_COMPROBANTE = C' +
        'ON$COMPROBATE.TIPO_COMPROBANTE)'
      'LEFT JOIN CON$PUC ON (CON$AUXILIAR.CODIGO = CON$PUC.CODIGO)'
      
        'LEFT JOIN "gen$agencia" ON (CON$AUXILIAR.ID_AGENCIA = "gen$agenc' +
        'ia".ID_AGENCIA)'
      
        'LEFT JOIN "gen$persona" ON (CON$AUXILIAR.ID_PERSONA = "gen$perso' +
        'na".ID_PERSONA)'
      
        'LEFT JOIN CON$TIPO_COMPROBANTE t ON t.TIPO_COMPROBANTE = CON$AUX' +
        'ILIAR.TIPO_COMPROBANTE '
      'where'
      
        '(CON$AUXILIAR.FECHA >= :"FECHA_INICIAL" and CON$AUXILIAR.FECHA <' +
        '= :"FECHA_FINAL") and'
      
        '(CON$AUXILIAR.CODIGO >= :"CODIGO_INICIAL" and CON$AUXILIAR.CODIG' +
        'O <= :"CODIGO_FINAL") and'
      '(CON$AUXILIAR.ESTADOAUX = '#39'C'#39')'
      
        'order by CON$AUXILIAR.CODIGO, CON$AUXILIAR.FECHA, CON$AUXILIAR.I' +
        'D_COMPROBANTE, CON$AUXILIAR.CREDITO')
    Left = 12
    Top = 190
    ParamData = <
      item
    ...
    object IBQuery1ABREVIATURA: TStringField
    ...
    object IBQuery1DETALLECOMP: TMemoField
      FieldName = 'DETALLECOMP'
      Origin = '"con$comprobante"."DESCRIPCION"'
  ...
  object ReporteAuxiliarGrafico: TprReport
    ShowProgress = True
    FromPage = 1
    ToPage = 1
    Title = 'Liquidaci'#243'n'
