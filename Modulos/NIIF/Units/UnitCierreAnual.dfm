object frmcierreanual: Tfrmcierreanual
  ...
  object Panel3: TPanel
    ...
    object EdFecha: TDateTimePicker
      ...
      Date = 38741.6717641319
      Time = 38741.6717641319
      DateFormat = dfShort
      DateMode = dmComboBox
      Kind = dtkDate
      ParseInput = False
  ...
  object Panel4: TPanel
    ...
    object Label7: TLabel
      ...
      Width = 114
      Height = 13
      Caption = 'Nota Contable N'#250'mero: '
    end
    object EdNota: TStaticText
      Left = 122
      Top = 1
      Width = 63
      Height = 19
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
      ...
      'p.NOMBRE,'
      'p.SALDOINICIAL,'
      'g.DESCRIPCION_AGENCIA,'
      'n.NOMBRE,'
      'n.PRIMER_APELLIDO,'
      'n.SEGUNDO_APELLIDO'
      'from "CON$AUXILIAR" a'
      
        'LEFT JOIN "CON$COMPROBANTE" c ON (a.ID_COMPROBANTE = c.ID_COMPRO' +
        'BANTE)'
      'LEFT JOIN "CON$PUC" p ON (a.CODIGO = p.CODIGO)'
      'LEFT JOIN "gen$agencia"  g ON (a.ID_AGENCIA = g.ID_AGENCIA)'
      'LEFT JOIN "gen$persona" n ON (a.ID_PERSONA = n.ID_PERSONA)'
      'where'
      '(a.FECHA >= :"FECHA_INICIAL" and a.FECHA <= :"FECHA_FINAL") and'
      
        '(a.CODIGO >= :"CODIGO_INICIAL" and a.CODIGO <= :"CODIGO_FINAL") ' +
        'and'
      '(a.ESTADOAUX = '#39'C'#39')'
      'order by a.CODIGO, a.FECHA, a.ID_COMPROBANTE, a.CREDITO')
    Left = 9
    Top = 85
    ParamData = <
      item
  ...
  object IBpuc: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  "CON$PUC"'
      'WHERE'
      '  ("CON$PUC".MOVIMIENTO = 1) AND '
      '  ("CON$PUC".CODIGO BETWEEN :COD_INICIAL AND :COD_FINAL) AND'
  ...
  object IBSaldo: TIBQuery
    ...
    Transaction = dmGeneral.IBTransaction1
    SQL.Strings = (
      'select sum(DEBITO-CREDITO) AS SALDO from "CON$SALDOSCUENTA"'
  ...
  object CDsaldos: TClientDataSet
    ...
    Top = 105
    Data = {
      
      000000010007535542545950450200490006004D6F6E6579000000}
    object CDsaldoscodigo: TStringField
      FieldName = 'codigo'
      Size = 18
    end
    object CDsaldosnombre: TStringField
      FieldName = 'nombre'
      Size = 100
    end
    object CDsaldosdebito: TCurrencyField
      FieldName = 'debito'
    end
    object CDsaldoscredito: TCurrencyField
      FieldName = 'credito'
    end
  end
  ...
  object report10: TprTxReport
    ...
    object prTxPage1: TprTxPage
      ...
      object prTxHDetailHeaderBand1: TprTxHDetailHeaderBand
        Height = 7
        UseVerticalBands = False
        DetailBand = report10.prTxHDetailBand1
        ColCount = 1
        ColDirection = prcdTopBottomLeftRight
        ReprintOnEachPage = True
        LinkToDetail = True
        ...
        object prTxMemoObj12: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                ' Tipo Comprobante: NOTA CONTABLE')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
