object frmInformeCarteraPrivilegiados: TfrmInformeCarteraPrivilegiados
  ...
  object InformeDiario: TprTxReport
    ...
    Values = <
      ...
      item
        Group = InformeDiario.Privilegiado
        Name = 'TNoPriv'
        AggFunction = prafCount
        Formula = 'IBQuery2.ID_COLOCACION'
        ResetOn = rvtGroup
        ...
        object prTxMemoObj32: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'INFORME CARTERA DE PRIVILEGIADOS')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
    ...
    object Privilegiado: TprGroup
      Valid = 'IBQuery2.ID_PERSONA_PRIV'
      DetailBand = InformeDiario.prTxHDetailBand1
    end
  end
  object IBQuery2: TClientDataSet
    ...
    Left = 224
    Data = {
      940100009619E0BD01000000180000000D00000000000300000094010A49445F
      ...
      0100490000000100055749445448020002001E000D434C415349464943414349
      4F4E0100490000000100055749445448020002001E000000}
    ...
    object IBQuery2CLASIFICACION: TStringField
  ...
  object IBPrivilegiado: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select "gen$persona".NOMBRE || '#39' '#39' || "gen$persona".PRIMER_APELL' +
        'IDO || '#39' '#39' || "gen$persona".SEGUNDO_APELLIDO as ASOCIADO, "gen$p' +
        'rivilegiados".ID_IDENTIFICACION_PRIV,"gen$privilegiados".ID_PERS' +
        'ONA_PRIV from "gen$privilegiados"'
  ...
  object IBSQL1: TIBSQL
    ...
    SQL.Strings = (
        ...
        '          SELECT "col$colocacion".ID_AGENCIA, "col$colocacion".I' +
        'D_COLOCACION,'
      ...
      '          FROM "gen$privilegiados"'
      
        '          INNER JOIN "gen$persona" ON ("gen$privilegiados".ID_ID' +
        'ENTIFICACION_PRIV = "gen$persona".ID_IDENTIFICACION)'
      
        '          AND ("gen$privilegiados".ID_PERSONA_PRIV="gen$persona"' +
        '.ID_PERSONA)'
      
        '          RIGHT JOIN "col$colocacion" ON ("gen$privilegiados".ID' +
        '_IDENTIFICACION_PRIV="col$colocacion".ID_IDENTIFICACION)'
      
        '          AND ("gen$privilegiados".ID_PERSONA_PRIV="col$colocaci' +
        'on".ID_PERSONA)'
      
        '          LEFT JOIN "col$estado" ON ("col$colocacion".ID_ESTADO_' +
        'COLOCACION = "col$estado".ID_ESTADO_COLOCACION)'
      
        '          LEFT JOIN "col$clasificacion" ON ("col$colocacion".ID_' +
        'CLASIFICACION = "col$clasificacion".ID_CLASIFICACION)'
      
        '           WHERE ("col$colocacion".ID_ESTADO_COLOCACION <= 3) AN' +
        'D'
      
        '          ("col$colocacion".ID_IDENTIFICACION = :ID_IDENTIFICACI' +
        'ON_PRIV AND'
      '          "col$colocacion".ID_PERSONA = :ID_PERSONA_PRIV)')
    Transaction = dmGeneral.IBTransaction1
    Left = 56
  end
  object IBSQL2: TIBSQL
    ...
    SQL.Strings = (
      ...
      '  AND ("col$colocacion".ID_PERSONA="gen$persona".ID_PERSONA)'
        ...
        ' INNER JOIN "col$clasificacion" ON ("col$colocacion".ID_CLASIFIC' +
        'ACION = "col$clasificacion".ID_CLASIFICACION)'
      'WHERE'
