object frmCausacionCarteraDiaria: TfrmCausacionCarteraDiaria
        ...
        object prTxMemoObj24: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<#,#0>IBQuery1.DEUDA - IBQuery1.GARANTIA_DESCONTADA]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
  ...
  object IBQReal: TIBQuery
    ...
    SQL.Strings = (
      ...
      'FROM  "col$datogarantia"'
      'WHERE "col$datogarantia".ESTADO = 0 AND CUENTAS_DE_ORDEN > 0'
      'ORDER BY MATRICULA ASC')
    Left = 352
  end
  object DPReal: TDataSetProvider
    DataSet = IBQReal
    Constraints = True
    Left = 328
  end
  ...
  object IBActualizaGarReal: TIBSQL
    Database = dmGeneral.IBDatabase1
  ...
  object IBSQL11: TIBSQL
    Database = dmGeneral.IBDatabase1
    Transaction = IBTAdicional
    Left = 504
    Top = 184
  end
  object IBQRealAct: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = dmGeneral.IBTransaction1
    Left = 376
  end
