object frmPlanillaResumen: TfrmPlanillaResumen
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  CON$COMPROBANTE'
        ...
        '  INNER JOIN CON$AUXILIAR ON (CON$COMPROBANTE.ID_COMPROBANTE = C' +
        'ON$AUXILIAR.ID_COMPROBANTE) AND (CON$COMPROBANTE.ID_AGENCIA = CO' +
        'N$AUXILIAR.ID_AGENCIA) AND (CON$COMPROBANTE.TIPO_COMPROBANTE = C' +
        'ON$AUXILIAR.TIPO_COMPROBANTE)'
      
        '  LEFT JOIN CON$PUC ON (CON$AUXILIAR.CODIGO = CON$PUC.CODIGO) AN' +
        'D (CON$AUXILIAR.ID_AGENCIA = CON$PUC.ID_AGENCIA)'
  ...
  object IBQuery2: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select CON$PLANILLARESUMEN.CODIGO, CON$PUC.NOMBRE, CON$PLANILLAR' +
        'ESUMEN.DEBITO, CON$PLANILLARESUMEN.CREDITO from CON$PLANILLARESU' +
        'MEN LEFT JOIN CON$PUC ON (CON$PLANILLARESUMEN.CODIGO = CON$PUC.C' +
        'ODIGO)'
      'ORDER BY'
