object frmLibroRCajaDiario: TfrmLibroRCajaDiario
  Left = 299
  Top = 296
  Width = 352
  Height = 114
  Caption = 'Libro Registrado Caja Diario'
  Color = clBtnFace
  ...
  object IBQTemp: TIBQuery
    ...
    SQL.Strings = (
        ...
        '(a.DEBITO) AS DEBITO, SUM(a.CREDITO) AS CREDITO FROM CON$COMPROB' +
        'ANTE c'
      
        'INNER JOIN CON$AUXILIAR a ON a.ID_AGENCIA = c.ID_AGENCIA and a.T' +
        'IPO_COMPROBANTE = c.TIPO_COMPROBANTE and a.ID_COMPROBANTE = c.ID' +
        '_COMPROBANTE'
      'INNER JOIN CON$PUC p ON a.CODIGO = p.CODIGO'
      'WHERE'
      'EXTRACT(MONTH FROM c.FECHADIA) = :MES and c.ESTADO <> '#39'N'#39
  ...
  object IBQTemp1: TIBQuery
    ...
    SQL.Strings = (
        ...
        'O) AS CREDITO FROM CON$COMPROBANTE c'
      
        'INNER JOIN CON$AUXILIAR a ON a.ID_AGENCIA = c.ID_AGENCIA and a.T' +
        'IPO_COMPROBANTE = c.TIPO_COMPROBANTE and a.ID_COMPROBANTE = c.ID' +
        '_COMPROBANTE'
      'INNER JOIN CON$PUC p ON a.CODIGO = p.CODIGO'
      'WHERE EXTRACT(MONTH FROM c.FECHADIA) = :MES and c.ESTADO <> '#39'N'#39
  ...
  object CDSdata: TClientDataSet
    ...
    Top = 24
    Data = {
      
      6F6E6579000000}
    object CDSdataDIA: TIntegerField
      FieldName = 'DIA'
    end
  ...
  object CDSdata1: TClientDataSet
    ...
    Top = 24
    Data = {
      
      000000010007535542545950450200490006004D6F6E6579000000}
    object CDSdata1CODIGO: TStringField
      FieldName = 'CODIGO'
      Size = 4
    end
    object CDSdata1NOMBRE: TStringField
      FieldName = 'NOMBRE'
      Size = 200
    end
    object CDSdata1DEBITO: TCurrencyField
      FieldName = 'DEBITO'
    end
    object CDSdata1CREDITO: TCurrencyField
      FieldName = 'CREDITO'
    end
  end
