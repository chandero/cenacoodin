object FrmDesembolso: TFrmDesembolso
  ...
  object GroupBox2: TGroupBox
    ...
    object EdFechaDesembolso: TDateTimePicker
      ...
      TabOrder = 6
      TabStop = False
      OnChange = EdFechaDesembolsoChange
    ...
    object EdValorAporte: TJvCurrencyEdit
      Left = 489
      Top = 95
      Width = 80
      Height = 21
    ...
    object EdValorAsobancaria: TJvCurrencyEdit
      ...
      ReadOnly = False
      TabOrder = 20
      OnKeyPress = EdValorAsobancariaKeyPress
      HasMaxValue = False
      HasMinValue = False
    end
  end
  ...
  object Grupoinformacion: TGroupBox
    ...
    ParentFont = False
    TabOrder = 5
    object DBOtrosDescuentos: TDBGrid
      Left = 14
      Top = 23
      Width = 632
      Height = 153
      DataSource = DSOtrosDescuentos
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
  ...
  object JvGroupBox3: TJvGroupBox
    ...
    object btnOtrosDescuentos: TBitBtn
      Left = 95
      Top = 15
      Width = 85
      Height = 25
      ...
      ParentFont = False
      TabOrder = 2
      OnClick = btnOtrosDescuentosClick
      Glyph.Data = {
        36030000424D3603000000000000360000002800000010000000100000000100
        18000000000000030000130B0000130B00000000000000000000FF00FFFF00FF
        FF00FFFF00FF4A49494A49494A49494A49494A49494A49494A49494A4949FF00
  ...
  object GroupBox3: TGroupBox
    ...
    ParentFont = False
    TabOrder = 8
    object cbFormaDesembolso: TComboBox
      Left = 8
      Top = 11
      Width = 145
      Height = 21
      ...
      TabOrder = 0
      Text = 'EFECTIVO'
      OnChange = cbFormaDesembolsoChange
      Items.Strings = (
        'EFECTIVO'
        'RETIRO EN EFECTIVO'
        'CHEQUE')
    end
    object panelBancoDesembolso: TPanel
      Left = 160
      Top = 8
      Width = 489
      Height = 26
      ...
      object lstBancos: TDBLookupComboBox
        Left = 47
        Top = 3
        Width = 192
        Height = 21
  ...
  object CDliquidacion: TClientDataSet
    ...
    Left = 800
    Data = {
      080100009619E0BD01000000180000000700000000000300000008010C43554F
      ...
      
      490006004D6F6E6579000000}
    object CDliquidacionCUOTA_NUMERO: TIntegerField
      FieldName = 'CUOTA_NUMERO'
    end
    object CDliquidacionFECHA_A_PAGAR: TDateField
      FieldName = 'FECHA_A_PAGAR'
    end
    object CDliquidacionCAPITAL_A_PAGAR: TCurrencyField
      FieldName = 'CAPITAL_A_PAGAR'
    end
    object CDliquidacionINTERES_A_PAGAR: TCurrencyField
      FieldName = 'INTERES_A_PAGAR'
    end
  ...
  object IBQDescuento: TIBQuery
    ...
    SQL.Strings = (
      'SELECT '
      '"col$solicituddescuento".ID_DESCUENTO, '
      '"col$descuentos".DESCRIPCION_DESCUENTO '
      'FROM "col$solicituddescuento" '
      
        'INNER JOIN "col$descuentos" on ("col$solicituddescuento".ID_DESC' +
        'UENTO = "col$descuentos".ID_DESCUENTO) '
      ' WHERE ID_SOLICITUD = :ID_SOLICITUD and ID_AGENCIA = :ID_AGENCIA')
    Left = 120
    Top = 368
    ParamData = <
      item
  ...
  object DSOtrosDescuentos: TDataSource
