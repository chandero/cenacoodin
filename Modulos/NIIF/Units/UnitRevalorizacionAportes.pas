...
uses
  ...
  IBCustomDataSet, IBQuery, JvTypedEdit, DBClient, Provider, ComCtrls, UnitDmGeneral,
...
uses unitGlobales, UnitPantallaProgreso, UnitVistaPreliminar;
...
begin
        ...
        begin
          ...
          Close;
          SQL.Clear;
          SQL.Add('select FIRST 1 ANO from "cap$revalorizaciontmp"');
          try
           ExecQuery;
