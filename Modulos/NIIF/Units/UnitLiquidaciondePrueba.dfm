object frmLiquidaciondePrueba: TfrmLiquidaciondePrueba
  Left = 381
  Top = 185
  Width = 447
  Height = 314
  ...
  object IBQueryTabla: TIBQuery
    SQL.Strings = (
      'select * from "col$tablaliquidaciontmp"')
    Left = 400
    Top = 64
  end
  ...
  object CDSADescontar: TClientDataSet
    ...
    Data = {
      ...
      0557494454480200020012000C43554F54415F4E554D45524F04000100000000
  ...
  object CDSCuotas: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DSPCuotas'
    Left = 272
    Top = 184
  end
  object DSPCuotas: TDataSetProvider
    DataSet = IBQueryTabla
    Constraints = True
    Left = 344
    Top = 176
  end
