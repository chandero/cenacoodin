...
// Componer Mensaje
       ...
       //Encryptar el archivo, Se debe encryptar con las Tres llaves Generadas
       _sProceso := 'encrypt.bat ' + _sRutasalPGP + ' ' + FFF+'.Zip ' + _sLlavesPGP1 + ' ' + _sLlavesPGP2  + ' ' + _sLlavesPGP3;
       ExecProceso(_sProceso);
       Sleep(3000);
       //
       TIdAttachment.Create(Msg.MessageParts, 'C:\Tdebito\Salida\'+FFF+'.Zip.pgp');
//       TIdAttachment.Create(Msg.MessageParts, 'C:\24013012010.Zip');
//
