...
procedure TfrmConsultaProductos.FormClose(Sender: TObject;
...
begin
        ...
        begin
          ...
          JVfechaCre.Caption := DateToStr(FieldByName('FECHAHORA').AsDateTime);
          Close;
          SQL.Clear;
          SQL.Add('SELECT ');
          SQL.Add('"gen$empleado".NOMBRE,');
          ...
          JVfechaAna.Caption := DateToStr(FieldByName('FECHAHORA').AsDateTime);
          Close;
        end;
end;
