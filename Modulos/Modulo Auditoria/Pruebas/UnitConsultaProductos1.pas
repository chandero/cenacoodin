...
type
  TfrmConsultaProductos1 = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    PanelTree: TPanel;
  ...
  private
    ...
    procedure BuscarDatosSolicitud(vId_Solicitud: string);
...
var
  frmConsultaProductos1: TfrmConsultaProductos1;
...
uses unitdmGeneral,unitGlobales,
     ...
     unitObservacionesCambioEstado, UnitControlDeObservaciones;

procedure TfrmConsultaProductos1.FormShow(Sender: TObject);
begin
        AbrirIniciales;
end;

procedure TfrmConsultaProductos1.AbrirIniciales;
var I :Integer;
begin
        if IBDSTiposId.Transaction.InTransaction then
           IBDSTiposId.Transaction.Commit;
...
procedure TfrmConsultaProductos1.EdCaptacionKeyPress(Sender: TObject;
  var Key: Char);
begin
        NumericoSinPunto(Sender,Key);
end;

procedure TfrmConsultaProductos1.EdColocacionKeyPress(Sender: TObject;
  var Key: Char);
begin
        NumericoSinPunto(Sender,Key);
end;

procedure TfrmConsultaProductos1.EdNumeroIdentificacionKeyPress(
  Sender: TObject; var Key: Char);
begin
//        NumericoSinPunto(Sender,Key);
end;

procedure TfrmConsultaProductos1.CmdOtroClick(Sender: TObject);
begin
        AbrirIniciales;
end;

procedure TfrmConsultaProductos1.Tab1Show(Sender: TObject);
begin
        CBtiposid.SetFocus;
end;

procedure TfrmConsultaProductos1.Tab2Show(Sender: TObject);
begin
        CBTiposCaptacion.SetFocus;
end;

procedure TfrmConsultaProductos1.Tab3Show(Sender: TObject);
begin
        EdColocacion.SetFocus;
end;

procedure TfrmConsultaProductos1.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TfrmConsultaProductos1.CmdActualizar1Click(Sender: TObject);
begin
        PageBuscar.ActivePage := Tab1;
...
procedure TfrmConsultaProductos1.BuscarProductos;
begin
...
//Buscar Observaciones
        ...
        agregarsolicitudes;
        if (Agencia = 1) and (Role = 'CAPTACIONES') then
           BuscaCredivida;
        Arbol.Enabled := True;
...
procedure TfrmConsultaProductos1.AgregarCaptaciones;
begin
...
procedure TfrmConsultaProductos1.AgregarColocaciones;
...
procedure TfrmConsultaProductos1.AgregarFianzas;
var Descripcion:string;
begin
        with IBConsulta do
        begin
...
procedure TfrmConsultaProductos1.AgregarObservaciones;
begin
        with IBConsulta do
        begin
             Close;
...
procedure TfrmConsultaProductos1.FormCreate(Sender: TObject);
begin
...
procedure TfrmConsultaProductos1.CmdBuscarClick(Sender: TObject);
...
procedure TfrmConsultaProductos1.ArbolChange(Sender: TObject;
  Node: TTreeNode);
begin
        ...
        begin
           case TProductos(Node.Data).forma of
               ...
               8: begin
                    BuscarDatosSolicitud(TProductos(Node.Data).nombre);
...
procedure TfrmConsultaProductos1.BuscarDatosAportes(tipo:Integer;agencia:Integer;cuenta:string);
var digito:string;
    tmp:Integer;
    Inicial:Currency;
    Actual:Currency;
...
procedure TfrmConsultaProductos1.BuscarDatosAhorro(tipo:Integer;agencia: integer;
  cuenta: string);
var digito:string;
    tmp:Integer;
    Inicial:Currency;
...
procedure TfrmConsultaProductos1.BuscarDatosAhorroC(tipo:Integer;agencia: integer;
  cuenta: string);
var digito:string;
    tmp,tmp1:Integer;
    Inicial:Currency;
...
procedure TfrmConsultaProductos1.BuscarDatosCertificados(tipo:Integer;agencia: integer; cuenta: string);
var digito:string;
    tmp:Integer;
    Inicial:Currency;
    Actual:Currency;
...
procedure TfrmConsultaProductos1.BuscarDatosColocacion(agencia: integer;
  cuenta: string);
var tmp:Integer;
    tmp1:string;
    Fecha:TDate;
...
procedure TfrmConsultaProductos1.BuscarDatosFianzas(agencia: integer;
  cuenta: string);
var tmp:Integer;
    tmp1:string;
    Fecha:TDate;
...
procedure TfrmConsultaProductos1.CmdActualizar2Click(Sender: TObject);
begin
        with IBSQL do
        begin
            Close;
...
procedure TfrmConsultaProductos1.EdCaptacionExit(Sender: TObject);
begin
        EdCaptacion.Text := FormatCurr('0000000',StrToFloat(EdCaptacion.Text));
end;

procedure TfrmConsultaProductos1.CmdActualizar3Click(Sender: TObject);
begin
        with IBSQL do
        begin
            Close;
...
procedure TfrmConsultaProductos1.BuscarDatosObservaciones;
begin
        with IBObservaciones do
        begin
                Close;
...
function TfrmConsultaProductos1.TotalAportaciones(Id: Integer;Documento: string): Currency;
...
begin
           ...
           with IBSQL1 do begin
                ...
                SQL.Add('Order by "cap$maestrotitular".ID_AGENCIA,"cap$maestrotitular".ID_TIPO_CAPTACION,"cap$maestro".ID_ESTADO,"cap$maestrotitular".NUMERO_CUENTA,"cap$maestrotitular".DIGITO_CUENTA');
               ...
               while not Eof do begin
                ...
                IBSQL2.Close;
                IBSQL2.SQL.Clear;
                IBSQL2.SQL.Add('Select "cap$maestro".ID_ESTADO, "cap$tiposestado".DESCRIPCION from "cap$maestro"');
...
function TfrmConsultaProductos1.TotalCaptaciones(Id: integer;
...
begin
           ...
           with IBSQL1 do begin
               ...
               while not Eof do begin
                ...
                IBSQL2.Close;
                IBSQL2.SQL.Clear;
                IBSQL2.SQL.Add('Select "cap$maestro".ID_ESTADO,"cap$maestro".VALOR_INICIAL, "cap$tiposestado".DESCRIPCION, "cap$tiposestado".SE_SUMA, "cap$maestro".FIRMAS from "cap$maestro"');
...
function TfrmConsultaProductos1.TotalColocaciones(Id: Integer;
  Documento: String): Currency;
var Saldo:Currency;
...
begin
        with IBSQL1 do begin
          ...
          SQL.Add('"col$colocacion".ID_ESTADO_COLOCACION <> 4 and "col$colocacion".ID_ESTADO_COLOCACION <> 5');
          SQL.Add('Order by "col$colocacion".ID_AGENCIA, "col$colocacion".ID_ESTADO_COLOCACION, "col$colocacion".ID_COLOCACION');
          ParamByName('ID_IDENTIFICACION').AsInteger := Id;
          ParamByName('ID_PERSONA').AsString := Documento;
          try
            ExecQuery;
            if RecordCount > 0 then
             while not Eof do begin
               ...
               if (obtenerdeudahoy1(Agencia,FieldByName('ID_COLOCACION').AsString,IBDeudaHoy).Dias > 0) and (FieldByName('ID_ESTADO_COLOCACION').AsInteger = 0) then
               begin
                 Vcapital := 0;
                 Deuda := 0;
               ...
               if IBSQL2.FieldByName('VCOSTAS').AsCurrency <> 0 then
                  GridRColocaciones.Cells[6, GridRColocaciones.RowCount-1] := FormatCurr('$#,#0',Deuda);
               Next;
             end;
          except
...
function TfrmConsultaProductos1.TotalFianzas(Id: Integer;
  Documento: String): Currency;
var Saldo:Currency;
begin
        with IBSQL1 do begin
...
procedure TfrmConsultaProductos1.IBTablaLiquidacionColocacionPAGADAGetText(
...
procedure TfrmConsultaProductos1.CmdCerrarClick(Sender: TObject);
begin
        Close;
end;

procedure TfrmConsultaProductos1.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
        dmColocacion.Free;
end;

procedure TfrmConsultaProductos1.ConsultadeExtracto1Click(Sender: TObject);
...
procedure TfrmConsultaProductos1.GridRCaptacionesSelectCell(Sender: TObject;
  ACol, ARow: Integer; var CanSelect: Boolean);
begin
        FilaCap := ARow;
end;

procedure TfrmConsultaProductos1.CambiosdeEstado1Click(Sender: TObject);
...
procedure TfrmConsultaProductos1.DBImage1KeyDown(Sender: TObject;
...
procedure TfrmConsultaProductos1.DBImage3KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
        if ssCtrl in Shift then begin
          MessageDlg('No puede realizar procesos de copiar o cortar',mtError,[mbcancel],0);
...
procedure TfrmConsultaProductos1.GridRCaptacionesDrawCell(Sender: TObject;
...
begin
        ...
        with GridRCaptaciones do begin
           ...
           if GridRCaptaciones.Cells[4,ARow] = 'SALDADO' then
           begin
...
procedure TfrmConsultaProductos1.GridObservacionesDrawColumnCell(
...
procedure TfrmConsultaProductos1.IBObservacionesOBSERVACIONGetText(
  Sender: TField; var Text: String; DisplayText: Boolean);
begin
        Text := Sender.AsString;
end;

procedure TfrmConsultaProductos1.IBObservacionesID_EMPLEADOGetText(
  Sender: TField; var Text: String; DisplayText: Boolean);
begin
        with IBSQL1 do begin
          Close;
...
procedure TfrmConsultaProductos1.IBObservacionesAfterScroll(
  DataSet: TDataSet);
begin
        Memo.Text := DataSet.FieldByName('OBSERVACION').AsString;
end;

procedure TfrmConsultaProductos1.IraObservaciones1Click(Sender: TObject);
...
procedure TfrmConsultaProductos1.IBObservacionesSEMAFOROGetText(
  Sender: TField; var Text: String; DisplayText: Boolean);
begin
        Text := '';
end;

procedure TfrmConsultaProductos1.AgregarSolicitudes;
begin
       with IBConsulta do
       begin
             Close;
             ...
             SQL.Add('("col$solicitud".ESTADO IN (1,2,3,4,8,11,12,13))');
             ParamByName('ID_PERSONA').AsString := vidpersona;
             ParamByName('ID_IDENTIFICACION').AsInteger := vididentificacion;
             Open;
             ...
             begin
                arbolinfo := TProductos.Create;
                arbolinfo.forma := 8;
                arbolinfo.nombre := FieldByName('ID_SOLICITUD').AsString;
                arbolinfo.tipo := 0;
                arbolinfo.numero := '';
                arbolinfo.agencia := Agencia;
                arbolinfo.digito := 0;
...
procedure TfrmConsultaProductos1.BuscarSolicitudes;
begin
...
procedure TfrmConsultaProductos1.ExtractodeColocacin1Click(Sender: TObject);
var
...
procedure TfrmConsultaProductos1.GridRColocacionesSelectCell(
  Sender: TObject; ACol, ARow: Integer; var CanSelect: Boolean);
begin
        FilaCol := ARow;
end;

procedure TfrmConsultaProductos1.GridRFianzasSelectCell(Sender: TObject;
  ACol, ARow: Integer; var CanSelect: Boolean);
begin
        FilaFia := ARow;
end;

procedure TfrmConsultaProductos1.MenuItem3Click(Sender: TObject);
var
  FrmExtractoColocacion : TFrmExtractoColocacion;
begin
      FrmExtractoColocacion := TFrmExtractoColocacion.Create(Self);
...
procedure TfrmConsultaProductos1.FormCloseQuery(Sender: TObject;
...
procedure TfrmConsultaProductos1.BuscaCredivida;
...
begin
        ...
        begin
          ...
          begin
            arbolinfo := TProductos.Create;
            arbolinfo.forma := 9;
            arbolinfo.nombre := 'CREDIVIDAS VIGENTES';
            arbolinfo.tipo := 0;
            arbolinfo.numero := '';
            arbolinfo.agencia := Agencia;
            arbolinfo.digito := 0;
...
procedure TfrmConsultaProductos1.AgregarTarjetaDebito;
begin
        with IBConsulta do
        begin
           SQL.Clear;
...
procedure TfrmConsultaProductos1.ExpandirTodo1Click(Sender: TObject);
begin
        Arbol.FullExpand;
end;

procedure TfrmConsultaProductos1.ContraerTodo1Click(Sender: TObject);
begin
        Arbol.FullCollapse;
end;

procedure TfrmConsultaProductos1.BuscarDatosTarjetaDebito(numero: string);
begin
        with IBConsulta do
        begin
           SQL.Clear;
...
procedure TfrmConsultaProductos1.splitterMouseMove(Sender: TObject;
...
procedure TfrmConsultaProductos1.BuscarDatosSolicitud(
  vId_Solicitud: string);
begin
        ...
        begin
          ...
          Open;
          JVempleadoRec.Caption := FieldByName('NOMBRE').AsString + ' ' + FieldByName('PRIMER_APELLIDO').AsString;
          JVfechaRec.Caption := FormatDateTime('yyyy/mm/dd',FieldByName('FECHA_RECEPCION').AsDateTime);
          ...
          SQL.Add('WHERE');
          SQL.Add('("col$solicitudempleado".ID_SOLICITUD = :ID_EMPLEADO)');
          ParamByName('ID_SOLICITUD').AsString := vId_Solicitud;
          Open;
          JVempleadoCre.Caption := FieldByName('NOMBRE').AsString + ' ' + FieldByName('PRIMER_APELLIDO').AsString;
          JVfechaCre.Caption := FormatCurr('yyyy/mm/dd',FieldByName('FECHAHORA').AsDateTime);
          Close;
          SQL.Clear;
          SQL.Add('SELECT ');
          SQL.Add('"gen$empleado".NOMBRE,');
          ...
          ParamByName('ID_SOLICITUD').AsString := vId_Solicitud;
          Open;
          JVempleadoAna.Caption := FieldByName('NOMBRE').AsString + ' ' + FieldByName('PRIMER_APELLIDO').AsString;
          JVfechaAna.Caption := FormatCurr('yyyy/mm/dd',FieldByName('FECHAHORA').AsDateTime);
          Close;
        end;
end;
