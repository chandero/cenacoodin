object FrmInformacion: TFrmInformacion
  ...
  Caption = 'Formulario de Solicitudes FUNDACION'
  Color = clBtnFace
  ...
  object CDinfCrediticia: TClientDataSet
    ...
    Top = 416
    Data = {
      850100009619E0BD01000000180000000C000000000003000000850107656E74
  ...
  object IBtipocuota: TIBQuery
    ...
    Transaction = IBTransaction1
    SQL.Strings = (
      'select * from "col$tiposcuota" where ID_TIPOS_CUOTA <> 3')
    Left = 680
    Top = 104
  end
  ...
  object CDcrediticiacod: TClientDataSet
    ...
    Top = 147
    Data = {
      790100009619E0BD01000000180000000C000000000003000000790107656E74
      ...
      00000000000D66656368615F696E746572657304000600000000000000}
