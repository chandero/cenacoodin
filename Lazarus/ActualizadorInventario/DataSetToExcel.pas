...
begin 
  ...
  try 
    ...
    for i := 0 to FDataSet.FieldCount - 1 do begin 
      ...
      if FDataSet.Fields[i].DataType = ftDateTime then inc(wWidth,2000); {FDataSet.FieldDefs[i].DataType}
      if FDataSet.Fields[i].DataType = ftDate then inc(wWidth,1050); {FDataSet.FieldDefs[i].DataType}
      if FDataSet.Fields[i].DataType = ftTime then inc(wWidth,100);  {FDataSet.FieldDefs[i].DataType}
