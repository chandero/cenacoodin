object frmConsultaExtractoCaptacion: TfrmConsultaExtractoCaptacion
  ...
  object Panel1: TPanel
    ...
    object JvDBGrid1: TJvDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'DESCRIPCION_MOVIMIENTO'
          Title.Alignment = taCenter
    ...
    object GroupBox1: TGroupBox
      ...
      Enabled = False
      TabOrder = 1
      object TipoInforme: TRadioGroup
        Left = 6
        Top = 46
        Width = 185
        Height = 29
        Hint = 'Seleccione el tipo de informe'
        Columns = 2
        ItemIndex = 0
        Items.Strings = (
          'Borrador'
      ...
      object TipoReporte: TRadioGroup
        Left = 6
        Top = 12
        Width = 185
        Height = 62
    ...
    object EdTotCheques: TStaticText
      Left = 116
      Top = 6
      Width = 41
      Height = 21
    ...
    object EdValorCheques: TStaticText
      Left = 164
      Top = 6
      Width = 180
      Height = 21
  ...
  object GridExtracto: TXStringGrid
    Left = 0
    Top = 89
    Width = 749
    Height = 278
  ...
  object Panel3: TPanel
    ...
    object ScrollBox1: TScrollBox
      ...
      object EdSaldoInicial: TStaticText
        Left = 97
        Top = -26
        Width = 117
        Height = 21
      ...
      object EdTotDebito: TStaticText
        Left = 97
        Top = -4
        Width = 117
        Height = 21
      ...
      object EdTotCredito: TStaticText
        Left = 97
        Top = 17
        Width = 117
        Height = 21
      ...
      object EdSaldoFinal: TStaticText
        Left = 97
        Top = 38
        Width = 117
        Height = 21
  ...
  object IBTiposCaptacion: TIBQuery
    ...
    SQL.Strings = (
        ...
        '.DESCRIPCION from "cap$tipocaptacion"')
    Left = 278
    Top = 10
  end
  ...
  object IBExtracto: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select ID_TIPO_MOVIMIENTO, DOCUMENTO_MOVIMIENTO, FECHA_MOVIMIENT' +
        'O, HORA_MOVIMIENTO, DESCRIPCION_MOVIMIENTO, VALOR_DEBITO, VALOR_' +
        'CREDITO from "cap$extracto" where (ID_AGENCIA = :"ID_AGENCIA" ) ' +
        'and (ID_TIPO_CAPTACION = :"ID_TIPO_CAPTACION" ) and (NUMERO_CUEN' +
        'TA = :"NUMERO_CUENTA") and (DIGITO_CUENTA = :"DIGITO_CUENTA") an' +
        'd (FECHA_MOVIMIENTO between :"FECHA1" and :"FECHA2") order by FE' +
        'CHA_MOVIMIENTO, HORA_MOVIMIENTO, VALOR_CREDITO')
    Left = 470
    Top = 200
    ParamData = <
      item
    ...
    object IBExtractoID_TIPO_MOVIMIENTO: TSmallintField
      FieldName = 'ID_TIPO_MOVIMIENTO'
      Origin = '"cap$extracto"."ID_TIPO_MOVIMIENTO"'
      ReadOnly = True
      Required = True
    end
    object IBExtractoDOCUMENTO_MOVIMIENTO: TIBStringField
      FieldName = 'DOCUMENTO_MOVIMIENTO'
      Origin = '"cap$extracto"."DOCUMENTO_MOVIMIENTO"'
      ReadOnly = True
      Required = True
      FixedChar = True
      Size = 8
    end
    object IBExtractoFECHA_MOVIMIENTO: TDateField
      FieldName = 'FECHA_MOVIMIENTO'
      Origin = '"cap$extracto"."FECHA_MOVIMIENTO"'
      ReadOnly = True
      Required = True
    end
    object IBExtractoHORA_MOVIMIENTO: TTimeField
      FieldName = 'HORA_MOVIMIENTO'
      Origin = '"cap$extracto"."HORA_MOVIMIENTO"'
      ReadOnly = True
      Required = True
    end
    object IBExtractoDESCRIPCION_MOVIMIENTO: TIBStringField
      FieldName = 'DESCRIPCION_MOVIMIENTO'
      Origin = '"cap$extracto"."DESCRIPCION_MOVIMIENTO"'
      ReadOnly = True
      Size = 50
    end
    object IBExtractoVALOR_DEBITO: TIBBCDField
      FieldName = 'VALOR_DEBITO'
      Origin = '"cap$extracto"."VALOR_DEBITO"'
      ReadOnly = True
      currency = True
      Precision = 18
      Size = 3
    end
    object IBExtractoVALOR_CREDITO: TIBBCDField
      FieldName = 'VALOR_CREDITO'
      Origin = '"cap$extracto"."VALOR_CREDITO"'
      ReadOnly = True
      currency = True
      Precision = 18
      Size = 3
  ...
  object DSTiposMovimiento: TDataSource
    AutoEdit = False
    DataSet = IBTiposMovimiento
    Left = 356
    Top = 322
  end
  object IBTiposMovimiento: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = IBTExtracto
    SQL.Strings = (
      
        'select ID_TIPO_MOVIMIENTO, DESCRIPCION_MOVIMIENTO from "cap$tipo' +
        'smovimiento" order by ID_TIPO_MOVIMIENTO')
    Left = 328
    Top = 322
    object IBTiposMovimientoID_TIPO_MOVIMIENTO: TSmallintField
      FieldName = 'ID_TIPO_MOVIMIENTO'
      Origin = '"cap$tiposmovimiento"."ID_TIPO_MOVIMIENTO"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object IBTiposMovimientoDESCRIPCION_MOVIMIENTO: TIBStringField
      FieldName = 'DESCRIPCION_MOVIMIENTO'
      Origin = '"cap$tiposmovimiento"."DESCRIPCION_MOVIMIENTO"'
      Size = 100
    end
  end
  object ReporteB: TprTxReport
    Title = 'Extracto de Captaci'#243'n'
    ExportFromPage = 0
    ExportToPage = 0
    Values = <
      item
        Name = 'TotalDebito'
        AggFunction = prafSum
        Formula = 'IBExtracto.VALOR_DEBITO'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'IBExtracto'
      end
      item
        Name = 'TotalCredito'
        AggFunction = prafSum
        Formula = 'IBExtracto.VALOR_CREDITO'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'IBExtracto'
      end
      item
        Name = 'Saldo'
        AggFunction = prafSum
        Formula = 'IBExtracto.VALOR_DEBITO - IBExtracto.VALOR_CREDITO'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'IBExtracto'
        Accumulate = True
    ...
    OnUnknownFunction = ReporteBUnknownFunction
    OnUnknownObjFunction = ReporteBUnknownObjFunction
    WrapAfterColumn = 0
    ...
    object prTxPage1: TprTxPage
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'PERIODO Desde el [:<yyyy/MM/dd>Fecha_Inicial] Hasta el [:<yyyy/M' +
                  'M/dd>Fecha_Final]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
      ...
      object prTxHDetailHeaderBand1: TprTxHDetailHeaderBand
        Height = 3
        UseVerticalBands = False
        DetailBand = ReporteB.prTxHDetailBand1
        ColCount = 1
        ...
        object prTxMemoObj41: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<yyyy/MM/dd>IBExtracto.FECHA_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj42: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<hh:mm>IBExtracto.HORA_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj43: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[IBExtracto.DOCUMENTO_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj44: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<000>IBExtracto.ID_TIPO_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj45: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[IBExtracto.DESCRIPCION_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj49: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<000>IBTiposMovimiento.ID_TIPO_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj50: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[IBTiposMovimiento.DESCRIPCION_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
      ...
      object prTxHDetailHeaderBand2: TprTxHDetailHeaderBand
        Height = 1
        UseVerticalBands = False
        DetailBand = ReporteB.prTxHDetailBand2
        ColCount = 2
        ColDirection = prcdTopBottomLeftRight
  ...
  object IBmaestrotitular: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = IBTExtracto
    SQL.Strings = (
      'select * from "cap$maestrotitular"')
    Left = 498
    Top = 112
  end
  object IBPersonas: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = IBTExtracto
    SQL.Strings = (
  ...
  object ReporteBr: TprTxReport
    ...
    Values = <
      item
        Name = 'TotalDebito'
        AggFunction = prafSum
        Formula = 'IBExtracto1.VALOR_DEBITO'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'IBExtracto1'
      end
      item
        Name = 'TotalCredito'
        AggFunction = prafSum
        Formula = 'IBExtracto1.VALOR_CREDITO'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'IBExtracto1'
      end
      item
        Name = 'Saldo'
        AggFunction = prafSum
        Formula = 'IBExtracto1.VALOR_DEBITO - IBExtracto1.VALOR_CREDITO'
        ResetOn = rvtReport
        CalcOn = cvtDataSetNext
        DataSetName = 'IBExtracto1'
        Accumulate = True
    ...
    OnUnknownFunction = ReporteBrUnknownFunction
    OnUnknownObjFunction = ReporteBrUnknownObjFunction
    WrapAfterColumn = 0
    EjectPageAfterPrint = False
    LinesOnPage = 0
    FromLine = 0
        ...
        object prTxMemoObj41: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<yyyy/MM/dd>IBExtracto1.FECHA_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj42: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<hh:mm>IBExtracto1.HORA_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj43: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[IBExtracto1.DOCUMENTO_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj44: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<000>IBExtracto1.ID_TIPO_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj45: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[IBExtracto1.DESCRIPCION_MOVIMIENTO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj47: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<#,#0.00>IBExtracto1.VALOR_CREDITO]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
  ...
  object ReporteB1: TprTxReport
    ...
    object prTxPage1: TprTxPage
      ...
      object prTxHDetailHeaderBand1: TprTxHDetailHeaderBand
        Height = 3
        UseVerticalBands = False
        DetailBand = ReporteB1.prTxHDetailBand1
        ColCount = 1
        ColDirection = prcdTopBottomLeftRight
        ReprintOnEachPage = True
        LinkToDetail = True
  ...
  object ReporteBr1: TprTxReport
    ...
    object prTxPage1: TprTxPage
      ...
      object prTxHDetailHeaderBand1: TprTxHDetailHeaderBand
        Height = 3
        UseVerticalBands = False
        DetailBand = ReporteBr1.prTxHDetailBand1
        ColCount = 1
        ColDirection = prcdTopBottomLeftRight
        ReprintOnEachPage = True
        LinkToDetail = True
